...
@property(assign,readwrite) bool hasIsDSUser;
@property(assign,readwrite) bool hasIsPhoneUser;
...
@property(assign,readwrite) unsigned int isDSUser;
@property(assign,readwrite) unsigned int isPhoneUser;
