...
@property(assign,retain) NSMutableDictionary * styleComposersByKeypath;
@property(assign,retain) IKStyleFactory * styleFactory;
@property(assign,retain) NSMutableDictionary * templateKeyPathMap;
@property(assign,copy) NSDictionary * templateTree;
