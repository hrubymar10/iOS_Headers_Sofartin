...
@property(setter=_setCheckmarkImage:,assign,retain) UIImage * _checkmarkImage;
@property(setter=_setDefaultSectionHeaderView:,assign,retain) UIView * _defaultSectionHeaderView;
@property(setter=_setMediaItems:,assign,retain) NSMutableArray * _mediaItems;
@property(setter=_setMediaPickerController:,assign,retain) MPMediaPickerController * _mediaPickerController;
@property(setter=_setMediaSectionHeaderView:,assign,retain) UIView * _mediaSectionHeaderView;
@property(assign,readonly) MPMusicPlayerController * _musicPlayer;
@property(setter=_setNeedsScrollPositionReset:,assign,readwrite) bool _needsScrollPositionReset;
@property(setter=_setRegularToneSectionHeaderViews:,assign,retain) NSMutableArray * _regularToneSectionHeaderViews;
@property(setter=_setShowsStoreButtonInNavigationBar:,assign,readwrite) bool _showsStoreButtonInNavigationBar;
@property(setter=_setStoreBarButtonItem:,assign,retain) UIBarButtonItem * _storeBarButtonItem;
@property(setter=_setStoredMusicPlayer:,assign,retain) MPMusicPlayerController * _storedMusicPlayer;
@property(setter=_setStyleProvider:,assign,retain) <TKTonePickerStyleProvider> * _styleProvider;
@property(setter=_setTableViewCellLayoutManager:,assign,retain) TKTonePickerTableViewCellLayoutManager * _tableViewCellLayoutManager;
@property(setter=_setToneClassicsTableViewController:,assign,retain) TKToneClassicsTableViewController * _toneClassicsTableViewController;
@property(setter=_setTonePickerController:,assign,retain) TKTonePickerController * _tonePickerController;
@property(setter=_setVibrationPickerViewController:,assign,retain) TKVibrationPickerViewController * _vibrationPickerViewController;
...
@property(assign,readwrite) <TKTonePickerViewControllerDelegate> * delegate;
...
@property(assign,copy) NSNumber * selectedMediaIdentifier;
...
@property(assign,readwrite) bool showsMedia;
@property(assign,readwrite) bool showsNone;
@property(assign,readwrite) bool showsNothingSelected;
@property(assign,readwrite) bool showsStoreButtonInNavigationBar;
@property(assign,readwrite) bool showsVibrations;
@property(assign,retain) <TKTonePickerStyleProvider> * styleProvider;
