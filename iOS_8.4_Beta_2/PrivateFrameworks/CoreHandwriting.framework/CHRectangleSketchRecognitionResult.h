...
@property(assign,readonly) struct CGPoint { double x1; double x2; } lowerLeftPoint;
@property(assign,readonly) struct CGPoint { double x1; double x2; } lowerRightPoint;
@property(assign,readonly) struct CGPoint { double x1; double x2; } upperLeftPoint;
@property(assign,readonly) struct CGPoint { double x1; double x2; } upperRightPoint;
