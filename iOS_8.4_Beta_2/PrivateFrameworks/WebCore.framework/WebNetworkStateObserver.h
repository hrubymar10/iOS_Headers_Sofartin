...
@property(assign,readwrite) const /* Warning: unhandled struct encoding: '{NetworkStateNotifier={Vector<std::__1::function<void (bool)>' */ struct * notifier; /* unknown property attribute:  WTF::CrashOnOverflow>=^{function<void (bool)>}II}BB{RetainPtr<WebNetworkStateObserver>=^v}} */
