...
@property(setter=_setGUIDs:,assign,retain) NSMutableSet * _guids;
@property(assign,readonly) bool _shouldRegisterChat;
@property(assign,readonly) IMAccount * account;
@property(assign,readonly) bool allRecipientsFollowingLocation;
@property(assign,readonly) bool allRecipientsSharingLocation;
@property(assign,retain) NSSet * allSiblingFMFHandles;
@property(assign,copy) NSArray * attachments;
@property(assign,readonly) bool canHaveMultipleParticipants;
@property(assign,readonly) bool canLeaveChat;
@property(assign,readonly) NSString * chatIdentifier;
@property(assign,retain) IMChatRegistry * chatRegistry;
@property(assign,readonly) unsigned char chatStyle;
@property(assign,readwrite) void* contextInfo;
@property(assign,readonly) NSDate * dateCreated;
@property(assign,readonly) NSDate * dateModified;
@property(assign,readwrite) NSString * displayName;
@property(assign,retain) NSSet * fmfHandles;
...
@property(assign,readonly) bool hasMoreMessagesToLoad;
@property(assign,readonly) bool hasRecipientsFollowingLocation;
@property(assign,readonly) bool hasRecipientsSharingLocation;
@property(assign,readonly) bool hasSiblingRecipientsSharingLocation;
@property(assign,readonly) bool hasUnhandledInvitation;
@property(assign,retain) IMMessage * invitationForPendingParticipants;
@property(assign,readonly) long long joinState;
@property(assign,retain) NSString * lastAddressedHandleID;
@property(assign,readonly) IMMessage * lastFinishedMessage;
@property(assign,readonly) IMMessage * lastIncomingFinishedMessage;
@property(assign,readonly) IMMessage * lastIncomingMessage;
@property(assign,readonly) IMMessage * lastMessage;
@property(assign,readonly) NSString * localTypingMessageGUID;
@property(assign,readwrite) bool localUserIsRecording;
@property(assign,readwrite) bool localUserIsTyping;
@property(assign,readonly) unsigned long long messageCount;
@property(assign,readonly) unsigned long long messageFailureCount;
@property(getter=_nextStaleChatItem,setter=_setNextStaleChatItem:,assign,retain) IMChatItem * nextStaleChatItem;
@property(assign,readwrite) unsigned long long numberOfMessagesToKeepLoaded;
@property(assign,readonly) unsigned long long overallChatStatus;
@property(assign,readonly) NSArray * participants;
@property(assign,retain) NSString * persistentID;
@property(assign,retain) IMHandle * recipient;
@property(assign,readonly) NSString * roomName;
@property(assign,readonly) NSString * roomNameWithoutSuffix;
@property(assign,readwrite) <IMChatSendProgressDelegate> * sendProgressDelegate;
@property(assign,readonly) bool suppressAccountRetargetingForGroupConversation;
@property(assign,readonly) unsigned long long unreadMessageCount;
