...
@property(getter=_lastPresentedViewController,setter=_setLastPresentedViewController:,assign,readwrite) UIViewController * lastPresentedViewController;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_contentItemFrameForContentContainerBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
- (id)_lastPresentedViewController;
...
- (void)_setLastPresentedViewController:(id)arg1;
- (void)_setRatingsVisible:(bool)arg1;
- (bool)_shouldDismissAutomaticallyForCurrentPlaybackState;
- (void)_showContextualActionsWithTransportButton:(id)arg1 showSharingOnly:(bool)arg2;
