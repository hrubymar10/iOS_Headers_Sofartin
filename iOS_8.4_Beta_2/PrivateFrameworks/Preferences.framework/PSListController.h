...
@property(assign,retain) UIColor * altTextColor;
@property(assign,retain) UIColor * backgroundColor;
@property(assign,retain) UIColor * buttonTextColor;
@property(assign,retain) UIColor * cellAccessoryColor;
@property(assign,retain) UIColor * cellAccessoryHighlightColor;
@property(assign,retain) UIColor * cellHighlightColor;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool edgeToEdgeCells;
@property(assign,retain) UIColor * editableInsertionPointColor;
@property(assign,retain) UIColor * editablePlaceholderTextColor;
@property(assign,retain) UIColor * editableSelectionBarColor;
@property(assign,retain) UIColor * editableSelectionHighlightColor;
@property(assign,retain) UIColor * editableTextColor;
@property(assign,readwrite) bool extendedLayoutIncludesOpaqueBars;
@property(assign,retain) UIColor * footerHyperlinkColor;
@property(assign,readwrite) bool forceSynchronousIconLoadForCreatedCells;
@property(assign,retain) UIColor * foregroundColor;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) long long observerType;
@property(assign,retain) NSDictionary * pendingURLResourceDictionary;
@property(assign,retain) UIColor * segmentedSliderTrackColor;
@property(assign,retain) UIColor * separatorColor;
@property(assign,copy) NSString * specifierIDPendingPush;
