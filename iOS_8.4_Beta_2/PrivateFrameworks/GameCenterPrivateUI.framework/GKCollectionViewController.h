...
@property(assign,retain) GKSearchBar * activeSearchBar;
@property(assign,readwrite) long long appearCount;
@property(assign,retain) GKColorPalette * colorPalette;
@property(assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } contentInsetsBeforeKeyboard;
@property(assign,retain) NSString * currentSearchText;
@property(assign,retain) <UICollectionViewDataSource> * dataSource;
@property(assign,copy) NSString * debugDescription;
@property(assign,retain) UICollectionViewLayout * defaultLayout;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool didSlideIn;
@property(assign,readwrite) long long gkFocusBubbleType;
@property(assign,readwrite) bool hasViewFactories;
...
@property(assign,readonly) NSString * loadingState;
@property(assign,retain) GKPlaceholderView * placeholderView;
@property(assign,readwrite) long long previousOrientation;
@property(assign,readonly) bool readyToDisplayData;
@property(assign,retain) NSMapTable * reusableViewsIHaveSeen;
@property(assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } scrollInsetsBeforeKeyboard;
@property(assign,readwrite) bool shouldSlideInContents;
@property(assign,readwrite) bool showSupplementaryViewsWhileLoading;
@property(assign,readwrite) bool skipLoadAfterViewDidLoad;
@property(assign,readonly) Class superclass;
@property(assign,readwrite) bool supportsMasterSelectionBehavior;
@property(assign,retain) GKSwipeToEditStateMachine * swipeStateMachine;
