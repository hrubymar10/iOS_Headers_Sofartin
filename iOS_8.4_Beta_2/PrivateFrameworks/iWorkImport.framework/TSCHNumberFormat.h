...
@property(assign,readonly) unsigned int base;
@property(assign,readonly) unsigned int basePlaces;
@property(assign,readonly) bool baseUseMinusSign;
@property(assign,copy) NSString * currencyCode;
@property(assign,copy) NSString * debugDescription;
@property(assign,readonly) unsigned int decimalPlaces;
@property(assign,copy) NSString * description;
@property(assign,readonly) int formatType;
@property(assign,readonly) int fractionAccuracy;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) bool isBase;
@property(assign,readonly) bool isCurrency;
@property(assign,readonly) bool isFraction;
@property(assign,readonly) bool isPercentage;
@property(assign,readonly) int negativeStyle;
@property(assign,copy) NSString * prefixString;
@property(assign,readonly) double scaleFactor;
@property(assign,readonly) bool showThousandsSeparator;
@property(assign,copy) NSString * suffixString;
@property(assign,readonly) Class superclass;
@property(assign,readonly) bool useAccountingStyle;
@property(assign,readonly) bool usesNumberFormatStruct;
