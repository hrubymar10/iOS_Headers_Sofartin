...
@property(assign,readonly) TSCH3DBarNormalResource * normalResource;
@property(assign,readonly) TSCH3DBarTexCoordResource * texCoordResource;
@property(assign,readonly) TSCH3DBarVertexResource * vertexResource;
