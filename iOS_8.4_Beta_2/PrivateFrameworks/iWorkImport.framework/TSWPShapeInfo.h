...
@property(assign,readonly) int columnDirection;
@property(assign,retain) TSWPColumns * columns;
...
@property(assign,readonly) bool displaysInstructionalText;
...
@property(assign,readonly) NSString * instructionalText;
@property(assign,readonly) bool isTextBox;
...
@property(assign,retain) TSWPPadding * padding;
@property(assign,readwrite) NSObject<TSDContainerInfo> * parentInfo;
@property(assign,readwrite) bool shrinkTextToFit;
@property(assign,readonly) Class superclass;
@property(assign,readwrite) bool textIsVertical;
@property(assign,readonly) TSWPShapeStyle * tswpShapeStyle;
