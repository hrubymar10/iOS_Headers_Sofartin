...
@property(assign,readonly) struct { float x1; float x2; float x3; } GLPoint3DValue;
@property(assign,readwrite) struct { float x1; float x2; float x3; } proposedGLPoint3DValue;
