...
+ (bool)isStacked;
+ (struct TSCH3DScenePart { id x1; id x2; })partWithEnumerator:(id)arg1 layoutSettings:(struct { bool x1; bool x2; bool x3; bool x4; bool x5; bool x6; unsigned long long x7; })arg2;
