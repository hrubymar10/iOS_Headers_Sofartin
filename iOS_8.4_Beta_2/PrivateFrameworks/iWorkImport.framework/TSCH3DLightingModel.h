...
@property(assign,retain) TSCH3DEnvironmentPackage * environment;
@property(assign,retain) TSCH3DLightingPackage * lightings;
@property(assign,retain) TSCH3DMaterialPackage * materials;
