...
@property(assign,readonly) double dashSpacing;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,copy) NSString * description;
@property(assign,readonly) bool dontClearBackground;
@property(assign,readonly) bool drawsOutsideStrokeBounds;
@property(assign,readonly) bool empty;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) bool isDash;
@property(assign,readonly) bool isFrame;
@property(assign,readonly) bool isNearlyWhite;
@property(assign,readonly) bool isNullStroke;
@property(assign,readonly) bool isRoundDash;
@property(assign,readwrite) int join;
@property(assign,readwrite) double miterLimit;
@property(assign,readonly) struct _TSDStrokeOutsets { double x1; double x2; double x3; double x4; } outsets;
@property(assign,copy) TSDStrokePattern * pattern;
@property(assign,readonly) bool shouldRender;
@property(assign,readonly) bool solid;
@property(assign,readonly) double suggestedMinimumLineWidth;
@property(assign,readonly) Class superclass;
@property(assign,readonly) Class superclass;
@property(assign,readonly) bool supportsColor;
@property(assign,readonly) bool supportsLineOptions;
@property(assign,readonly) bool supportsPattern;
@property(assign,readonly) bool supportsWidth;
