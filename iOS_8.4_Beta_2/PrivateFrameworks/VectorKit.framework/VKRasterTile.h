...
@property(assign,readonly) int genericTileType;
@property(assign,readwrite) struct shared_ptr<ggl::Texture2D> { struct Texture2D {} *x1; struct __shared_weak_count {} *x2; } gglTexture;
@property(assign,readonly) bool hasGenericTileType;
