...
@property(assign,readonly) struct { double x1; double x2; } coordinateOnFeature;
@property(assign,readonly) double courseOnFeature;
@property(assign,readonly) float distanceFromJunction;
@property(assign,readonly) NSString * featureName;
@property(assign,readonly) float junctionRadius;
...
@property(assign,readonly) float roadWidth;
