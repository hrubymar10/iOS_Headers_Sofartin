...
@property(assign,retain) NSTimer * buttonRepeatTimer;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,retain) UIButton * downIncrementButton;
@property(assign,readwrite) bool enabled;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) float increment;
...
@property(assign,readwrite) bool showsValueLabel;
@property(assign,retain) UISlider * sliderControl;
@property(assign,retain) NSArray * subviewConstraints;
@property(assign,readonly) Class superclass;
@property(assign,retain) UILabel * titleLabel;
@property(assign,retain) UIButton * upIncrementButton;
@property(assign,readwrite) float value;
@property(assign,readwrite) struct { double x1; double x2; } valueChangePublishTTL;
@property(assign,copy) NSString * valueKeyPath;
@property(assign,retain) UILabel * valueLabel;
@property(assign,retain) NSNumberFormatter * valueLabelFormatter;
@property(assign,copy) NSArray * valueLabelStrings;
