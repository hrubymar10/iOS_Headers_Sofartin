...
@property(assign,readonly) BRCPrivateLocalContainer * container;
@property(assign,readonly) BRCZonePurgeOperation * deleteAllContentsOperation;
@property(assign,readonly) NSError * deleteAllContentsOperationLastError;
