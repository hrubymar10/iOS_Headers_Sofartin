...
@property(assign,readonly) struct { double x1; double x2; } shiftedCoordinate;
@property(assign,readwrite) struct { double x1; double x2; int x3; struct { unsigned int x_4_1_1 : 1; } x4; } shiftedPixel;
