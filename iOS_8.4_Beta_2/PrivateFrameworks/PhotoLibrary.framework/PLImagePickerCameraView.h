...
@property(assign,readonly) PLCropOverlay * _cropOverlay;
@property(setter=_setEnabledGestures:,assign,readwrite) int _enabledGestures;
@property(getter=_isManipulatingCrop,setter=_setManipulatingCrop:,assign,readwrite) bool _manipulatingCrop;
@property(assign,readonly) CAMStillImageCaptureResponse * _mostRecentCaptureResponse;
@property(getter=_isRetakingPhoto,setter=_setRetakingPhoto:,assign,readwrite) bool _retakingPhoto;
@property(assign,readonly) bool _shouldSkipPostcaptureReview;
@property(assign,readonly) PLVideoView * _videoView;
@property(setter=_setWindowEdgeClip:,assign,readwrite) int _windowEdgeClip;
@property(assign,readwrite) bool allowsEditing;
@property(assign,readwrite) bool controlsAreVisible;
@property(assign,readwrite) bool cropOverlayUsesTelephonyUI;
@property(assign,retain) UIView * customOverlayView;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(getter=isDisplayedInPopover,assign,readwrite) bool displayedInPopover;
@property(assign,readonly) unsigned long long hash;
@property(assign,retain) NSDictionary * imagePickerOptions;
@property(assign,readwrite) int photoSavingOptions;
@property(assign,readwrite) bool showsCropRegion;
@property(assign,readonly) Class superclass;
@property(assign,readonly) PLPhotoTileViewController * tileViewController;
@property(assign,readwrite) bool wantsImageData;
