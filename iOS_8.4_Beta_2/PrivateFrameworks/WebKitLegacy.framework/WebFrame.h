...
@property(assign,readonly) DOMDocument * DOMDocument;
@property(assign,copy) NSArray * childFrames;
@property(assign,readonly) WebDataSource * dataSource;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readonly) DOMHTMLElement * frameElement;
@property(assign,readonly) WebFrameView * frameView;
@property(assign,readonly) struct OpaqueJSContext { }* globalContext;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) JSContext * javaScriptContext;
@property(assign,copy) NSString * name;
@property(assign,readonly) WebFrame * parentFrame;
@property(assign,readonly) WebDataSource * provisionalDataSource;
@property(assign,readonly) Class superclass;
@property(assign,readonly) WebView * webView;
@property(assign,readonly) NSURL * webui_URL;
@property(assign,readonly) NSArray * webui_certificateChain;
@property(assign,readonly) WebScriptObject * windowObject;
