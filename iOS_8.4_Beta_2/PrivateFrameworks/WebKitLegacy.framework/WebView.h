...
@property(assign,readwrite) id UIDelegate;
@property(assign,copy) NSString * applicationNameForUserAgent;
@property(assign,readonly) WebBackForwardList * backForwardList;
@property(assign,readonly) bool canGoBack;
@property(assign,readonly) bool canGoForward;
@property(assign,readonly) bool canMakeTextLarger;
@property(assign,readonly) bool canMakeTextSmaller;
@property(assign,readonly) bool canMakeTextStandardSize;
@property(getter=isContinuousSpellCheckingEnabled,assign,readwrite) bool continuousSpellCheckingEnabled;
@property(assign,copy) NSString * customTextEncodingName;
@property(assign,copy) NSString * customUserAgent;
@property(assign,readwrite) id downloadDelegate;
@property(assign,readwrite) bool drawsBackground;
@property(getter=isEditable,assign,readwrite) bool editable;
@property(assign,retain) id editingDelegate;
@property(assign,readonly) double estimatedProgress;
@property(assign,readwrite) id frameLoadDelegate;
@property(assign,copy) NSString * groupName;
@property(assign,retain) WAKWindow * hostWindow;
@property(getter=isLoading,assign,readonly) bool loading;
@property(assign,readonly) WebFrame * mainFrame;
@property(assign,readonly) DOMDocument * mainFrameDocument;
@property(assign,copy) NSString * mainFrameTitle;
@property(assign,copy) NSString * mainFrameURL;
@property(assign,readonly) bool maintainsInactiveSelection;
@property(assign,copy) NSString * mediaStyle;
@property(assign,readwrite) id policyDelegate;
@property(assign,retain) WebPreferences * preferences;
@property(assign,copy) NSString * preferencesIdentifier;
@property(assign,readwrite) id resourceLoadDelegate;
@property(assign,readonly) DOMRange * selectedDOMRange;
@property(assign,readonly) WebFrame * selectedFrame;
@property(assign,readonly) int selectionAffinity;
@property(assign,readwrite) bool shouldCloseWithWindow;
@property(assign,readwrite) bool shouldUpdateWhileOffscreen;
@property(assign,readwrite) bool smartInsertDeleteEnabled;
@property(getter=_sourceApplicationAuditData,setter=_setSourceApplicationAuditData:,assign,copy) NSData * sourceApplicationAuditData;
@property(assign,readonly) bool supportsTextEncoding;
@property(assign,readwrite) float textSizeMultiplier;
@property(assign,retain) DOMCSSStyleDeclaration * typingStyle;
@property(assign,readonly) NSUndoManager * undoManager;
@property(assign,readonly) WebScriptObject * windowScriptObject;
