...
@property(assign,readwrite) bool allDayDrawingStyle;
...
@property(assign,readwrite) double cappedColorBarHeight;
...
@property(assign,readwrite) bool drawsResizeHandles;
@property(getter=isFacebook,assign,readwrite) bool facebook;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) bool hideBackgroundImage;
@property(assign,readwrite) bool hideText;
@property(assign,readwrite) bool isSelectedCopyView;
@property(assign,copy) NSString * location;
@property(assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } margin;
@property(assign,readwrite) bool needsReply;
@property(assign,retain) EKEvent * occurrence;
...
@property(assign,readwrite) EKDayOccurrenceView * selectedCopy;
@property(assign,readwrite) bool showsTravelTime;
...
@property(assign,readwrite) double travelTimeSubviewHeightInPoints;
