...
@property(assign,readwrite) bool alignsMidnightToTop;
@property(assign,readonly) EKDayAllDayView * allDayView;
@property(assign,readwrite) bool allowPinchingHourHeights;
...
@property(assign,readwrite) <EKDayViewDataSource> * dataSource;
@property(assign,readonly) double dayEnd;
@property(assign,readonly) double dayStart;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <EKDayViewDelegate> * delegate;
...
@property(assign,readwrite) int firstVisibleSecond;
@property(assign,retain) UIColor * gridLineColor;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) double hourScale;
@property(assign,readwrite) struct _NSRange { unsigned long long x1; unsigned long long x2; } hoursToRender;
@property(assign,readwrite) bool isNowVisible;
@property(assign,readonly) double leftContentInset;
...
@property(assign,readonly) NSArray * occurrenceViews;
@property(assign,readwrite) int outlineStyle;
@property(assign,readonly) double scrollBarOffset;
@property(assign,readonly) double scrollOffset;
@property(assign,readwrite) bool shouldEverShowTimeIndicators;
@property(assign,readwrite) bool showsLeftBorder;
@property(assign,readwrite) bool showsTimeLabel;
@property(assign,readwrite) bool showsTimeLine;
@property(assign,readwrite) bool showsTimeMarker;
@property(assign,readonly) Class superclass;
@property(assign,retain) UIColor * timeViewTextColor;
