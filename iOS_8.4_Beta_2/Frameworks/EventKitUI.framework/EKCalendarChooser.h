...
@property(assign,readwrite) bool allowsEdit;
@property(assign,readwrite) bool allowsPullToRefresh;
@property(assign,readwrite) bool allowsRotation;
@property(assign,retain) NSIndexPath * checkedRow;
@property(assign,readwrite) int chooserMode;
@property(assign,retain) NSMutableDictionary * customGroupMap;
@property(assign,readwrite) <EKCalendarChooserDelegate> * delegate;
@property(assign,readwrite) bool disableCalendarEditing;
@property(assign,readwrite) unsigned long long entityType;
@property(assign,retain) EKEventStore * eventStore;
@property(assign,readwrite) struct { unsigned int x1 : 1; unsigned int x2 : 1; unsigned int x3 : 1; unsigned int x4 : 1; unsigned int x5 : 1; unsigned int x6 : 1; unsigned int x7 : 1; unsigned int x8 : 1; unsigned int x9 : 1; unsigned int x10 : 1; unsigned int x11 : 1; } flags;
@property(assign,retain) NSMutableArray * groups;
@property(assign,readwrite) long long lastAuthorizationStatus;
@property(assign,retain) EKSource * limitedToSource;
@property(assign,retain) UIRefreshControl * refreshControl;
@property(assign,readwrite) long long refreshCounter;
@property(assign,retain) EKCalendar * selectedCalendar;
@property(assign,retain) NSMutableSet * selectedCalendarSet;
@property(assign,copy) NSSet * selectedCalendars;
@property(assign,readwrite) int selectionStyle;
@property(assign,readwrite) bool showDetailAccessories;
@property(assign,readwrite) bool showsCancelButton;
@property(assign,readwrite) bool showsDeclinedEventsSetting;
@property(assign,readwrite) bool showsDoneButton;
@property(assign,readwrite) bool showsRefreshButton;
@property(assign,retain) NSMutableDictionary * storeGroupMap;
