...
@property(assign,retain) NSMutableDictionary * _cachedValidatedEmails;
@property(assign,retain) NSMutableDictionary * _calendars;
@property(assign,retain) EKCalendar * _defaultCalendarForNewEvents;
@property(assign,retain) EKCalendar * _defaultCalendarForNewReminders;
@property(assign,retain) NSMutableDictionary * _sources;
@property(assign,readwrite) NSObject<OS_dispatch_queue> * calendarQueue;
@property(assign,readonly) NSArray * calendars;
@property(assign,readonly) EKDaemonConnection * connection;
@property(assign,retain) EKDaemonConnection * database;
@property(assign,readwrite) NSObject<OS_dispatch_queue> * dbChangedQueue;
@property(assign,copy) NSString * debugDescription;
@property(assign,readonly) EKAlarm * defaultAllDayAlarm;
@property(assign,retain) NSNumber * defaultAllDayAlarmOffset;
@property(assign,readonly) EKCalendar * defaultCalendarForNewEvents;
@property(assign,readonly) EKAlarm * defaultTimedAlarm;
@property(assign,retain) NSNumber * defaultTimedAlarmOffset;
@property(assign,readwrite) NSMutableSet * deletedObjects;
@property(assign,copy) NSString * description;
@property(assign,readonly) NSArray * eventNotifications;
@property(assign,readonly) NSString * eventStoreIdentifier;
@property(assign,readwrite) unsigned int flags;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) NSArray * inboxRepliedSectionItems;
@property(assign,readwrite) NSMutableSet * insertedObjects;
@property(assign,readwrite) double lastDatabaseNotificationTimestamp;
@property(assign,readonly) int notifiableEventCount;
@property(assign,readwrite) NSMutableSet * objectsPendingCommit;
@property(assign,readwrite) NSMutableDictionary * publicRegisteredObjects;
@property(assign,readwrite) NSMutableDictionary * registeredObjects;
@property(assign,readwrite) NSObject<OS_dispatch_queue> * registeredQueue;
@property(assign,readonly) NSArray * reminderNotifications;
@property(assign,readwrite) bool showDeclinedEvents;
@property(assign,readonly) Class superclass;
@property(assign,copy) NSTimeZone * timeZone;
@property(assign,readonly) int unacknowledgedEventCount;
@property(assign,readwrite) NSObject<OS_dispatch_queue> * unsavedChangesQueue;
@property(assign,readwrite) NSMutableSet * updatedObjects;
