...
@property(assign,retain) MPAVItem * MPAVItem;
@property(getter=_isExternalProtectionRequiredForPlayback,setter=_setExternalProtectionRequiredForPlayback:,assign,readwrite) bool _externalProtectionRequiredForPlayback;
@property(getter=_isRental,assign,readonly) bool _rental;
@property(assign,readonly) NSDate * _rentalExpirationDate;
@property(assign,readonly) NSDate * _rentalPlaybackExpirationDate;
@property(getter=_isRentalPlaybackStarted,assign,readonly) bool _rentalPlaybackStarted;
@property(assign,readonly) NSDate * _rentalPlaybackStartedDate;
@property(assign,readonly) NSDate * _rentalStartDate;
@property(getter=isApplicationAuthorizedForPlayback,assign,readonly) bool applicationAuthorizedForPlayback;
@property(getter=isAuthorizationRequiredForPlayback,assign,readonly) bool authorizationRequiredForPlayback;
@property(getter=isContentAuthorizedForPlayback,assign,readonly) bool contentAuthorizedForPlayback;
@property(assign,copy) NSString * dataYouTubeID;
...
@property(assign,readonly) bool rc_isDurationAvailable;
@property(assign,readonly) struct { double x1; double x2; } rc_playableTimeRange;
@property(setter=rc_setPreviewTimeRange:,assign,readwrite) struct { double x1; double x2; } rc_previewTimeRange;
@property(assign,readwrite) unsigned long long restrictions;
@property(assign,copy) NSString * serviceIdentifier;
