...
@property(assign,readonly) long long activeVideoStabilizationMode;
...
@property(assign,readonly) AVCaptureOutput * output;
@property(assign,readwrite) long long preferredVideoStabilizationMode;
...
@property(assign,readonly) AVCaptureVideoPreviewLayer * videoPreviewLayer;
