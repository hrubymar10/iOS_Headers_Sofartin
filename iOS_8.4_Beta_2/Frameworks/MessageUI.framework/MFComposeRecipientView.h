...
@property(assign,readonly) UIView * addButton;
...
@property(assign,readonly) MFCorecipientsIndicatorAtom * corecipientsIndicator;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) unsigned long long defaultAtomPresentationOptions;
@property(assign,readwrite) <MFComposeRecipientViewDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool didIgnoreFirstResponderResign;
...
@property(assign,readonly) long long numberOfRowsOfTextInField;
@property(assign,readonly) double offsetForRowWithTextField;
@property(assign,retain) MFComposeRecipient * placeholderRecipient;
