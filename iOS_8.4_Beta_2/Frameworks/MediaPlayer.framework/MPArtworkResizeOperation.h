...
@property(assign,readonly) NSObject<OS_dispatch_group> * operationGroup;
@property(assign,readonly) UIImage * resizedImage;
@property(assign,readwrite) struct CGSize { double x1; double x2; } scaledFittingSize;
@property(assign,readwrite) bool usesExactFittingSizeAsDestinationSize;
