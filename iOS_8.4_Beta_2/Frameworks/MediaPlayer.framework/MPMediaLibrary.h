...
- (void).cxx_destruct;
- (id)MPU_entityWithContentItemIdentifierCollection:(id)arg1;
- (id)_MPU_mediaEntityWithFilterPredicate:(id)arg1 mediaGrouping:(long long)arg2 isCollection:(bool)arg3;
...
- (id)_syncValidity;
- (void)addGlobalPlaylistWithID:(id)arg1 completion:(id)arg2;
