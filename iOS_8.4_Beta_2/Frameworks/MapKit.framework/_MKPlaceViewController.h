...
@property(assign,readwrite) ABPeoplePickerNavigationController<ABContactViewControllerDelegate> * contactsNavigationController;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool disableReportAProblem;
@property(assign,retain) MKDistanceDetailProvider * distanceMonitor;
@property(assign,readwrite) bool hasCheckedDistanceAvailability;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) double headerHeight;
@property(assign,copy) NSString * headerTitle;
@property(assign,readwrite) bool hideDirectionsButtons;
@property(assign,readwrite) bool hideInlineMap;
@property(assign,retain) MKMapItem * mapItem;
@property(assign,readonly) MKPlaceNearbyAppsMetricsCoordinator * metricsCoordinator;
@property(assign,readwrite) unsigned long long options;
@property(assign,retain) CNContact * originalContact;
@property(assign,retain) MKPlaceHeaderView * placeHeaderView;
@property(assign,readwrite) <_MKPlaceViewControllerDelegate> * placeViewControllerDelegate;
@property(assign,readwrite) <_MKPlaceViewControllerFeedbackDelegate> * placeViewFeedbackDelegate;
@property(assign,readwrite) bool showContactActions;
@property(assign,readwrite) bool showCreateReminder;
@property(assign,readwrite) bool showEditButton;
@property(assign,readwrite) bool showFlyoverTour;
@property(assign,readwrite) bool showInlineMapInHeader;
@property(assign,readwrite) bool showNearbyApps;
...
@property(assign,readwrite) bool showShareActionsButton;
@property(assign,readwrite) bool showSimulateLocation;
@property(assign,readwrite) bool showTitleBar;
@property(assign,readonly) Class superclass;
@property(assign,retain) MKSegmentedControlTabBarView * tabBar;
