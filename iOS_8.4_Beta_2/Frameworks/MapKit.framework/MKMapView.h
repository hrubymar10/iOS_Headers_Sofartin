...
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } annotationVisibleRect;
...
@property(getter=_currentFlyoverAnimationID,setter=_setCurrentFlyoverAnimationID:,assign,readwrite) unsigned long long currentFlyoverAnimationID;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <MKMapViewDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,copy) NSString * description;
@property(getter=_detailedDescription,assign,readonly) NSString * detailedDescription;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) bool ignoreLocationUpdates;
@property(assign,readwrite) unsigned long long mapType;
@property(assign,readonly) NSArray * overlays;
@property(getter=isPitchEnabled,assign,readwrite) bool pitchEnabled;
@property(assign,retain) CLLocation * predictedUserLocation;
@property(assign,readwrite) struct { struct { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; } region;
@property(getter=isRotateEnabled,assign,readwrite) bool rotateEnabled;
@property(getter=isScrollEnabled,assign,readwrite) bool scrollEnabled;
@property(assign,copy) NSArray * selectedAnnotations;
@property(assign,readwrite) bool showsBuildings;
@property(assign,readwrite) bool showsPointsOfInterest;
@property(assign,readwrite) bool showsUserLocation;
@property(assign,readonly) Class superclass;
@property(assign,readonly) Class superclass;
@property(assign,readonly) MKUserLocation * userLocation;
@property(assign,retain) MKAnnotationView * userLocationView;
@property(getter=isUserLocationVisible,assign,readonly) bool userLocationVisible;
@property(assign,readwrite) long long userTrackingMode;
@property(assign,readwrite) struct { struct { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; } visibleMapRect;
@property(getter=_visibleTileSets,assign,readonly) NSArray * visibleTileSets;
