...
@property(assign,retain) EAGLContext * _context;
@property(assign,readonly) double _fps;
@property(assign,readonly) SKScene * _nextScene;
@property(assign,readonly) SKScene * _scene;
@property(assign,readwrite) bool _shouldCenterStats;
@property(assign,readwrite) bool _showsCPUStats;
@property(assign,readwrite) bool _showsCoreAnimationFPS;
@property(assign,readwrite) bool _showsCulledNodesInNodeCount;
@property(assign,readwrite) bool _showsGPUStats;
@property(assign,readwrite) bool _showsOutlineInterior;
@property(assign,readwrite) bool _showsSpriteBounds;
@property(assign,readwrite) bool _showsTotalAreaRendered;
@property(assign,readonly) int _spriteRenderCount;
@property(assign,readonly) int _spriteSubmitCount;
@property(assign,readwrite) bool _usesAsyncUpdateQueue;
@property(assign,readwrite) double _viewScale;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } _viewTranslation;
@property(assign,readwrite) bool allowsTransparency;
@property(getter=isAsynchronous,assign,readwrite) bool asynchronous;
@property(assign,readwrite) long long frameInterval;
@property(assign,readwrite) bool ignoresSiblingOrder;
@property(getter=isPaused,assign,readwrite) bool paused;
@property(assign,readwrite) double physicsDebugStrokeWidth;
@property(assign,readonly) struct CGSize { double x1; double x2; } pixelSize;
@property(assign,readonly) SKScene * scene;
@property(assign,readwrite) bool shouldCullNonVisibleNodes;
@property(assign,readwrite) bool showsDrawCount;
@property(assign,readwrite) bool showsFPS;
@property(assign,readwrite) bool showsFields;
@property(assign,readwrite) bool showsNodeCount;
@property(assign,readwrite) bool showsPhysics;
@property(assign,readwrite) bool showsQuadCount;
