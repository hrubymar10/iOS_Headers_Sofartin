...
@property(assign,readonly) struct shared_ptr<PKCAether> { struct PKCAether {} *x1; struct __shared_weak_count {} *x2; } _aether;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } _anchorPoint;
@property(assign,retain) NSMutableDictionary * _info;
@property(assign,readwrite) bool _showBounds;
@property(assign,readonly) struct CGSize { double x1; double x2; } _size;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _untransformedBounds;
...
@property(assign,readonly) struct CGPath { }* outline;
@property(assign,readonly) SKNode * parent;
@property(getter=isPaused,assign,readwrite) bool paused;
@property(assign,retain) SKPhysicsBody * physicsBody;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } position;
@property(assign,copy) SKReachConstraints * reachConstraints;
@property(assign,readonly) SKScene * scene;
...
@property(assign,readwrite) double xRotation;
@property(assign,readwrite) double xScale;
@property(assign,readwrite) double yRotation;
@property(assign,readwrite) double yScale;
@property(assign,readwrite) double zPosition;
@property(assign,readwrite) double zRotation;
