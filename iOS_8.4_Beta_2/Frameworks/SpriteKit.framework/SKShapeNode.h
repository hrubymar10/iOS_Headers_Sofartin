...
@property(getter=isAntialiased,assign,readwrite) bool antialiased;
@property(assign,readwrite) long long blendMode;
@property(assign,retain) UIColor * fillColor;
@property(assign,retain) SKShader * fillShader;
@property(assign,retain) SKTexture * fillTexture;
@property(assign,readwrite) double glowWidth;
@property(assign,readwrite) int lineCap;
@property(assign,readwrite) int lineJoin;
@property(assign,readonly) double lineLength;
...
@property(assign,readwrite) double renderQualityRatio;
@property(assign,retain) UIColor * strokeColor;
@property(assign,retain) SKShader * strokeShader;
@property(assign,retain) SKTexture * strokeTexture;
