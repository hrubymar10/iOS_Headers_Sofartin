...
@property(assign,readwrite) float angleInitial;
@property(assign,readwrite) float length;
@property(assign,retain) SKNode * node;
@property(assign,readwrite) union _GLKVector2 { struct { float x_1_1_1; float x_1_1_2; } x1; struct { float x_2_1_1; float x_2_1_2; } x2; float x3[2]; } position;
@property(assign,readwrite) union _GLKVector2 { struct { float x_1_1_1; float x_1_1_2; } x1; struct { float x_2_1_1; float x_2_1_2; } x2; float x3[2]; } size;
