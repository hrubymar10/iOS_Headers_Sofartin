...
@property(getter=isBannerLoaded,assign,readonly) bool bannerLoaded;
@property(getter=isBannerViewActionInProgress,assign,readwrite) bool bannerViewActionInProgress;
@property(assign,readwrite) double constraintBasedWidth;
@property(assign,readonly) bool createdForIBInternal;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <ADBannerViewDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool determiningConstraintBasedWidth;
@property(assign,readwrite) bool dimmed;
@property(assign,readonly) unsigned long long hash;
@property(assign,retain) UIView * highlightClippedView;
@property(assign,retain) UIView * highlightHittableView;
@property(assign,retain) NSTimer * highlightUpdateTimer;
@property(assign,readwrite) bool inSecondConstraintsPass;
