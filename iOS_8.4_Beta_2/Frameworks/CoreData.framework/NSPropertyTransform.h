...
@property(assign,retain) NSPropertyTransform * prerequisiteTransform;
@property(assign,retain) NSString * propertyName;
@property(assign,readwrite) bool replaceMissingValueOnly;
