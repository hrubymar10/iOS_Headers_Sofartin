...
- (struct JSObject { unsigned int x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; struct CopyWriteBarrier<JSC::Butterfly> { struct Butterfly {} *x_6_1_1; } x6; }*)prototype;
