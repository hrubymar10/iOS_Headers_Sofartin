...
@property(getter=_mapkit_isCLDenied,assign,readonly) bool _mapkit_CLDenied;
@property(getter=_mapkit_isCLErrorNetwork,assign,readonly) bool _mapkit_CLErrorNetwork;
@property(getter=_mapkit_isCLHeadingFailure,assign,readonly) bool _mapkit_CLHeadingFailure;
@property(getter=_mapkit_isCLLocationUnknown,assign,readonly) bool _mapkit_CLLocationUnknown;
@property(assign,retain) NSURL * _mapkit_locationErrorSettingsURL;
@property(assign,readonly) long long code;
@property(assign,copy) NSString * domain;
@property(getter=isFromRequest,assign,readonly) bool fromRequest;
@property(getter=hd_isFromRequest,assign,readonly) bool hd_fromRequest;
@property(assign,readonly) unsigned short hd_messageID;
@property(assign,readonly) NSString * hd_messageIDSIdentifier;
@property(assign,readonly) NSDate * hd_messageSent;
@property(assign,readonly) NSDictionary * hd_persistentUserInfo;
@property(assign,copy) NSString * helpAnchor;
@property(assign,readonly) NSString * idsIdentifier;
@property(assign,copy) NSString * localizedDescription;
@property(assign,copy) NSString * localizedFailureReason;
@property(assign,copy) NSArray * localizedRecoveryOptions;
@property(assign,copy) NSString * localizedRecoverySuggestion;
@property(assign,readonly) unsigned short messageID;
@property(assign,readonly) NSDate * messageSent;
@property(assign,readonly) NSDictionary * persistentUserInfo;
@property(assign,retain) id recoveryAttempter;
