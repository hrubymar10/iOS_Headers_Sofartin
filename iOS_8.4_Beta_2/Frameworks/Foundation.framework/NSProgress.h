...
@property(getter=isCancellable,assign,readwrite) bool cancellable;
@property(assign,copy) id cancellationHandler;
@property(getter=isCancelled,assign,readonly) bool cancelled;
@property(assign,readwrite) long long completedUnitCount;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readonly) double fractionCompleted;
@property(assign,readonly) unsigned long long hash;
@property(getter=isIndeterminate,assign,readonly) bool indeterminate;
@property(assign,readwrite) unsigned long long installPhase;
@property(assign,readwrite) unsigned long long installState;
@property(assign,copy) NSString * kind;
@property(assign,copy) NSString * localizedAdditionalDescription;
@property(assign,copy) NSString * localizedDescription;
@property(getter=isOld,assign,readonly) bool old;
@property(getter=isPausable,assign,readwrite) bool pausable;
@property(getter=isPaused,assign,readonly) bool paused;
@property(assign,copy) id pausingHandler;
@property(assign,readonly) NSString * sf_bundleID;
@property(assign,readonly) NSString * sf_error;
@property(assign,readonly) NSString * sf_personRealName;
@property(assign,readonly) NSString * sf_publishingKey;
@property(assign,readonly) NSString * sf_sessionID;
@property(assign,readwrite) long long sf_transferState;
@property(assign,readonly) Class superclass;
@property(assign,readwrite) long long totalUnitCount;
