...
@property(assign,readonly) float blendColorAlpha;
@property(assign,readonly) float blendColorBlue;
@property(assign,readonly) float blendColorGreen;
@property(assign,readonly) float blendColorRed;
@property(assign,readonly) <MTLDevice> * cachedDevice;
@property(assign,readonly) unsigned long long cullMode;
@property(assign,readonly) MTLDepthStencilDescriptor * defaultDepthStencilDescriptor;
@property(assign,readonly) float depthBias;
@property(assign,readonly) float depthBiasClamp;
@property(assign,readonly) float depthBiasSlopeScale;
@property(assign,readonly) <MTLDepthStencilState> * depthStencilState;
@property(assign,copy) MTLRenderPassDescriptor * descriptor;
@property(assign,readonly) unsigned long long frontFacingWinding;
@property(assign,readonly) unsigned long long height;
@property(assign,readonly) float lineWidth;
@property(assign,readonly) <MTLRenderPipelineState> * renderPipelineState;
@property(assign,readonly) struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; } scissorRect;
@property(assign,readonly) unsigned int stencilRef;
@property(assign,readonly) unsigned long long triangleFillMode;
@property(assign,readonly) struct { double x1; double x2; double x3; double x4; double x5; double x6; } viewport;
@property(assign,readonly) unsigned long long visibilityResultMode;
@property(assign,readonly) unsigned long long visibilityResultOffset;
