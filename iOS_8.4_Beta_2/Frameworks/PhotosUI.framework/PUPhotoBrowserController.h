...
@property(setter=_setAirplayPickerViewController:,assign,readwrite) PUAirplayRoutePickerViewController * _airplayPickerViewController;
@property(setter=_setEmptyPlaceholderView:,assign,retain) _UIContentUnavailableView * _emptyPlaceholderView;
@property(setter=_setLockScreenSharingObserver:,assign,retain) id _lockScreenSharingObserver;
@property(setter=_setSlideshowSettingsViewController:,assign,readwrite) PUSlideshowSettingsViewController * _slideshowSettingsViewController;
@property(assign,readwrite) unsigned long long allowedActions;
@property(assign,readonly) PHFetchResult * assetCollections;
...
@property(assign,readonly) PHAsset * currentAsset;
...
@property(assign,readonly) PLPhotoTileViewController * currentTileForTransitions;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <PUPhotoBrowserControllerDelegate> * delegate;
@property(assign,readwrite) bool deletesDuplicatesWhenNecessary;
@property(assign,copy) NSString * description;
@property(assign,readonly) unsigned long long hash;
@property(assign,retain) PLCloudSharedComment * initialComment;
@property(assign,readwrite) bool isBrowsingFavorites;
@property(getter=areOverlaysVisible,setter=_setOverlaysVisible:,assign,readwrite) bool overlaysVisible;
@property(assign,readonly) UIColor * photoBackgroundColor;
@property(getter=isPhotoBackgroundHidden,assign,readwrite) bool photoBackgroundHidden;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } photoFrame;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } photoFrameForZoomTransition;
@property(assign,readonly) UIImage * photoImage;
@property(assign,readonly) UIImage * photoImageForZoomTransition;
@property(setter=ppt_setOnDidEndPagingBlock:,assign,copy) id ppt_onDidEndPagingBlock;
