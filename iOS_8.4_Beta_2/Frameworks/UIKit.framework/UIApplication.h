...
@property(setter=_setExpectedViewOrientation:,assign,readwrite) long long _expectedViewOrientation;
@property(assign,readonly) long long _virtualHorizontalSizeClass;
@property(assign,readonly) long long _virtualVerticalSizeClass;
@property(assign,readonly) struct CGSize { double x1; double x2; } _virtualWindowSizeInSceneReferenceSpace;
@property(assign,readwrite) long long applicationIconBadgeNumber;
@property(assign,readonly) long long applicationState;
@property(assign,readwrite) bool applicationSupportsShakeToEdit;
@property(assign,readonly) long long backgroundRefreshStatus;
@property(assign,readonly) double backgroundTimeRemaining;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <UIApplicationDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readonly) unsigned long long hash;
@property(getter=isIdleTimerDisabled,assign,readwrite) bool idleTimerDisabled;
@property(assign,readonly) UIWindow * keyWindow;
@property(getter=_lastLocationWhereAllTouchesLifted,setter=_setLastLocationWhereAllTouchesLifted:,assign,readwrite) struct CGPoint { double x1; double x2; } lastLocationWhereAllTouchesLifted;
@property(getter=_lastLocationWhereFirstTouchCameDown,setter=_setLastLocationWhereFirstTouchCameDown:,assign,readwrite) struct CGPoint { double x1; double x2; } lastLocationWhereFirstTouchCameDown;
@property(getter=_lastTimestampWhenAllTouchesLifted,setter=_setLastTimestampWhenAllTouchesLifted:,assign,readwrite) double lastTimestampWhenAllTouchesLifted;
@property(getter=_lastTimestampWhenFirstTouchCameDown,setter=_setLastTimestampWhenFirstTouchCameDown:,assign,readwrite) double lastTimestampWhenFirstTouchCameDown;
@property(getter=isNetworkActivityIndicatorVisible,assign,readwrite) bool networkActivityIndicatorVisible;
@property(assign,readonly) NSString * preferredContentSizeCategory;
@property(setter=_setPreferredContentSizeCategoryName:,assign,copy) NSString * preferredContentSizeCategoryName;
@property(getter=isProtectedDataAvailable,assign,readonly) bool protectedDataAvailable;
@property(getter=isProximitySensingEnabled,assign,readwrite) bool proximitySensingEnabled;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } statusBarFrame;
@property(getter=isStatusBarHidden,assign,readwrite) bool statusBarHidden;
@property(assign,readwrite) long long statusBarOrientation;
@property(assign,readonly) double statusBarOrientationAnimationDuration;
@property(assign,readwrite) long long statusBarStyle;
@property(assign,readonly) Class superclass;
@property(assign,readonly) long long userInterfaceLayoutDirection;
@property(assign,readonly) NSArray * windows;
