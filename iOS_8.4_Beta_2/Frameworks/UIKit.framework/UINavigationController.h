...
@property(setter=_setBarAnimationWasCancelled:,assign,readwrite) bool _barAnimationWasCancelled;
@property(setter=_setInteractiveAnimationCoordinator:,assign,retain) _UIAnimationCoordinator * _barInteractiveAnimationCoordinator;
@property(setter=_setBarSwipeHideGesture:,assign,retain) _UIBarPanGestureRecognizer * _barSwipeHideGesture;
@property(setter=_setBarTapHideGesture:,assign,retain) _UIBarTapGestureRecognizer * _barTapHideGesture;
@property(setter=_setCachedInteractionController:,assign,retain) _UINavigationInteractiveTransition * _cachedInteractionController;
@property(setter=_setCachedTransitionController:,assign,retain) _UINavigationParallaxTransition * _cachedTransitionController;
@property(setter=_setInteractionController:,assign,retain) <UIViewControllerInteractiveTransitioning> * _interactionController;
@property(setter=_setKeyboardAppearedNotificationToken:,assign,retain) id _keyboardAppearedNotificationToken;
@property(setter=_setNavbarAnimationId:,assign,retain) NSUUID * _navbarAnimationId;
@property(setter=_setToolbarAnimationId:,assign,retain) NSUUID * _toolbarAnimationId;
@property(setter=_setToolbarClass:,assign,readwrite) Class _toolbarClass;
@property(setter=_setTransitionController:,assign,retain) <UIViewControllerAnimatedTransitioning> * _transitionController;
@property(setter=_setUpdateNavigationBarHandler:,assign,copy) id _updateNavigationBarHandler;
@property(getter=_isUsingBuiltinAnimator,setter=_setUsingBuiltinAnimator:,assign,readwrite) bool _usingBuiltinAnimator;
@property(getter=_allowNestedNavigationControllers,setter=_setAllowNestedNavigationControllers:,assign,readwrite) bool allowNestedNavigationControllers;
@property(assign,readwrite) bool avoidMovingNavBarOffscreenBeforeUnhiding;
@property(assign,retain) UIPanGestureRecognizer * barHideOnSwipeGestureRecognizer;
@property(assign,readonly) UITapGestureRecognizer * barHideOnTapGestureRecognizer;
@property(assign,readonly) UIViewController * bottomViewController;
@property(getter=_builtinTransitionGap,setter=_setBuiltinTransitionGap:,assign,readwrite) double builtinTransitionGap;
@property(getter=_builtinTransitionStyle,setter=_setBuiltinTransitionStyle:,assign,readwrite) long long builtinTransitionStyle;
@property(getter=_isCrossfadingInTabBar,setter=_setCrossfadingInTabBar:,assign,readwrite) bool crossfadingInTabBar;
@property(getter=_isCrossfadingOutTabBar,setter=_setCrossfadingOutTabBar:,assign,readwrite) bool crossfadingOutTabBar;
@property(assign,readwrite) double customNavigationTransitionDuration;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <UINavigationControllerDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,copy) NSString * description;
@property(assign,retain) UIViewController * detailViewController;
@property(getter=_didExplicitlyHideTabBar,setter=_setDidExplicitlyHideTabBar:,assign,readwrite) bool didHideTabBar;
@property(assign,retain) UIViewController * disappearingViewController;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) bool hidesBarsOnSwipe;
@property(assign,readwrite) bool hidesBarsOnTap;
@property(assign,readwrite) bool hidesBarsWhenKeyboardAppears;
@property(assign,readwrite) bool hidesBarsWhenVerticallyCompact;
@property(assign,readonly) UIGestureRecognizer * interactivePopGestureRecognizer;
@property(getter=isInteractiveTransition,assign,readwrite) bool interactiveTransition;
@property(assign,readwrite) bool isExpanded;
@property(getter=_isNestedNavigationController,setter=_setIsNestedNavigationController:,assign,readwrite) bool isNestedNavigationController;
@property(assign,readonly) UINavigationBar * navigationBar;
@property(getter=isNavigationBarHidden,assign,readwrite) bool navigationBarHidden;
@property(assign,readonly) UINavigationTransitionView * navigationTransitionView;
@property(assign,readwrite) bool needsDeferredTransition;
@property(assign,readwrite) bool pretendNavBarHidden;
@property(assign,readonly) UIViewController * previousViewController;
@property(assign,readonly) Class superclass;
@property(assign,readonly) Class superclass;
@property(assign,readonly) UIToolbar * toolbar;
@property(getter=isToolbarHidden,assign,readwrite) bool toolbarHidden;
@property(assign,retain) UIViewController * topViewController;
