...
@property(getter=_whitelistedTypingAttributes,setter=_setWhitelistedTypingAttributes:,assign,copy) NSSet * _whitelistedTypingAttributes;
...
@property(assign,readwrite) bool continuousSpellCheckingEnabled;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <UITextInputControllerDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(getter=isEditable,assign,readonly) bool editable;
@property(getter=isEditing,assign,readonly) bool editing;
@property(getter=_emptyStringAttributes,setter=_setEmptyStringAttributes:,assign,copy) NSDictionary * emptyStringAttributes;
...
@property(assign,retain) NSLayoutManager * layoutManager;
@property(assign,readonly) UITextRange * markedTextRange;
@property(assign,copy) NSDictionary * markedTextStyle;
@property(assign,readwrite) struct _NSRange { unsigned long long x1; unsigned long long x2; } previousSelectedRange;
