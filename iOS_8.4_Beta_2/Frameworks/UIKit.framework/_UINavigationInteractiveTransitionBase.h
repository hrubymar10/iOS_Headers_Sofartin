...
@property(setter=_setCompletesTransitionOnEnd:,assign,readwrite) bool _completesTransitionOnEnd;
@property(setter=_setInteractionState:,assign,readwrite) long long _interactionState;
@property(setter=_setParent:,assign,readwrite) UIViewController * _parent;
@property(setter=_setStoppedTransitionWasCancelled:,assign,readwrite) bool _stoppedTransitionWasCancelled;
@property(setter=_setTransitionWasStopped:,assign,readwrite) bool _transitionWasStopped;
@property(setter=_setUseAugmentedShouldPopDecisionProcedure:,assign,readwrite) bool _useAugmentedShouldPopDecisionProcedure;
@property(assign,retain) _UINavigationParallaxTransition * animationController;
@property(assign,readwrite) double averageAcceleration;
@property(assign,readwrite) double averageVelocity;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <_UINavigationInteractiveTransitionBaseDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readwrite) UIPanGestureRecognizer * gestureRecognizer;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) bool inSpringAnimation;
@property(getter=_navigationGesture,assign,readonly) UIGestureRecognizer * navigationGesture;
@property(assign,readwrite) double previousAcceleration;
@property(assign,readwrite) double previousDisplacement;
@property(assign,readwrite) double previousTimeStamp;
@property(assign,readwrite) double previousVelocity;
@property(assign,readwrite) unsigned long long sampleCount;
@property(assign,readwrite) bool shouldReverseTranslation;
@property(assign,readwrite) double skipTimeStamp;
@property(assign,readwrite) bool springAnimationIsPending;
