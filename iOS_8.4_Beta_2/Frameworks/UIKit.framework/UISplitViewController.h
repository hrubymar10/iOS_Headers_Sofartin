...
@property(setter=_setClearPreventRotationHook:,assign,copy) id _clearPreventRotationHook;
@property(getter=_didChangeBoundsBlock,setter=_setDidChangeBoundsBlock:,assign,copy) id _didChangeBoundsBlock;
@property(setter=_setDisplayModeButtonItemTitle:,assign,copy) NSString * _displayModeButtonItemTitle;
@property(setter=_setPresentsInFadingPopover:,assign,readwrite) bool _presentsInFadingPopover;
@property(setter=_setPreservedDetailController:,assign,retain) UIViewController * _preservedDetailController;
@property(setter=_setResizesDetailOnSlide:,assign,readwrite) bool _resizesDetailOnSlide;
@property(getter=isCollapsed,assign,readonly) bool collapsed;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <UISplitViewControllerDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,copy) NSString * description;
@property(assign,readonly) long long displayMode;
@property(assign,readwrite) float gutterWidth;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) bool hidesMasterViewInLandscape;
@property(assign,readwrite) bool hidesMasterViewInPortrait;
@property(assign,readwrite) float masterColumnWidth;
@property(assign,readwrite) double maximumPrimaryColumnWidth;
@property(assign,readwrite) double minimumPrimaryColumnWidth;
@property(assign,readwrite) long long preferredDisplayMode;
@property(assign,readwrite) double preferredPrimaryColumnWidthFraction;
@property(assign,readwrite) bool presentsWithGesture;
@property(assign,readonly) double primaryColumnWidth;
@property(assign,readwrite) bool resizeForKeyboard;
