...
@property(assign,retain) UIInputViewSet * _inputViews;
@property(assign,readwrite) UIInputViewSet * _transientInputViews;
@property(assign,readwrite) double _transitionStartTime;
@property(assign,readwrite) double ambiguousControlCenterActivationMargin;
@property(assign,readwrite) bool animationFencingEnabled;
@property(assign,readwrite) bool animationFencingEnabled;
@property(assign,readonly) bool animationsEnabled;
@property(assign,readwrite) bool automaticAppearanceEnabled;
@property(assign,readwrite) bool automaticAppearanceInternalEnabled;
@property(assign,readonly) bool automaticAppearanceReallyEnabled;
@property(assign,readonly) UIKeyboard * automaticKeyboard;
@property(assign,readonly) UIKeyboardAutomatic * automaticKeyboard;
@property(assign,readwrite) int currentState;
@property(assign,retain) UIInputViewTransition * currentTransition;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readonly) NSMutableArray * dropShadowViews;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) bool ignoresPinning;
@property(getter=_isIgnoringReloadInputViews,assign,readonly) bool ignoringReloadInputViews;
@property(assign,retain) UIInputViewSet * inputViews;
@property(assign,readonly) bool keyClicksEnabled;
@property(assign,readonly) UIInputViewSet * loadAwareInputViews;
@property(assign,retain) UIInputViewPostPinningReloadState * postPinningReloadState;
@property(assign,retain) UIResponder * responder;
@property(assign,retain) UIResponder * responder;
@property(assign,retain) UIKeyboardRotationState * rotationState;
@property(assign,retain) UIResponder * selfHostingTrigger;
@property(assign,readonly) Class superclass;
@property(assign,retain) UIPeripheralHostState * targetState;
