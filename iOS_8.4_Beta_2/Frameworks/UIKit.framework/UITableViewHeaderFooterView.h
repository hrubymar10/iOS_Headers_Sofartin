...
@property(getter=_marginWidth,setter=_setMarginWidth:,assign,readwrite) double marginWidth;
@property(assign,readwrite) double maxTitleWidth;
@property(assign,copy) NSString * reuseIdentifier;
@property(getter=_rightMarginWidth,setter=_setRightMarginWidth:,assign,readwrite) double rightMarginWidth;
@property(assign,readwrite) bool sectionHeader;
@property(getter=_stripPadding,setter=_setStripPadding:,assign,readwrite) bool stripPadding;
...
@property(getter=_isTopHeader,setter=_setTopHeader:,assign,readwrite) bool topHeader;
