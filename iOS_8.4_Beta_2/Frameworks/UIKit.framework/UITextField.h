...
@property(setter=_setBaselineLayoutConstraint:,assign,retain) NSLayoutConstraint * _baselineLayoutConstraint;
@property(setter=_setBaselineLayoutLabel:,assign,retain) _UIBaselineLayoutStrut * _baselineLayoutLabel;
...
@property(assign,readwrite) long long borderStyle;
@property(assign,readwrite) long long clearButtonMode;
@property(assign,readwrite) bool clearsOnBeginEditing;
...
@property(assign,readwrite) <UITextFieldDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,copy) NSString * description;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool disablePrediction;
@property(assign,retain) UIImage * disabledBackground;
...
@property(assign,readwrite) long long leftViewMode;
...
@property(assign,readwrite) long long rightViewMode;
