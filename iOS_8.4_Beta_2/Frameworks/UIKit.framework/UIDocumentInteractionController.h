...
@property(assign,retain) UIActivityViewController * activityViewController;
@property(assign,retain) id annotation;
@property(getter=isArchive,assign,readonly) bool archive;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <UIDocumentInteractionControllerDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readonly) NSArray * gestureRecognizers;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) NSArray * icons;
@property(assign,copy) NSString * name;
@property(getter=_performingActivity,setter=_setPerformingActivity:,assign,readwrite) bool performingActivity;
@property(assign,retain) UIPopoverController * popoverController;
@property(assign,readonly) id previewController;
@property(assign,readonly) _UIPreviewItemProxy * previewItemProxy;
@property(assign,readwrite) bool shouldUnzipDocument;
@property(assign,readwrite) bool shouldUnzipDocument;
