...
@property(assign,readwrite) bool allowsMultipleSelectionDuringEditing;
@property(assign,readwrite) bool allowsSelection;
@property(assign,readwrite) bool allowsSelectionDuringEditing;
@property(assign,retain) UIView * backgroundView;
@property(assign,retain) UITouch * currentTouch;
@property(assign,readwrite) <UITableViewDataSource> * dataSource;
@property(assign,copy) NSString * debugDescription;
@property(getter=_defaultMarginWidth,assign,readonly) double defaultMarginWidth;
@property(assign,readwrite) <UITableViewDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(getter=isEditing,assign,readwrite) bool editing;
@property(assign,readwrite) double estimatedRowHeight;
@property(assign,readwrite) double estimatedSectionFooterHeight;
@property(assign,readwrite) double estimatedSectionHeaderHeight;
...
@property(getter=MPU_isInScrollTest,setter=MPU_setInScrollTest:,assign,readwrite) bool inScrollTest;
@property(getter=_manuallyManagesSwipeUI,setter=_setManuallyManagesSwipeUI:,assign,readwrite) bool manuallyManagesSwipeUI;
@property(assign,readwrite) double rowHeight;
@property(assign,readwrite) double sectionFooterHeight;
@property(assign,readwrite) double sectionHeaderHeight;
@property(assign,retain) UIColor * sectionIndexBackgroundColor;
@property(assign,retain) UIColor * sectionIndexColor;
@property(assign,readwrite) long long sectionIndexMinimumDisplayRowCount;
@property(assign,retain) UIColor * sectionIndexTrackingBackgroundColor;
@property(assign,retain) UIColor * separatorColor;
@property(assign,copy) UIVisualEffect * separatorEffect;
...
@property(assign,retain) UIView * tableHeaderView;
@property(getter=_wrapperView,assign,readonly) UIScrollView * wrapperView;
