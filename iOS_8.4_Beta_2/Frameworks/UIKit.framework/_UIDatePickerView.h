...
@property(getter=_amPmValue,assign,readonly) long long amPmValue;
@property(assign,readonly) NSCalendar * calendar;
@property(assign,readonly) double contentWidth;
@property(assign,copy) NSDate * date;
@property(assign,copy) NSDateComponents * dateComponents;
@property(assign,readwrite) long long datePickerMode;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) id delegateOfDatePicker;
@property(assign,copy) NSString * description;
@property(getter=_hasCustomCalendar,assign,readonly) bool hasCustomCalendar;
@property(getter=_hasCustomLocale,assign,readonly) bool hasCustomLocale;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) bool highlightsToday;
@property(getter=_hrMinFont,assign,readonly) UIFont * hrMinFont;
@property(getter=_isTimeIntervalMode,assign,readonly) bool isTimeIntervalMode;
@property(getter=_lastSelectedDateComponents,assign,readonly) NSDateComponents * lastSelectedDateComponents;
@property(assign,readonly) NSLocale * locale;
@property(assign,copy) NSDate * maximumDate;
@property(assign,copy) NSDate * minimumDate;
@property(assign,readwrite) long long minuteInterval;
@property(assign,readwrite) bool staggerTimeIntervals;
@property(assign,readonly) Class superclass;
@property(assign,readwrite) double timeInterval;
@property(assign,retain) NSTimeZone * timeZone;
@property(assign,copy) NSCalendar * userProvidedCalendar;
@property(assign,retain) NSLocale * userProvidedLocale;
