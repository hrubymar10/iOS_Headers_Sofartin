...
@property(setter=setInputAccessoryBackdropView:,assign,retain) UIKBInputBackdropView * _inputAccessoryBackdropView;
@property(assign,readonly) UIView * _inputAccessoryView;
@property(assign,retain) UIInputViewController * _inputAccessoryViewController;
@property(setter=setInputBackdropView:,assign,retain) UIKBInputBackdropView * _inputBackdropView;
@property(assign,readonly) UIView * _inputView;
@property(assign,retain) UIInputViewController * _inputViewController;
@property(assign,retain) NSLayoutConstraint * accessoryViewHeightConstraint;
@property(assign,retain) <_UIRemoteKeyboardControllerDelegate> * controllerDelegate;
@property(assign,retain) UIInputViewPlacementTransition * currentTransition;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) UIView * hostView;
@property(assign,retain) NSLayoutConstraint * inputViewHeightConstraint;
@property(assign,retain) UIInputViewSet * inputViewSet;
@property(assign,readwrite) UIInputViewSetPlacement * placement;
@property(assign,retain) UIInputViewSet * postRotationInputViewSet;
@property(assign,retain) UIInputViewSetPlacement * postRotationPlacement;
@property(assign,readwrite) bool shouldNotifyRemoteKeyboards;
@property(assign,readonly) Class superclass;
@property(assign,retain) UIInputViewSetNotificationInfo * templateNotificationInfo;
@property(assign,retain) NSLayoutConstraint * verticalVisibilityConstraint;
@property(assign,retain) NSArray * visibilityConstraints;
