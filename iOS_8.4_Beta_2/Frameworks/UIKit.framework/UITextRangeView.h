...
@property(assign,readwrite) bool animateUpdate;
@property(assign,readonly) bool autoscrolled;
@property(assign,readwrite) bool baseIsStart;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } basePoint;
@property(assign,readwrite) bool commandsWereShowing;
@property(assign,readonly) UIResponder<UITextInput> * container;
@property(assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } endEdge;
@property(assign,retain) UISelectionGrabber * endGrabber;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } extentPoint;
@property(assign,readwrite) double firstMovedTime;
@property(assign,readwrite) bool inGesture;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } initialBasePoint;
@property(assign,readwrite) double initialDistance;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } initialExtentPoint;
@property(assign,readwrite) bool inputViewIsChanging;
@property(assign,readwrite) bool isScrolling;
@property(assign,readwrite) bool magnifying;
@property(assign,readwrite) int mode;
@property(assign,retain) NSArray * rects;
@property(assign,readwrite) bool rotating;
@property(assign,readwrite) bool scaling;
@property(assign,readonly) UITextSelectionView * selectionView;
@property(assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } startEdge;
@property(assign,retain) UISelectionGrabber * startGrabber;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } touchOffset;
