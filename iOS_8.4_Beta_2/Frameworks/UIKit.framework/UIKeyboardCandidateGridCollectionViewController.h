...
@property(assign,readwrite) bool _usesDeemphasizedTextAppearance;
@property(assign,readwrite) bool alwaysShowExtensionCandidates;
...
@property(assign,readonly) UIKeyboardCandidateGridCollectionView * collectionView;
@property(assign,readonly) UIKeyboardCandidateGridLayout * collectionViewGridLayout;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <UIKeyboardCandidateGridCollectionViewControllerDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readwrite) double groupBarWidth;
@property(assign,readonly) bool hasGroupBar;
@property(assign,readwrite) bool hasSecondaryCandidates;
@property(assign,readonly) unsigned long long hash;
@property(assign,retain) UIView * headerView;
@property(assign,readonly) UIButton * padInlineFloatingArrowButton;
@property(assign,readwrite) double rowHeight;
@property(assign,retain) UIKBCandidateCollectionView * secondaryCandidatesView;
@property(assign,readwrite) bool secondaryCandidatesViewIsCurrent;
@property(assign,readwrite) bool showHiddenCandidatesOnly;
@property(assign,readwrite) bool showsExtensionCandidates;
@property(assign,readwrite) bool singleLineMode;
