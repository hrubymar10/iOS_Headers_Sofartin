...
@property(setter=_setAccessoryView:,assign,readwrite) UIView * _accessoryView;
@property(setter=_setBackgroundNeedsUpdate:,assign,readwrite) bool _backgroundNeedsUpdate;
...
@property(setter=_setBarOrientation:,assign,readwrite) long long _barOrientation;
@property(setter=_setDividerImageViews:,assign,retain) NSMutableArray * _dividerImageViews;
@property(setter=_setDividerImagesAreInvalid:,assign,readwrite) bool _dividerImagesAreInvalid;
@property(setter=_setDividerImagesChangeWithSelection:,assign,readwrite) bool _dividerImagesChangeWithSelection;
@property(setter=_setHidesShadow:,assign,readwrite) bool _hidesShadow;
@property(setter=_setImageStyle:,assign,readwrite) long long _imageStyle;
@property(setter=_setInterTabButtonSpacing:,assign,readwrite) double _interTabButtonSpacing;
@property(setter=_setNextSelectionSlideDuration:,assign,readwrite) double _nextSelectionSlideDuration;
@property(setter=_setShowsHighlightedState:,assign,readwrite) bool _showsHighlightedState;
@property(setter=_setTabBarSizing:,assign,readwrite) long long _tabBarSizing;
@property(setter=_setTabButtonWidth:,assign,readwrite) double _tabButtonWidth;
...
@property(assign,readwrite) <UITabBarDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) long long itemPositioning;
@property(assign,readwrite) double itemSpacing;
...
@property(assign,readwrite) UITabBarItem * selectedItem;
