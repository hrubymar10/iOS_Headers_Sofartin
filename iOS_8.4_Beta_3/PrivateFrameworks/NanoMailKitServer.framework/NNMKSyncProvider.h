...
@property(assign,retain) NNMKAccountsSyncServiceServer * accountsSyncService;
@property(assign,retain) NNMKMessageContentSyncServiceServer * contentSyncService;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <NNMKSyncProviderDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,retain) NNMKFetchesSyncServiceServer * fetchesSyncService;
@property(assign,readonly) unsigned long long hash;
@property(assign,retain) PSYSyncCoordinator * initialSyncCoordinator;
@property(assign,retain) NSMutableSet * initialSyncMessageIdsOfContentToAck;
@property(assign,retain) NSMutableSet * initialSyncMessageIdsToSyncContent;
@property(assign,readwrite) unsigned long long initialSyncMessagesCount;
@property(assign,readwrite) double initialSyncProgress;
@property(assign,readwrite) unsigned long long initialSyncResendInterval;
@property(assign,readwrite) bool isFirstMessagesRequestPending;
@property(assign,retain) NSMutableSet * messageIdsToIgnoreStatusUpdates;
@property(assign,readwrite) bool messagesQueryAvailable;
@property(assign,readonly) bool messagesSyncActive;
@property(assign,retain) NNMKMessagesSyncServiceServer * messagesSyncService;
@property(assign,readwrite) bool messagesVerificationTriggered;
@property(assign,retain) BLTPingSubscriber * notificationsPingSubscriber;
@property(assign,readonly) bool organizeByThread;
@property(assign,readonly) NNMKPairedDeviceInfo * pairedDeviceInfo;
@property(assign,retain) NNMKDeviceSyncRegistry * pairedDeviceRegistry;
@property(assign,retain) NSDate * pendingMoreMessagesForConversationIdRequestBeforeDateReceived;
@property(assign,retain) NSString * pendingMoreMessagesForConversationIdRequestConversationId;
@property(assign,retain) NNMKProtectedSyncServiceServer * protectedSyncService;
@property(assign,retain) NSObject<OS_dispatch_queue> * providerQueue;
@property(assign,readonly) Class superclass;
@property(assign,readonly) NSString * syncedMailboxAccountId;
@property(assign,readonly) NSString * syncedMailboxCustomName;
@property(assign,readonly) unsigned long long syncedMailboxType;
@property(assign,readonly) NSURL * syncedMailboxURL;
@property(assign,readwrite) bool trackingInitialSync;
