...
@property(assign,readwrite) bool allowDuplicates;
@property(assign,readonly) bool allowsBioAuthorization;
@property(assign,copy) SSAuthenticationContext * authenticationContext;
@property(assign,readwrite) bool authorizationIsForced;
@property(assign,retain) NSArray * buttons;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) long long defaultButtonIndex;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool dismissOnHomeButton;
@property(assign,readwrite) bool dismissOnLock;
@property(assign,copy) NSString * displayCountKey;
@property(getter=isDisplayable,assign,readonly) bool displayable;
...
@property(assign,readwrite) long long maximumDisplayCount;
@property(assign,retain) NSString * message;
@property(assign,readwrite) bool noDefaultButton;
@property(assign,readwrite) bool oneButtonPerLine;
@property(assign,readwrite) bool shouldDismissAfterUnlock;
@property(assign,readwrite) bool shouldDisplayAsTopMost;
@property(assign,readwrite) bool shouldPendInSetupIfNotAllowed;
@property(assign,readonly) Class superclass;
@property(assign,retain) NSArray * textFields;
@property(assign,retain) NSString * title;
@property(assign,readwrite) long long unlockActionButtonIndex;
