...
@property(assign,retain) NSArray * advisoryNotices;
@property(assign,readwrite) bool allowsNetworkTileLoad;
@property(assign,readonly) GEOMapRegion * boundingMapRegion;
@property(assign,readonly) void* controlPoints;
@property(assign,readwrite) unsigned long long currentDisplayStep;
...
@property(assign,readwrite) unsigned int firstVisiblePoint;
@property(assign,readonly) GEORoute * geoRoute;
@property(assign,readonly) bool hasExpectedTime;
@property(assign,readonly) bool hasHistoricTravelTime;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) unsigned int historicTravelTime;
@property(assign,readonly) NSArray * legs;
@property(assign,readonly) unsigned int maneuverDisplayCount;
@property(assign,readwrite) bool maneuverDisplayEnabled;
@property(assign,retain) NSArray * maneuverDisplaySteps;
@property(assign,readonly) NSString * name;
@property(assign,retain) GEOComposedWaypoint * origin;
@property(assign,readonly) unsigned int pointCount;
@property(assign,readonly) NSData * routeID;
@property(assign,readonly) NSArray * routeNames;
@property(assign,readonly) int routeType;
@property(assign,readonly) NSArray * sections;
@property(assign,readwrite) unsigned long long selectedLegIndex;
@property(assign,readonly) NSArray * steps;
@property(assign,readonly) unsigned long long stepsCount;
