...
@property(assign,readwrite) bool endsOnFwy;
...
@property(assign,readwrite) bool hasEndsOnFwy;
@property(assign,readonly) bool hasExitNumber;
@property(assign,readwrite) bool hasExpectedTime;
@property(assign,readonly) bool hasHintFirstAnnouncementIndex;
@property(assign,readwrite) bool hasHintFirstAnnouncementZilchIndex;
@property(assign,readonly) bool hasInstructions;
@property(assign,readwrite) bool hasJunctionType;
@property(assign,readwrite) bool hasManeuverEndBasicIndex;
@property(assign,readwrite) bool hasManeuverEndZilchIndex;
@property(assign,readwrite) bool hasManeuverStartZilchIndex;
@property(assign,readwrite) bool hasManeuverType;
@property(assign,readonly) bool hasNotice;
@property(assign,readwrite) bool hasOverrideDrivingSide;
@property(assign,readwrite) bool hasOverrideTransportType;
...
@property(assign,readwrite) bool hasTollAhead;
@property(assign,readwrite) bool hasTollPrior;
@property(assign,readonly) int hintFirstAnnouncementIndex;
@property(assign,readwrite) int hintFirstAnnouncementZilchIndex;
@property(assign,retain) NSString * instructions;
...
@property(assign,readonly) struct { int x1; unsigned int x2; unsigned int x3; int x4; unsigned int x5; int x6; struct { unsigned int x_7_1_1 : 1; unsigned int x_7_1_2 : 1; unsigned int x_7_1_3 : 1; unsigned int x_7_1_4 : 1; unsigned int x_7_1_5 : 1; unsigned int x_7_1_6 : 1; } x7; }* laneGuidances;
@property(assign,readonly) unsigned long long laneGuidancesCount;
@property(assign,readwrite) int maneuverEndBasicIndex;
@property(assign,readonly) unsigned int maneuverEndIndex;
@property(assign,readwrite) int maneuverEndZilchIndex;
@property(assign,retain) NSMutableArray * maneuverNames;
@property(assign,readonly) unsigned int maneuverStartIndex;
@property(assign,readwrite) int maneuverStartZilchIndex;
@property(assign,readwrite) int maneuverType;
@property(assign,retain) NSString * notice;
@property(assign,readwrite) int overrideDrivingSide;
@property(assign,readwrite) int overrideTransportType;
@property(assign,retain) NSMutableArray * signposts;
@property(assign,readwrite) unsigned int stepID;
@property(assign,retain) NSMutableArray * substeps;
@property(assign,retain) GEOTimeCheckpoints * timeCheckpoints;
@property(assign,readwrite) bool toFreeway;
@property(assign,readwrite) bool tollAhead;
@property(assign,readwrite) bool tollPrior;
