...
@property(assign,readwrite) bool ignoreUnnamedFeatures;
@property(assign,readonly) GEOMapAccess * map;
@property(assign,copy) id pointHandler;
@property(assign,copy) id polygonHandler;
@property(assign,copy) id roadHandler;
