...
@property(assign,readonly) int* additionalTransportTypes;
@property(assign,readonly) unsigned long long additionalTransportTypesCount;
@property(assign,readwrite) int basicPointsToBeIncluded;
@property(assign,readwrite) bool hasBasicPointsToBeIncluded;
@property(assign,readwrite) bool hasIncludeContingencyRoutes;
@property(assign,readwrite) bool hasIncludeHistoricTravelTime;
@property(assign,readwrite) bool hasIncludeLaneGuidance;
@property(assign,readwrite) bool hasIncludeManeuverIcons;
@property(assign,readwrite) bool hasIncludePhonetics;
@property(assign,readwrite) bool hasIncludeSubsteps;
@property(assign,readwrite) bool hasIncludeTrafficAlongRoute;
@property(assign,readwrite) bool hasIncludeTrafficIncidents;
@property(assign,readwrite) bool hasIncludeZilchPoints;
@property(assign,readwrite) bool hasMainTransportType;
@property(assign,readonly) bool hasPhoneticLocaleIdentifier;
@property(assign,readwrite) bool hasTimepoint;
@property(assign,readwrite) bool hasTrafficType;
@property(assign,readwrite) bool hasWalkingLimitMeters;
@property(assign,readwrite) bool includeContingencyRoutes;
@property(assign,readwrite) bool includeHistoricTravelTime;
@property(assign,readwrite) bool includeLaneGuidance;
@property(assign,readwrite) bool includeManeuverIcons;
@property(assign,readwrite) bool includePhonetics;
@property(assign,readwrite) bool includeSubsteps;
@property(assign,readwrite) bool includeTrafficAlongRoute;
@property(assign,readwrite) bool includeTrafficIncidents;
@property(assign,readwrite) bool includeZilchPoints;
@property(assign,readwrite) int mainTransportType;
...
@property(assign,readwrite) int trafficType;
@property(assign,readwrite) unsigned int walkingLimitMeters;
