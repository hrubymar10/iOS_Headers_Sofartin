...
@property(assign,retain) NSDictionary * TXTRecord;
@property(assign,readwrite) long long accessState;
@property(assign,readonly) long long accessState;
@property(assign,readonly) bool hasIdentifyPrinterOp;
@property(assign,readonly) bool hasPrintInfoSupported;
@property(assign,retain) NSString * hostname;
@property(assign,readonly) bool isAdobeRGBSupported;
@property(assign,readwrite) bool isFromMCProfile;
@property(assign,readonly) bool isIPPS;
@property(assign,readwrite) bool isLocal;
@property(assign,readonly) long long jobTypesSupported;
@property(assign,readonly) long long kind;
@property(assign,readonly) NSString * name;
@property(assign,readonly) bool needsSetup;
@property(assign,retain) PKPaperList * paperList;
@property(assign,retain) NSNumber * port;
@property(assign,readonly) NSDictionary * printInfoSupported;
@property(assign,readonly) NSURL * printerURL;
@property(assign,retain) NSString * scheme;
@property(assign,readonly) bool setupSupportsPasswordScope;
