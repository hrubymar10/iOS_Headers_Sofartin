...
@property(assign,retain) NSArray * duplexPapers;
@property(assign,readwrite) bool hasMediaReady;
@property(assign,retain) NSArray * papers;
@property(assign,retain) NSArray * photoPapers;
@property(assign,retain) NSArray * rolls;
@property(assign,retain) NSArray * simplexPapers;
