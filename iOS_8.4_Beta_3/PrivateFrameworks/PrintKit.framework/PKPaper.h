...
@property(assign,readwrite) int bottomMargin;
@property(assign,readonly) unsigned long long bottomMarginInPoints;
@property(assign,readwrite) int height;
@property(assign,readonly) double imageableArea;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } imageableAreaRect;
@property(assign,readonly) bool isBorderless;
@property(assign,readonly) bool isRoll;
@property(assign,readonly) bool isTransverse;
@property(assign,readwrite) int leftMargin;
@property(assign,retain) NSString * localizedName;
@property(assign,readonly) unsigned long long maxCutLength;
@property(assign,readonly) int maxHeight;
@property(assign,copy) NSDictionary * mediaInfo;
@property(assign,retain) NSString * mediaType;
@property(assign,retain) NSString * mediaTypeName;
@property(assign,readonly) unsigned long long minCutLength;
@property(assign,readonly) int minHeight;
@property(assign,retain) NSString * name;
@property(assign,readonly) struct CGSize { double x1; double x2; } paperSize;
@property(assign,readwrite) int rightMargin;
@property(assign,readwrite) int topMargin;
@property(assign,readonly) unsigned long long topMarginInPoints;
