...
@property(assign,readonly) TSTLayoutSpaceBezierPathCache * bezierPathCache;
@property(assign,readonly) TSTLayoutSpaceBundle * bundle;
@property(assign,readwrite) bool drawBlackAndWhite;
@property(assign,readwrite) bool drawPreventAntialias;
@property(assign,readwrite) bool headerColumnsRepeat;
@property(assign,readwrite) bool headerRowsRepeat;
@property(assign,readonly) bool isColumns;
@property(assign,readonly) bool isCorner;
@property(assign,readonly) bool isFrozen;
@property(assign,readonly) bool isMain;
@property(assign,readonly) bool isRepeat;
@property(assign,readonly) bool isRows;
@property(assign,readonly) TSTLayout * layout;
@property(assign,readonly) bool layoutDirectionIsLeftToRight;
@property(assign,readonly) int layoutSpaceType;
@property(assign,readonly) TSTMasterLayout * masterLayout;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } tableOffset;
@property(assign,readwrite) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } transformFromCanvas;
@property(assign,readwrite) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } transformFromDevice;
@property(assign,readwrite) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } transformToCanvas;
@property(assign,readwrite) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } transformToDevice;
