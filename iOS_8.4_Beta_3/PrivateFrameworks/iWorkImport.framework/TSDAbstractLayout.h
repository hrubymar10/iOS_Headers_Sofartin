...
@property(assign,copy) NSArray * children;
@property(assign,copy) TSDLayoutGeometry * geometry;
@property(assign,readwrite) double interimPositionX;
@property(assign,readwrite) double interimPositionY;
@property(assign,readonly) struct CGPoint { double x1; double x2; } lastInterimPosition;
@property(assign,readonly) unsigned int pageIndex;
@property(assign,readonly) TPPageLayout * pageLayout;
@property(assign,readwrite) TSDAbstractLayout * parent;
@property(assign,readonly) TSDAbstractLayout * root;
