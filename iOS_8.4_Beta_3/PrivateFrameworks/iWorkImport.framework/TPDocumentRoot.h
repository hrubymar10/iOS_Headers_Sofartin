...
@property(assign,retain) TSWPChangeSession * activeChangeSession;
@property(assign,retain) TSWPStorage * bodyStorage;
@property(assign,readwrite) double bottomMargin;
@property(assign,retain) NSArray * changeSessionHistory;
@property(getter=isChangeTrackingEnabled,assign,readwrite) bool changeTrackingEnabled;
@property(getter=isChangeTrackingPaused,assign,readwrite) bool changeTrackingPaused;
@property(assign,retain) NSMutableDictionary * chartsUIState;
@property(assign,readonly) long long contentWritingDirection;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,retain) TPDrawablesZOrder * drawablesZOrder;
@property(assign,retain) TPSection * firstSection;
@property(assign,retain) TPFloatingDrawables * floatingDrawables;
@property(assign,readwrite) double footerMargin;
@property(assign,readonly) bool hasTrackedChanges;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) double headerMargin;
@property(assign,readwrite) bool initiallyShowRuler;
@property(assign,readwrite) TPInteractiveCanvasController * interactiveCanvasController;
@property(assign,readonly) bool isNewDocument;
@property(assign,readonly) bool isTrackingChanges;
@property(assign,readwrite) bool layoutBodyVertically;
@property(assign,readwrite) double leftMargin;
@property(assign,retain) TSWPChangeSession * mostRecentChangeSession;
@property(assign,retain) NSArray * nonHiddenSections;
@property(assign,readwrite) unsigned long long orientation;
@property(assign,readwrite) double pageScale;
@property(assign,readwrite) struct CGSize { double x1; double x2; } pageSize;
@property(assign,readonly) TPPaginatedPageController * paginatedPageController;
...
@property(assign,retain) TPDocumentSettings * settings;
@property(assign,retain) TSSStylesheet * stylesheet;
@property(assign,readonly) Class superclass;
@property(assign,retain) TPTheme * theme;
@property(assign,readonly) TSDThumbnailController * thumbnailController;
@property(assign,retain) TPTOCController * tocController;
@property(assign,readwrite) double topMargin;
@property(getter=isTrackingChanges,assign,readonly) bool trackingChanges;
