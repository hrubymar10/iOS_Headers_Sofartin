...
@property(assign,readonly) /* Warning: unhandled struct encoding: '{vector<glm::detail::tvec2<float>' */ struct * container; /* unknown property attribute:  std::__1::allocator<glm::detail::tvec2<float> > >=^{tvec2<float>}}} */
