...
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } computedEditingCellContentFrame;
@property(assign,retain) TSWPLayout * containedTextEditingLayout;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readonly) struct TSUColumnRowRect { struct { unsigned short x_1_1_1; unsigned char x_1_1_2; unsigned char x_1_1_3; } x1; struct { unsigned short x_2_1_1; unsigned short x_2_1_2; } x2; } editingSpillingTextRange;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) bool layoutDirectionIsLeftToRight;
@property(assign,retain) TSTLayoutHint * layoutHint;
@property(assign,readonly) TSWPPadding * layoutMargins;
@property(assign,readwrite) TSTMasterLayout * masterLayout;
@property(assign,readwrite) bool newCanvasRevealedHorizontally;
@property(assign,readwrite) bool newCanvasRevealedVertically;
@property(assign,readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } paddingForEditingCell;
@property(assign,readonly) unsigned long long pageCount;
@property(assign,readonly) unsigned long long pageNumber;
@property(assign,readwrite) struct TSUColumnRowRect { struct { unsigned short x_1_1_1; unsigned char x_1_1_2; unsigned char x_1_1_3; } x1; struct { unsigned short x_2_1_1; unsigned short x_2_1_2; } x2; } prevEditingSpillingTextRange;
@property(assign,readwrite) bool processChangesFiltering;
@property(assign,readwrite) struct CGSize { double x1; double x2; } scaleToFit;
@property(assign,readonly) bool shrinkTextToFit;
@property(assign,retain) TSTLayoutSpaceBundle * spaceBundle;
