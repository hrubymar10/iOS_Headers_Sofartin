...
@property(assign,retain) KNSlideBackgroundInfo * background;
@property(assign,readonly) TSDFill * backgroundFill;
@property(assign,retain) KNBodyPlaceholderInfo * bodyPlaceholder;
@property(getter=isBodyVisible,assign,readonly) bool bodyVisible;
@property(assign,readonly) unsigned long long buildChunkCount;
@property(assign,readonly) NSArray * buildChunks;
@property(assign,readonly) unsigned long long buildCount;
@property(assign,copy) NSSet * builds;
@property(assign,readonly) NSArray * buildsGroupedByDeliveryGroup;
@property(assign,copy) NSString * debugDescription;
@property(assign,readonly) unsigned long long deliveryGroupCount;
...
@property(assign,readonly) bool hasFreeformTextPlaceholders;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) bool inDocument;
@property(assign,readonly) NSArray * infosToDisplay;
...
@property(assign,retain) KNObjectPlaceholderInfo * objectPlaceholder;
@property(getter=isObjectVisible,assign,readonly) bool objectVisible;
@property(assign,readonly) NSArray * ownedChildInfos;
...
@property(assign,copy) NSDictionary * placeholdersForTags;
@property(assign,readwrite) KNSlideNode * slideNode;
@property(assign,readonly) KNSlideNode * slideNode;
@property(assign,retain) KNSlideNumberPlaceholderInfo * slideNumberPlaceholder;
@property(getter=isSlideNumberVisible,assign,readonly) bool slideNumberVisible;
@property(assign,retain) KNSlideStyle * style;
@property(assign,readonly) Class superclass;
@property(assign,retain) KNTitlePlaceholderInfo * titlePlaceholder;
@property(getter=isTitleVisible,assign,readonly) bool titleVisible;
@property(assign,retain) KNTransition * transition;
