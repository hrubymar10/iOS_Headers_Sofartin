...
@property(assign,readonly) NSArray * allTextures;
@property(assign,retain) CALayer * alternateLayer;
...
@property(assign,retain) NSDictionary * boundingRectForStage;
...
@property(assign,readwrite) bool isBaked;
@property(assign,readwrite) bool isFlippedHorizontally;
...
@property(assign,readonly) long long maxStageIndex;
@property(assign,readwrite) long long objectType;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } originalPosition;
@property(assign,readwrite) TSDRep * rep;
@property(assign,readwrite) bool shouldIncludeFinalTexturesInVisibleSet;
@property(assign,readwrite) bool shouldTransformUsingTextureCenter;
@property(assign,readonly) long long stageIndex;
@property(assign,readwrite) double textureAngle;
@property(assign,readwrite) double textureAnimationPercent;
@property(assign,readwrite) double textureOpacity;
@property(assign,readwrite) long long textureZOrder;
@property(assign,readonly) NSArray * visibleTextures;
