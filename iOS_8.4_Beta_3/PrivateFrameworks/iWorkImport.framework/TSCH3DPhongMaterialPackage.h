...
@property(assign,retain) TSCH3DDiffuseMaterial * diffuse;
@property(assign,retain) TSCH3DEmissiveMaterial * emissive;
@property(assign,retain) TSCH3DModulateMaterial * modulate;
@property(assign,retain) TSCH3DShininessMaterial * shininess;
@property(assign,retain) TSCH3DSpecularMaterial * specular;
