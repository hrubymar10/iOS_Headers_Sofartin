...
@property(assign,retain) TSPData * adjustedImageData;
...
@property(assign,readonly) bool canPasteAsPDF;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,retain) TSPData * enhancedImageData;
...
@property(assign,copy) TSDImageAdjustments * imageAdjustments;
@property(assign,retain) TSPData * imageData;
@property(assign,readonly) TSDMediaStyle * imageStyle;
@property(getter=isInlineWithText,assign,readonly) bool inlineWithText;
@property(assign,retain) TSUBezierPath * instantAlphaPath;
@property(assign,readwrite) bool interpretsUntaggedImageDataAsGeneric;
@property(assign,retain) TSDMaskInfo * maskInfo;
...
@property(assign,retain) TSPData * thumbnailAdjustedImageData;
@property(assign,retain) TSPData * thumbnailImageData;
@property(assign,readonly) TSUBezierPath * tracedPath;
