...
@property(assign,readwrite) unsigned long long anchoredCharCount;
@property(assign,readwrite) struct _NSRange { unsigned long long x1; unsigned long long x2; } anchoredRange;
@property(assign,readwrite) unsigned long long characterCount;
@property(assign,readwrite) unsigned long long columnIndex;
@property(assign,readwrite) double contentBottom;
@property(assign,readonly) unsigned long long countLines;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readwrite) double erasableContentBottom;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } frameBounds;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) int layoutResultFlags;
@property(assign,readwrite) unsigned long long nextWidowPullsDownFromCharIndex;
...
@property(assign,readwrite) unsigned long long scaleTextPercent;
@property(assign,readwrite) unsigned long long startAnchoredCharIndex;
@property(assign,readwrite) unsigned long long startCharIndex;
@property(assign,readonly) TSWPStorage * storage;
@property(assign,readwrite) unsigned long long storageChangeCount;
@property(assign,retain) <TSWPStyleProvider> * styleProvider;
@property(assign,readonly) Class superclass;
@property(assign,readonly) double textBottom;
@property(assign,readwrite) bool textIsVertical;
@property(assign,readwrite) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } transformFromWP;
@property(assign,readonly) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } transformToWP;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } typographicBoundsForCell;
@property(assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } wpBounds;
