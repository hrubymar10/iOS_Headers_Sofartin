...
@property(assign,retain) TSCHChartType * chartType;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) struct { bool x1; bool x2; bool x3; bool x4; bool x5; bool x6; unsigned long long x7; } defaultLayoutSettings;
@property(assign,copy) NSString * description;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool displayMessageOnRepCreation;
@property(assign,readonly) TSSStylesheet * documentStylesheet;
@property(assign,readonly) TSCHChartDrawableInfo * drawableInfo;
@property(assign,copy) TSDInfoGeometry * geometry;
@property(assign,readonly) int gridDirection;
@property(assign,readonly) bool hasSetDefaultLayoutSettings;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) double informationalMessageDuration;
@property(assign,retain) NSString * informationalMessageString;
@property(assign,readonly) bool isPhantom;
@property(assign,copy) NSString * lastAppliedFillSetLookupString;
@property(assign,retain) TSCHLegendModel * legend;
@property(assign,retain) TSCHChartMediator * mediator;
@property(assign,readonly) struct CGSize { double x1; double x2; } minimumChartBodySize;
@property(assign,retain) TSCHChartModel * model;
@property(assign,readonly) unsigned long long multiDataSetIndex;
@property(assign,readonly) TSCHChartStylePreset * preset;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } previewOrigin;
@property(assign,readonly) TSCHChartLayoutCache * sceneAreaLayoutItemCache;
@property(assign,readonly) Class superclass;
@property(assign,readonly) Class superclass;
@property(assign,readonly) bool wantsDeferredUpgradeOrImport;
...
- (id)create3DSceneWithLayoutSettings:(const struct { bool x1; bool x2; bool x3; bool x4; bool x5; bool x6; unsigned long long x7; }*)arg1;
- (void)dealloc;
- (void)debugLayoutCache;
- (struct { bool x1; bool x2; bool x3; bool x4; bool x5; bool x6; unsigned long long x7; })defaultLayoutSettings;
...
- (void)setDefaultLayoutSettings:(struct { bool x1; bool x2; bool x3; bool x4; bool x5; bool x6; unsigned long long x7; })arg1;
