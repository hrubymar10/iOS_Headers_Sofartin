...
@property(assign,copy) NSArray * effects;
@property(assign,readwrite) /* Warning: unhandled struct encoding: '{RenderState=BiBBBBBff{EnableClipDistances={array<bool' */ struct  renderState; /* unknown property attribute:  8>=[8B]}}} */
...
@property(assign,retain) TSCH3DResource * texcoords;
...
@property(assign,copy) id updateShaderEffectsStatesBlock;
@property(assign,retain) TSCH3DResource * vertices;
@property(assign,readwrite) struct tvec4<float> { union { float x_1_1_1; float x_1_1_2; float x_1_1_3; } x1; union { float x_2_1_1; float x_2_1_2; float x_2_1_3; } x2; union { float x_3_1_1; float x_3_1_2; float x_3_1_3; } x3; union { float x_4_1_1; float x_4_1_2; float x_4_1_3; } x4; } wipeColor;
@property(assign,readwrite) bool wipeTarget;
