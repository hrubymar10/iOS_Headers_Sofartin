...
@property(assign,readonly) float depthLimitFactor;
@property(assign,readonly) float p_sageInterSetDepthGapProperty;
@property(assign,readonly) long long seriesCount;
@property(assign,readonly) float shadowCameraDepthLimitAdjustmentFactor;
...
- (void)reset;
- (void)resetWithEnumerator:(id)arg1 layoutSettings:(struct { bool x1; bool x2; bool x3; bool x4; bool x5; bool x6; unsigned long long x7; })arg2;
