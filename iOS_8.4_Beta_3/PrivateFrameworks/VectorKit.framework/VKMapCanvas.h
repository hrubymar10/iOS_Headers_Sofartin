...
@property(assign,readwrite) <VKInteractiveMapDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool dynamicMapModesEnabled;
@property(assign,readonly) VKAnchorWrapper * externalAnchors;
...
@property(assign,readonly) VKMapModel * map;
