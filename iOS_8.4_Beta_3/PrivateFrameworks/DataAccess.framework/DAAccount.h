...
@property(assign,readonly) NSArray * appIdsForPasswordPrompt;
@property(assign,readonly) ACAccount * backingAccountInfo;
@property(assign,readonly) NSString * changeTrackingID;
@property(assign,copy) NSString * clientToken;
@property(setter=setDAAccountVersion:,assign,readwrite) int daAccountVersion;
@property(assign,retain) NSMutableDictionary * dataclassPropertyURLsByDataclass;
@property(assign,copy) NSString * emailAddress;
@property(assign,copy) NSArray * emailAddresses;
@property(assign,readonly) long long enabledDataclassesBitmask;
@property(assign,retain) NSData * encryptionIdentityPersistentReference;
@property(assign,copy) NSString * host;
@property(assign,copy) NSData * identityPersist;
@property(assign,readonly) bool isChildAccount;
@property(assign,readwrite) bool isValidating;
@property(assign,readonly) int keychainAccessibilityType;
@property(assign,readwrite) unsigned long long lastQueryStartedTime;
@property(assign,copy) NSString * password;
@property(assign,retain) NSMutableArray * pendingQueries;
@property(assign,retain) NSObject<OS_dispatch_queue> * pendingQueryQueue;
@property(assign,copy) NSString * persistentUUID;
@property(assign,readwrite) long long port;
@property(assign,copy) NSString * principalPath;
@property(assign,copy) NSURL * principalURL;
@property(assign,readonly) NSString * scheduleIdentifier;
@property(assign,copy) NSString * scheme;
@property(assign,readonly) NSSet * serverComplianceClasses;
@property(assign,readonly) NSString * serverRoot;
@property(assign,readonly) bool shouldAutodiscoverAccountProperties;
@property(assign,readwrite) bool shouldDoInitialAutodiscovery;
@property(assign,readonly) bool shouldFailAllTasks;
@property(assign,readwrite) bool shouldUseOpportunisticSockets;
@property(assign,retain) NSData * signingIdentityPersistentReference;
@property(assign,retain) DAStatusReport * statusReport;
@property(assign,readonly) DATaskManager * taskManager;
@property(assign,retain) DATrustHandler * trustHandler;
@property(assign,readwrite) bool useSSL;
@property(assign,copy) NSString * user;
@property(assign,readonly) NSString * userAgentHeader;
@property(assign,copy) NSString * username;
@property(assign,readwrite) bool wasUserInitiated;
