...
@interface MusicNowPlayingTransitionController : NSObject <UIViewControllerAnimatedTransitioning> {
    ...
    id _transitionRubberBandEffectBlock;
...
- (void)animateTransition:(id)arg1 withDuration:(double)arg2 initialVelocity:(double)arg3 interactively:(bool)arg4 toFinalPositions:(bool)arg5 completion:(id)arg6;
