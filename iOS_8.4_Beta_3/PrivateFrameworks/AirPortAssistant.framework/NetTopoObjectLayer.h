...
@property(assign,readwrite) NetTopoObjectLayer * ancestor;
@property(assign,retain) id associatedNode;
@property(assign,readwrite) struct CGSize { double x1; double x2; } boundsSizeConstraint;
@property(assign,readwrite) double change;
@property(assign,retain) NSMutableArray * children;
@property(assign,readwrite) unsigned long long column;
@property(assign,readwrite) NetTopoObjectLayer * contourThread;
@property(getter=isExpanded,assign,readwrite) bool expanded;
@property(getter=isGhosted,assign,readwrite) bool ghosted;
@property(assign,retain) NSString * label;
@property(assign,readwrite) double labelPinnedHeight;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } layoutOrigin;
@property(assign,readwrite) double layoutScale;
@property(assign,readwrite) double mod;
@property(assign,readwrite) unsigned long long number;
@property(assign,readonly) unsigned long long numberOfChildren;
@property(assign,retain) struct CGImage { }* objectImage;
@property(assign,readwrite) id owningView;
@property(assign,retain) NetTopoObjectLayer * parent;
@property(assign,readonly) NetTopoObjectLayer * parentDevice;
@property(assign,readwrite) double prelim;
@property(assign,readwrite) unsigned long long row;
@property(assign,retain) NSString * saveLabel;
@property(assign,retain) NSString * secondaryLabel;
@property(getter=isSelectable,assign,readwrite) bool selectable;
@property(getter=isSelected,assign,readwrite) bool selected;
@property(assign,readwrite) double shift;
@property(assign,readwrite) bool smallSize;
@property(assign,retain) UIImage * statusBadgeImage;
@property(assign,readwrite) unsigned int statusLightMode;
@property(assign,readwrite) unsigned long long topoBadgeNumber;
@property(assign,readwrite) float topoProgressValue;
@property(assign,retain) id userObject;
