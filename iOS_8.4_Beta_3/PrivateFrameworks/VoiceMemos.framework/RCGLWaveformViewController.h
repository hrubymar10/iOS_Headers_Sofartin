...
@property(getter=isAutoscrolling,assign,readonly) bool autoscrolling;
@property(assign,readwrite) bool capturing;
@property(assign,readwrite) bool clipTimeMarkersToDuration;
@property(assign,readwrite) double currentTime;
@property(assign,readwrite) unsigned long long currentTimeDisplayOptions;
@property(assign,retain) RCWaveformDataSource * dataSource;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <RCGLWaveformViewDelegate> * delegate;
...
@property(assign,readwrite) struct { double x1; double x2; } selectedTimeRange;
@property(getter=isSelectedTimeRangeEditingEnabled,assign,readwrite) bool selectedTimeRangeEditingEnabled;
@property(getter=isSelectedTimeRangeEditingEnabled,assign,readwrite) bool selectedTimeRangeScrubbingEnabled;
@property(assign,readwrite) double selectionVisibleMargin;
