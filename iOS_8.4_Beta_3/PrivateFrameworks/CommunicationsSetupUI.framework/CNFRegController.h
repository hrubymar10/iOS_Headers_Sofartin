...
@property(assign,copy) id accountActivationChangedBlock;
@property(assign,copy) id accountAddedBlock;
@property(assign,copy) id accountAuthorizationChangedBlock;
@property(assign,copy) id accountRegistrationBlock;
@property(assign,copy) id accountRemovedBlock;
@property(assign,copy) NSArray * accounts;
@property(assign,copy) id alertHandler;
@property(assign,copy) id aliasAddedBlock;
@property(assign,copy) id aliasRemovedBlock;
@property(assign,copy) id aliasStatusChangedBlock;
@property(assign,retain) NSArray * aliases;
@property(assign,retain) NSArray * allAvailableAliases;
@property(assign,copy) NSArray * appleIDAccounts;
@property(assign,copy) NSDictionary * cachedCallerIDMap;
@property(assign,copy) id callerIdChangedBlock;
@property(assign,retain) NSArray * emailAliases;
@property(assign,copy) NSArray * failedAccounts;
@property(assign,retain) IMServiceImpl * firstService;
@property(assign,copy) NSArray * phoneAccounts;
@property(assign,copy) id profileChangedBlock;
@property(assign,copy) id profileStatusChangedBlock;
@property(assign,copy) id resetBlock;
@property(assign,copy) id serviceDidBecomeUnsupportedBlock;
@property(getter=isServiceEnabled,assign,readwrite) bool serviceEnabled;
@property(assign,retain) NSSet * serviceNames;
@property(getter=isServiceSupported,assign,readonly) bool serviceSupported;
@property(assign,readwrite) long long serviceType;
@property(assign,copy) NSArray * services;
@property(assign,retain) IMAccount * systemAccount;
@property(assign,readonly) long long systemAccountType;
@property(assign,retain) NSArray * useableAliases;
@property(assign,retain) NSArray * vettedAliases;
@property(assign,copy) id vettedAliasesChangedBlock;
@property(assign,copy) id willLaunchURLBlock;
