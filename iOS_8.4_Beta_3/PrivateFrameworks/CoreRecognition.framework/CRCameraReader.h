...
@property(assign,retain) CRAlignmentLayer * alignmentLayer;
@property(assign,retain) CRBoxLayer * boxLayer;
@property(assign,retain) NSTimer * boxLayerHideTimer;
@property(assign,readwrite) <CRCameraReaderDelegate> * callbackDelegate;
@property(assign,copy) NSString * cameraMode;
@property(assign,readwrite) long long cameraPosition;
@property(assign,retain) NSPointerArray * captureBuffer;
@property(assign,readwrite) unsigned long long captureCount;
@property(getter=isCaptureMode,assign,readwrite) bool captureMode;
@property(assign,retain) NSMutableDictionary * cardNumberCounts;
@property(assign,retain) NSMutableDictionary * cardholderCounts;
@property(assign,readwrite) bool codeInverted;
@property(assign,retain) NSDate * codePresented;
@property(assign,readwrite) double configDemoSpeed;
@property(assign,readwrite) bool configExperimentalMode;
@property(assign,readwrite) bool configPresentCentered;
@property(assign,readwrite) bool configUseFastScanning;
@property(assign,readwrite) bool configUseJPEGForColor;
@property(assign,readwrite) bool continousMode;
@property(assign,readonly) long long currentCameraIdentifier;
@property(assign,retain) NSMutableArray * dateCutRects;
@property(assign,copy) NSString * debugDescription;
@property(assign,retain) NSObject<OS_dispatch_queue> * delegateQueue;
@property(assign,copy) NSString * description;
@property(assign,retain) DiagnosticHUDLayer * diagnosticHUDLayer;
@property(assign,readwrite) bool didSendEndOrCancel;
@property(assign,readwrite) bool didSendFindBox;
@property(assign,retain) NSMutableDictionary * expirationDateCounts;
@property(assign,readwrite) long long exposureMode;
@property(assign,readwrite) long long focusMode;
@property(assign,retain) NSString * foundCode;
@property(assign,readwrite) bool foundNumberEmbossed;
@property(assign,readwrite) bool foundNumberFixedSapphire;
@property(assign,readwrite) bool foundNumberFixedSlate;
@property(assign,readwrite) bool foundNumberFlatISO;
@property(assign,readwrite) bool foundNumberFreeform;
@property(assign,readwrite) bool foundNumberPortrait;
@property(assign,readwrite) bool foundNumberTextDetector;
@property(assign,retain) NSArray * foundPoints;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) bool hidePlacementText;
@property(assign,readwrite) unsigned long long imagesToCapture;
@property(assign,readwrite) struct opaqueCMSampleBuffer { }* lastBuffer;
@property(assign,retain) NSDate * lastFieldFoundDate;
@property(assign,retain) NSDate * lastFoundNumberDate;
@property(assign,retain) NSDate * lastSendFindBox;
@property(assign,retain) NSMutableArray * nameCutRects;
@property(assign,copy) NSArray * outputObjectTypes;
@property(assign,retain) NSMutableDictionary * pinnedFoundInfo;
@property(assign,retain) NSDate * pointsFound;
@property(assign,readwrite) struct OpaqueVTPixelTransferSession { }* previewScaleSession;
@property(assign,readwrite) bool previousIdleState;
@property(assign,retain) NSObject<OS_dispatch_semaphore> * processingImage;
@property(assign,retain) NSObject<OS_dispatch_queue> * processingQueue;
@property(assign,retain) CRCaptureSessionManager * sessionManager;
@property(assign,retain) NSDate * sessionStarted;
