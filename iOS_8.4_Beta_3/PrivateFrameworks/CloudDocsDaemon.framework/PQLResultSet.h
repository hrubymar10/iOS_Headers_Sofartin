...
- (struct PQLResultSet { Class x1; id x2; Class x3; SEL x4; bool x5; id x6; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x7; id x8; bool x9; bool x10; id x11; id x12; unsigned long long x13; unsigned long long x14; id x15; }*)enumerateObjects:(id)arg1;
- (struct PQLResultSet { Class x1; id x2; Class x3; SEL x4; bool x5; id x6; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x7; id x8; bool x9; bool x10; id x11; id x12; unsigned long long x13; unsigned long long x14; id x15; }*)enumerateObjectsOfClass:(Class)arg1;
- (struct PQLResultSet { Class x1; id x2; Class x3; SEL x4; bool x5; id x6; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x7; id x8; bool x9; bool x10; id x11; id x12; unsigned long long x13; unsigned long long x14; id x15; }*)enumerateObjectsOfClass:(Class)arg1 initializer:(SEL)arg2;
- (id)error;
