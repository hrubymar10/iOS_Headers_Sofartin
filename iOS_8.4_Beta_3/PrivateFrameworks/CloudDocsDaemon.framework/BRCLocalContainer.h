...
@property(assign,readonly) unsigned long long currentRequestID;
@property(assign,readonly) PQLConnection * db;
@property(assign,retain) NSNumber * dbRowID;
@property(assign,readonly) NSNumber * deepScanStamp;
@property(assign,retain) <BRCLocalContainerDelegate> * delegate;
@property(assign,readonly) NSNumber * fileID;
@property(assign,readonly) NSNumber * generationID;
@property(assign,readonly) bool hasActiveAliasQueries;
@property(assign,readonly) bool hasActiveQueries;
@property(assign,readonly) bool hasActiveRecursiveQueries;
@property(assign,readonly) bool hasHighPriorityWatchers;
@property(assign,readonly) bool isForeground;
@property(assign,readonly) bool isGreedy;
@property(assign,readonly) bool isPrivateContainer;
@property(assign,readonly) bool isSharedContainer;
@property(assign,readonly) long long lastInsertedRank;
@property(assign,readonly) unsigned long long lostHeapKey;
...
@property(assign,readonly) NSMutableIndexSet * pendingCoordinatedIOs;
...
@property(assign,readonly) BRCDeadlineToken * syncDeadlineToken;
@property(assign,readonly) unsigned int syncState;
