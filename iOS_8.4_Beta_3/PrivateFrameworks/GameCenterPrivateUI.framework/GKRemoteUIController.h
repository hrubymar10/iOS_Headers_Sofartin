...
@property(assign,readonly) NSURL * fallbackURL;
...
@property(assign,copy) id loadHandler;
@property(assign,retain) RUILoader * loader;
@property(assign,readwrite) bool loading;
@property(assign,readwrite) bool loadingInitialUI;
@property(assign,readwrite) UINavigationController * navigationController;
@property(assign,retain) NSMutableArray * objectModels;
@property(assign,retain) NSString * playerID;
@property(assign,retain) GKRemoteUIController * presentedRemoteUIController;
@property(assign,readwrite) bool previousUseCustomBackButtonActionValue;
@property(assign,retain) NSData * pushToken;
@property(assign,readwrite) bool shouldApplyGameCenterTheme;
@property(assign,retain) NSArray * staticViewControllers;
