...
@property(assign,retain) AXHearingAidMode * currentLeftProgram;
@property(assign,retain) AXHearingAidMode * currentRightProgram;
...
@property(assign,readwrite) bool isPersistent;
...
@property(assign,readwrite) long long leftLoadedProperties;
@property(assign,readwrite) double leftMicrophoneVolume;
@property(assign,retain) CBPeripheral * leftPeripheral;
@property(assign,retain) NSString * leftPeripheralUUID;
@property(assign,readwrite) unsigned int leftPresetBitmask;
@property(assign,readwrite) long long leftProgramVersion;
@property(assign,copy) NSArray * leftPrograms;
@property(assign,retain) NSMutableDictionary * leftPropertiesLoadCount;
...
@property(assign,readwrite) long long leftWriteRequestProperties;
@property(assign,readwrite) long long leftWriteResponseProperties;
...
@property(assign,readwrite) long long rightLoadedProperties;
@property(assign,readwrite) double rightMicrophoneVolume;
@property(assign,retain) CBPeripheral * rightPeripheral;
@property(assign,retain) NSString * rightPeripheralUUID;
@property(assign,readwrite) unsigned int rightPresetBitmask;
@property(assign,readwrite) long long rightProgramVersion;
@property(assign,copy) NSArray * rightPrograms;
@property(assign,retain) NSMutableDictionary * rightPropertiesLoadCount;
...
@property(assign,readwrite) long long rightWriteRequestProperties;
@property(assign,readwrite) long long rightWriteResponseProperties;
