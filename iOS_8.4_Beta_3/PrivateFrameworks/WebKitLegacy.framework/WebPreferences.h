...
@property(assign,readwrite) bool allowsAnimatedImageLooping;
@property(assign,readwrite) bool allowsAnimatedImages;
@property(assign,readwrite) bool autosaves;
@property(assign,readwrite) unsigned long long cacheModel;
@property(assign,copy) NSString * cursiveFontFamily;
@property(assign,readwrite) int defaultFixedFontSize;
@property(assign,readwrite) int defaultFontSize;
@property(assign,copy) NSString * defaultTextEncodingName;
@property(assign,copy) NSString * fantasyFontFamily;
@property(assign,copy) NSString * fixedFontFamily;
@property(assign,copy) NSString * identifier;
@property(getter=isJavaEnabled,assign,readwrite) bool javaEnabled;
@property(assign,readwrite) bool javaScriptCanOpenWindowsAutomatically;
@property(getter=isJavaScriptEnabled,assign,readwrite) bool javaScriptEnabled;
@property(assign,readwrite) bool loadsImagesAutomatically;
@property(assign,readwrite) int minimumFontSize;
@property(assign,readwrite) int minimumLogicalFontSize;
@property(getter=arePlugInsEnabled,assign,readwrite) bool plugInsEnabled;
@property(assign,readwrite) bool privateBrowsingEnabled;
@property(assign,copy) NSString * sansSerifFontFamily;
@property(assign,copy) NSString * serifFontFamily;
@property(assign,copy) NSString * standardFontFamily;
@property(assign,readwrite) bool suppressesIncrementalRendering;
@property(assign,readwrite) bool userStyleSheetEnabled;
@property(assign,retain) NSURL * userStyleSheetLocation;
@property(assign,readwrite) bool usesPageCache;
