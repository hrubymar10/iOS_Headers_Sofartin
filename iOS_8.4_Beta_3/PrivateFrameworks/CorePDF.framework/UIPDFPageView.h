...
@property(assign,readwrite) bool allowHighlighting;
@property(assign,readwrite) bool allowMenu;
@property(assign,readwrite) bool allowSelection;
@property(assign,readwrite) bool allowTwoFingerSelection;
@property(assign,readwrite) bool animateSetFrame;
@property(assign,readonly) UIPDFAnnotationController * annotationController;
@property(assign,retain) UIImage * backgroundImage;
@property(assign,retain) UIColor * backingLayerColor;
@property(assign,readonly) CALayer * contentLayer;
@property(assign,readwrite) <NSObject><UIPDFPageViewDelegate> * delegate;
@property(assign,retain) UIPDFDocument * document;
@property(assign,readonly) CALayer * effectsLayer;
@property(assign,readonly) struct CGColor { }* highLightColor;
...
@property(assign,readwrite) UIPDFSelectionController * selectionController;
@property(assign,readwrite) bool showActivityIndicator;
@property(assign,readwrite) bool showAnnotations;
@property(assign,readwrite) bool showLinkAnnotationUnderline;
@property(assign,readwrite) bool showTextAnnotations;
@property(assign,readwrite) bool useBackingLayer;
