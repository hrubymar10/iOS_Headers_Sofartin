...
@property (setter=_setNormalizedRingLocation:, nonatomic) struct CGPoint { double x1; double x2; } _normalizedRingLocation;
@property (setter=_setRingSpeed:, nonatomic) double _ringSpeed;
