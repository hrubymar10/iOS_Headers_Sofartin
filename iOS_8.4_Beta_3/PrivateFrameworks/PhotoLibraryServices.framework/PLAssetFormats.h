...
+ (int)bestFormatWithSize:(struct CGSize { double x1; double x2; })arg1 contentMode:(long long)arg2 demoteFactor:(double)arg3 srcAspectRatio:(double)arg4 isTableFormat:(bool*)arg5 desiredImagePixelSize:(struct CGSize { double x1; double x2; }*)arg6;
