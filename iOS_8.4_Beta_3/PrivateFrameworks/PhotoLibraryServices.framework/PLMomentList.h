...
@property(assign,readwrite) short granularityLevel;
@property(assign,readonly) unsigned long long hash;
@property(assign,retain) NSArray * localizedLocationNames;
@property(assign,retain) NSString * localizedTitle;
@property(assign,retain) NSOrderedSet * moments;
@property(assign,retain) NSOrderedSet * momentsForMegaMoment;
@property(assign,retain) NSOrderedSet * momentsForYear;
...
@property(assign,readwrite) int sortIndex;
