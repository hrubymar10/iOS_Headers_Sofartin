...
- (id)cloudResourcesInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (void)dealloc;
...
- (unsigned long long)totalSizeInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
