...
@property(assign,readonly) NSString * albumCloudGUID;
@property(assign,readonly) NSString * albumUUID;
@property(assign,readonly) bool allAssetsAreFullResolution;
@property(assign,readonly) long long bulletinType;
@property(assign,readonly) bool canMergeWithPersistedBulletins;
@property(assign,readonly) double completionPercentage;
@property(assign,readonly) NSDate * date;
@property(assign,readonly) NSString * destinationURLString;
...
@property(assign,readonly) NSString * mainAssetUUID;
@property(assign,readonly) NSString * message;
@property(assign,copy) NSDate * originalDate;
@property(assign,readwrite) unsigned long long originalRecordID;
@property(assign,readwrite) unsigned long long recordID;
@property(assign,readwrite) unsigned long long replacedBulletinRecordID;
@property(assign,readonly) NSString * senderEmailAddress;
@property(assign,readwrite) bool suppressAlert;
@property(assign,readonly) NSArray * suppressionContexts;
@property(assign,readonly) bool thumbnailAssetIsPlaceholder;
