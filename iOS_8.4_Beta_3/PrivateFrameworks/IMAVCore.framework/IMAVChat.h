...
@property(assign,readonly) bool _allParticipantsUsingICE;
@property(setter=_setBackCameraCaptureTime:,assign,retain) NSNumber * _backCameraCaptureTime;
@property(assign,readonly) long long _bustedCallID;
@property(assign,readonly) NSNumber * _callDuration;
@property(setter=_setCallStatisticsGUID:,assign,retain) NSString * _callStatisticsGUID;
@property(setter=_setConferenceController:,assign,readwrite) id _conferenceController;
@property(assign,readonly) NSObject<OS_dispatch_queue> * _conferenceQueue;
@property(assign,readonly) NSNumber * _connectDuration;
@property(setter=_setConnectionStarted:,assign,readwrite) bool _connectionStarted;
@property(setter=_setConnectionType:,assign,readwrite) int _connectionType;
@property(assign,readonly) NSNumber * _currentNatType;
@property(assign,retain) NSDictionary * _extraServerContext;
@property(setter=_setFrontCameraCaptureTime:,assign,retain) NSNumber * _frontCameraCaptureTime;
@property(assign,retain) NSArray * _imHandles;
@property(setter=_setInterruptionBegan:,assign,retain) NSDate * _interruptionBegan;
@property(setter=_setIsAudioInterrupted:,assign,readwrite) bool _isAudioInterrupted;
@property(setter=_setIsCallUpgrade:,assign,readwrite) bool _isCallUpgrade;
@property(assign,readonly) bool _isProxy;
@property(setter=_setIsVideoInterrupted:,assign,readwrite) bool _isVideoInterrupted;
@property(setter=_setLocalNetworkConnectionType:,assign,readwrite) unsigned long long _localNetworkConnectionType;
@property(setter=_setNatType:,assign,retain) NSNumber * _natType;
@property(setter=_setNeedsAudioRestart:,assign,readwrite) bool _needsAudioRestart;
@property(setter=_setNeedsVideoRestart:,assign,readwrite) bool _needsVideoRestart;
@property(setter=_setNetworkCheckResult:,assign,readwrite) long long _networkCheckResult;
@property(setter=_setPingTestResult:,assign,readwrite) long long _pingTestResult;
@property(setter=_setPingTestResults:,assign,retain) NSDictionary * _pingTestResults;
@property(assign,readonly) NSNumber * _relayConnectDuration;
@property(setter=_setRelayRemotePrimaryIdentifier:,assign,retain) NSData * _relayRemotePrimaryIdentifier;
@property(assign,readonly) NSNumber * _remoteNatType;
@property(setter=_setRemoteNetworkConnectionType:,assign,readwrite) unsigned long long _remoteNetworkConnectionType;
@property(setter=_setStartedAudioSession:,assign,readwrite) bool _startedAudioSession;
@property(assign,readonly) bool _usesRelay;
@property(assign,retain) IMAccount * account;
@property(setter=_setCallerProperties:,assign,retain) NSDictionary * callerProperties;
...
@property(setter=setDataDownloaded:,assign,retain) NSNumber * dataDownloaded;
@property(setter=setDataRate:,assign,retain) NSNumber * dataRate;
@property(setter=setDataUploaded:,assign,retain) NSNumber * dataUploaded;
...
@property(assign,readonly) bool didRemoteMute;
@property(assign,readonly) bool didRemotePause;
@property(assign,readonly) int endedError;
@property(assign,readonly) unsigned int endedReason;
@property(assign,readwrite) bool hasAudioInterruption;
@property(assign,readonly) bool hasReceivedFirstFrame;
@property(assign,retain) IMHandle * initiatorIMHandle;
@property(assign,retain) IMAVChatParticipant * initiatorParticipant;
...
@property(setter=setPaused:,assign,readwrite) bool isPaused;
@property(assign,readonly) bool isProxied;
@property(setter=setRemoteMute:,assign,readwrite) bool isRemoteMute;
...
@property(assign,readonly) bool isUsingWifi;
@property(assign,readonly) bool isVideo;
@property(assign,retain) IMAVChatParticipant * localParticipant;
...
@property(setter=_setWantsHoldMusic:,assign,readwrite) bool wantsHoldMusic;
