...
@property (nonatomic) double firstBalloonAlignmentTopInset;
...
@property (nonatomic, readonly) double leftBalloonMaxWidth;
...
@property (nonatomic, readonly) double rightBalloonMaxWidth;
