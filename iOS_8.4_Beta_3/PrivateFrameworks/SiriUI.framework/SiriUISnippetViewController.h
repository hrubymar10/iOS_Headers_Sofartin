...
@property(getter=isConfirmed,assign,readwrite) bool confirmed;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) long long defaultKeylineType;
@property(assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } defaultViewInsets;
@property(assign,readwrite) <SiriUISnippetViewControllerDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readonly) unsigned long long hash;
@property(assign,retain) SAUIAppPunchOut * headerPunchOut;
@property(assign,readwrite) bool isFullPadWidth;
@property(getter=isLoading,assign,readwrite) bool loading;
@property(assign,copy) NSString * navigationTitle;
@property(getter=_previousConfirmationOptions,setter=_setPreviousConfirmationOptions:,assign,retain) SAUIConfirmationOptions * previousConfirmationOptions;
@property(getter=_isProvisional,setter=_setProvisional:,assign,readwrite) bool provisional;
@property(assign,copy) NSArray * requestContext;
@property(assign,readwrite) bool showHeaderChevron;
@property(assign,retain) SAUISnippet * snippet;
@property(assign,retain) SAUIAppPunchOut * snippetPunchOut;
@property(assign,copy) NSString * subtitle;
@property(assign,readonly) Class superclass;
@property(assign,copy) NSString * title;
@property(assign,readwrite) bool topKeylineHidden;
@property(getter=isVirgin,assign,readonly) bool virgin;
@property(assign,readwrite) bool wantsConfirmationInsets;
@property(getter=_willAnimateCancellation,setter=_setWillAnimateCancellation:,assign,readwrite) bool willAnimateCancellation;
@property(getter=_willAnimateConfirmation,setter=_setWillAnimateConfirmation:,assign,readwrite) bool willAnimateConfirmation;
