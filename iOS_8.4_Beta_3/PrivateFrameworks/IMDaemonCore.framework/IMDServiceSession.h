...
@property(assign,readonly) bool accountNeedsLogin;
@property(assign,readonly) bool accountNeedsPassword;
@property(assign,readonly) bool accountShouldBeAlwaysLoggedIn;
@property(assign,retain) NSArray * allBuddies;
@property(assign,readonly) bool allowedAsChild;
@property(assign,retain) NSDictionary * buddyPictures;
@property(assign,retain) NSDictionary * buddyProperties;
@property(assign,retain) NSString * displayName;
@property(assign,readonly) bool isActive;
@property(assign,readonly) bool networkConditionsAllowLogin;
@property(assign,readonly) bool overrideNetworkAvailability;
@property(assign,retain) NSString * password;
@property(assign,retain) NSString * proxyAccount;
@property(assign,retain) NSString * proxyHost;
@property(assign,retain) NSString * proxyPassword;
@property(assign,readonly) unsigned short proxyPort;
@property(assign,readonly) long long proxyType;
...
@property(assign,retain) NSString * serverHost;
@property(assign,readonly) unsigned short serverPort;
@property(assign,retain) IMDService * service;
@property(assign,readonly) int serviceDisconnectReason;
@property(assign,readonly) unsigned int serviceLoginStatus;
@property(assign,retain) NSString * serviceLoginStatusMessage;
