...
@property(assign,readonly) long long autoFilledTracksTotalSize;
@property(assign,readwrite) bool companionDeviceActiveStoreAccountIsDynamiteEligible;
@property(assign,readonly) ML3DatabaseConnectionPool * connectionPool;
@property(assign,readonly) long long currentContentRevision;
@property(assign,readonly) ML3Container * currentDevicePlaybackHistoryPlaylist;
@property(assign,readonly) ML3Container * currentDevicePurchasesPlaylist;
@property(assign,readonly) long long currentRevision;
@property(assign,readonly) ML3DatabaseMetadata * databaseInfo;
@property(assign,readonly) NSString * databasePath;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <ML3MusicLibraryDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) bool isHomeSharingLibrary;
@property(assign,retain) NSArray * libraryContainerFilterPredicates;
@property(assign,retain) NSArray * libraryEntityFilterPredicates;
@property(assign,retain) NSArray * libraryPublicContainerFilterPredicates;
@property(assign,retain) NSArray * libraryPublicEntityFilterPredicates;
@property(assign,readonly) NSString * libraryUID;
@property(assign,readonly) NSArray * localizedSectionIndexTitles;
@property(assign,readonly) bool mediaRestrictionEnabled;
@property(assign,readonly) NSArray * preferredAudioTracks;
@property(assign,readonly) NSArray * preferredSubtitleTracks;
@property(assign,readonly) Class superclass;
@property(assign,readonly) bool supportsUbiquitousPlaybackPositions;
@property(assign,readwrite) long long syncGenerationID;
@property(assign,readwrite) NSString * syncLibraryID;
