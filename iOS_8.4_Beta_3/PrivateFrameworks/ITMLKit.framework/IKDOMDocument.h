...
@property(assign,readwrite) <IKJSDOMDocumentAppBridge> * appBridge;
@property(assign,retain) IKDOMElement * documentElement;
@property(assign,retain) NSString * documentURI;
@property(assign,readonly) IKDOMImplementation * implementation;
@property(assign,retain) NSString * inputEncoding;
@property(assign,readwrite) unsigned long long itmlIDSequence;
@property(assign,readwrite) IKJSNavigationDocument * navigationDocument;
@property(assign,readwrite) bool strictErrorChecking;
@property(assign,retain) NSString * xmlEncoding;
@property(assign,readwrite) bool xmlStandalone;
@property(assign,retain) NSString * xmlVersion;
