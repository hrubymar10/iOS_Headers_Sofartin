...
@property(assign,readwrite) bool canSetPreviousProtectionEtag;
...
@property(assign,retain) NSDictionary * metadatasByRecordID;
@property(assign,retain) NSMutableDictionary * modifyMetadatasByZoneID;
@property(assign,readwrite) int numPCSRetries;
@property(assign,retain) NSArray * recordIDsToDelete;
@property(assign,retain) NSDictionary * recordIDsToDeleteToEtags;
@property(assign,retain) NSMutableDictionary * recordsByServerID;
@property(assign,retain) NSArray * recordsToSave;
@property(assign,readwrite) bool retriedRecords;
@property(assign,readwrite) bool retryPCSFailures;
@property(assign,copy) id saveCompletionBlock;
@property(assign,readwrite) long long savePolicy;
@property(assign,copy) id saveProgressBlock;
@property(assign,readwrite) bool shouldOnlySaveAssetContent;
@property(assign,readonly) CKDProtocolTranslator * translator;
