...
@property(assign,retain) PLEntryNotificationOperatorComposition * audioEventCallback;
...
@property(assign,readwrite) bool doesCurrPackageHasProblem;
@property(assign,readwrite) bool doesPrevPackageHasProblem;
@property(assign,readwrite) double elapsedDenumerator;
@property(assign,retain) NSMutableArray * endExclusionPeriods;
@property(assign,readwrite) unsigned char exclusionMask;
@property(assign,readwrite) double gArmUtil;
@property(assign,readwrite) int gPerepherialMax;
@property(assign,retain) PLEntryNotificationOperatorComposition * hotspotEventCallback;
@property(assign,readwrite) bool isUIAlertEnabled;
@property(assign,retain) PLEntryNotificationOperatorComposition * lteRRCCallback;
@property(assign,retain) PLEntryNotificationOperatorComposition * msgLiteCallback;
@property(assign,retain) NSDate * notToRemoveDate;
@property(assign,retain) NSDate * samplingDate;
@property(assign,readwrite) bool sendAWD;
@property(assign,retain) NSMutableArray * startExclusionPeriods;
@property(assign,retain) PLEntryNotificationOperatorComposition * telActivityCallback;
@property(assign,readwrite) double totalNormalARMUtility;
@property(assign,retain) PLEntryNotificationOperatorComposition * wcdmaRRCCallback;
