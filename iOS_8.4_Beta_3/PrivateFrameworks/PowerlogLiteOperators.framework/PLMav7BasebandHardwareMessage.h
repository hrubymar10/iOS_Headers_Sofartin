...
@property(assign,readwrite) struct _PLMav7BasebandHWStatsClockStateMask { unsigned int x1[4]; }* apps_clock_count_mask;
@property(assign,readwrite) NSMutableString * apps_clock_duration;
@property(assign,readwrite) struct _PLMav7BasebandHWStatsClockStateMask { unsigned int x1[4]; }* apps_clock_duration_mask;
@property(assign,readwrite) struct _PLMav7BasebandGPSDPOBin { unsigned int x1[6]; }* gps_dpo_bins;
@property(assign,readwrite) struct _PLMav7BasebandHWStatsHSICState { unsigned int x1[8]; }* hsic;
@property(assign,readwrite) struct _PLMav7BasebandHWStatsMCPMVeto { unsigned int x1[6]; }* mcpm_sleep_veto;
@property(assign,readwrite) struct _PLMav7BasebandHWStatsClockStateMask { unsigned int x1[4]; }* mpss_clock_count_mask;
@property(assign,readwrite) NSMutableString * mpss_clock_duration;
@property(assign,readwrite) struct _PLMav7BasebandHWStatsClockStateMask { unsigned int x1[4]; }* mpss_clock_duration_mask;
@property(assign,readwrite) struct _PLMav7BasebandHWStatsNPAVeto { unsigned int x1; unsigned int x2[24]; }* npa_sleep_veto;
@property(assign,readwrite) struct _PLMav7BasebandHWStatsProtocol { unsigned int x1[6][16]; unsigned int x2[6]; }* protocol;
@property(assign,readwrite) struct _PLMav7BasebandHWStatsRFTech { unsigned int x1[6][4]; unsigned int x2[6][13]; unsigned int x3[6][13]; unsigned int x4[6][12]; unsigned int x5[6][11]; unsigned int x6[6][11]; }* rf;
