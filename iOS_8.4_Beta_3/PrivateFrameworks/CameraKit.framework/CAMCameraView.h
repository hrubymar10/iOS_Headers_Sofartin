...
@property(assign,readonly) CAMHDRBadge * _HDRBadge;
@property(assign,readonly) CAMHDRButton * _HDRButton;
@property(getter=_isHDRSuggested,setter=_setHDRSuggested:,assign,readwrite) bool _HDRSuggested;
@property(assign,readonly) bool _HDRUsedForLastCapture;
@property(setter=_setAllowsStillFromVideoModeWhenNotRecording:,assign,readwrite) bool _allowsStillFromVideoModeWhenNotRecording;
@property(assign,readonly) bool _avalancheCaptureAsSoonAsPossible;
@property(assign,readonly) bool _avalancheCaptureInProgress;
@property(setter=_setAvalancheCaptureRecognized:,assign,readwrite) bool _avalancheCaptureRecognized;
@property(assign,readonly) NSObject<OS_dispatch_source> * _avalancheCaptureTimer;
@property(assign,readonly) CAMAvalancheIndicatorView * _avalancheIndicator;
@property(getter=_isAvalancheIndicatorVisible,setter=_setAvalancheIndicatorVisible:,assign,readwrite) bool _avalancheIndicatorVisible;
@property(assign,readonly) NSObject<OS_dispatch_source> * _avalancheRecognitionTimer;
@property(assign,readonly) bool _badgesNeedLayoutForZoomSliderAnimation;
@property(setter=_setBlurredFromSuspension:,assign,readwrite) bool _blurredFromSuspension;
@property(assign,readonly) CAMBottomBar * _bottomBar;
@property(getter=_isCameraEnabled,setter=_setCameraEnabled:,assign,readwrite) bool _cameraEnabled;
@property(assign,readonly) CAMBlurredSnapshotView * _captureSnapshotView;
@property(getter=_isCapturing,setter=_setCapturing:,assign,readwrite) bool _capturing;
@property(setter=_setCapturingAvalancheForDelayedCapture:,assign,readwrite) bool _capturingAvalancheForDelayedCapture;
@property(assign,readonly) bool _capturingFromPhysicalButton;
@property(getter=_isChangingModes,setter=_setChangingModes:,assign,readwrite) bool _changingModes;
@property(assign,readonly) CAMBlurredSnapshotView * _currentDeviceBackSnapshotView;
@property(assign,readonly) CAMBlurredSnapshotView * _currentDeviceFrontSnapshotView;
@property(setter=_setDeferredModeIndex:,assign,readwrite) long long _deferredModeIndex;
@property(assign,readonly) CAMAnimationDelegate * _delayedCaptureAnimationDelegate;
@property(getter=_isDelayedCaptureIndicatorVisible,setter=_setDelayedCaptureIndicatorVisible:,assign,readwrite) bool _delayedCaptureIndicatorVisible;
@property(assign,readonly) NSObject<OS_dispatch_source> * _delayedCaptureTimer;
@property(assign,readwrite) long long _desiredNumberOfAvalancheCaptures;
@property(assign,readonly) CAMDisabledModeOverlayView * _disabledModeOverlayView;
@property(assign,readonly) CAMElapsedTimeView * _elapsedTimeView;
@property(assign,readonly) float _exposureBiasPanStartValue;
@property(assign,readonly) CAMExposureBiasTextView * _exposureBiasTextView;
@property(setter=_setExposureBiasVirtualSliderExponent:,assign,readwrite) double _exposureBiasVirtualSliderExponent;
@property(setter=_setExposureBiasVirtualSliderPointsForFirstStop:,assign,readwrite) double _exposureBiasVirtualSliderPointsForFirstStop;
@property(assign,readonly) CAMFilterButton * _filterButton;
@property(assign,readonly) NSMutableSet * _filterNamesSelectedBeforeCapture;
@property(assign,readonly) CAMFlashBadge * _flashBadge;
@property(assign,readonly) CAMFlashButton * _flashButton;
@property(assign,readonly) CAMFlipButton * _flipButton;
@property(getter=_isFlipping,setter=_setFlipping:,assign,readwrite) bool _flipping;
@property(assign,readonly) struct CGPoint { double x1; double x2; } _focusPanStartPoint;
@property(assign,readonly) CAMHardwareLockIndicatorView * _hardwareLockIndicator;
@property(getter=_hasMaximumNumberOfInflightImageRequests,setter=_setHasMaximumNumberOfInflightImageRequests:,assign,readwrite) bool _hasMaximumNumberOfInflightImageRequests;
@property(setter=_setHideFocusForFilterSelection:,assign,readwrite) bool _hideFocusForFilterSelection;
@property(setter=_setHideGridViewForFilterSelection:,assign,readwrite) bool _hideGridViewForFilterSelection;
@property(getter=_isHidingBadgesForFilterUI,setter=_setHidingBadgesForFilterUI:,assign,readwrite) bool _hidingBadgesForFilterUI;
@property(setter=_setIgnoringAutomaticBadgeUpdatesDuringCapture:,assign,readwrite) bool _ignoringAutomaticBadgeUpdatesDuringCapture;
@property(setter=_setIgnoringAutomaticBadgeUpdatesForAvalancheIndicator:,assign,readwrite) bool _ignoringAutomaticBadgeUpdatesForAvalancheIndicator;
@property(assign,readonly) bool _ignoringSubsequentAvalancheCaptureRequests;
@property(assign,readonly) CAMImageWell * _imageWell;
@property(getter=_isInterrupted,setter=_setInterrupted:,assign,readwrite) bool _interrupted;
@property(assign,readonly) NSDate * _lastAutoTimerCaptureDate;
@property(assign,readonly) NSDate * _lastDelayedCaptureIndicatorUpdateDate;
@property(assign,readonly) struct CGPoint { double x1; double x2; } _lastFocusPanPoint;
@property(setter=_setLayoutStyle:,assign,readwrite) int _layoutStyle;
@property(getter=_isLockedToPortraitOrientation,assign,readonly) bool _lockedToPortraitOrientation;
@property(assign,readonly) CAMModeDial * _modeDial;
@property(getter=_isModeDisabledForLayout,setter=_setModeDisabledForLayout:,assign,readwrite) bool _modeDisabledForLayout;
@property(assign,readonly) CAMBlurredSnapshotView * _modeSwitchingSnapshotView;
@property(assign,readonly) CAMMotionController * _motionController;
@property(assign,readonly) bool _needToStartAvalancheSound;
@property(assign,readonly) UISwipeGestureRecognizer * _nextModeGestureRecognizer;
@property(assign,readonly) UIView * _nonWidescreenSquareBottomMarginLayoutSpacer;
@property(setter=_setNumFilterSelectionsBeforeCapture:,assign,readwrite) unsigned long long _numFilterSelectionsBeforeCapture;
@property(assign,readonly) long long _numberOfInflightStillImageRequests;
@property(assign,readonly) bool _panningExposureBias;
@property(assign,readonly) bool _panningExposureRect;
@property(setter=_setPendingModeIndex:,assign,readwrite) long long _pendingModeIndex;
@property(setter=_setPerformingDelayedCapture:,assign,readwrite) bool _performingDelayedCapture;
@property(getter=_isPerformingFilterTransition,setter=_setPerformingFilterTransition:,assign,readwrite) bool _performingFilterTransition;
@property(getter=_isPostprocessing,setter=_setPostprocessing:,assign,readwrite) bool _postprocessing;
@property(getter=_isPreparingToRecord,setter=_setPreparingToRecord:,assign,readwrite) bool _preparingToRecord;
@property(assign,readonly) UIView * _previewCounterRotatingView;
@property(assign,readonly) UIView * _previewMaskingView;
@property(assign,readonly) UISwipeGestureRecognizer * _previousModeGestureRecognizer;
@property(getter=_isProcessingHDR,setter=_setProcessingHDR:,assign,readwrite) bool _processingHDR;
@property(getter=_isProcessingModeChange,assign,readonly) bool _processingModeChange;
@property(assign,readonly) bool _receivedInitialPreviewDidStartNotification;
@property(setter=_setRecoveringFromServerError:,assign,readwrite) bool _recoveringFromServerError;
@property(assign,readonly) long long _remainingDelayedCaptureTicks;
@property(getter=_resetTimerDurationAfterDelayedCapture,setter=_setResetTimerDurationAfterDelayedCapture:,assign,readwrite) bool _resetTimerDurationAfterDelayedCapture;
@property(getter=_isReviewingImagePickerCapture,setter=_setReviewingImagePickerCapture:,assign,readwrite) bool _reviewingImagePickerCapture;
@property(assign,readonly) bool _shouldBlurWhenSessionStops;
@property(assign,readonly) bool _shouldPausePreviewDuringCapture;
@property(assign,readonly) bool _shouldStartPreviewWhenApplicationBecomesActive;
@property(assign,readonly) CAMShutterButton * _shutterButton;
@property(assign,readonly) CAMShutterIndicatorView * _shutterIndicator;
@property(assign,readonly) CAMSlalomIndicatorView * _slalomIndicator;
@property(assign,readonly) UITapGestureRecognizer * _slalomIndicatorTapGestureRecognizer;
@property(assign,readonly) CAMShutterButton * _stillDuringVideoButton;
@property(setter=_setStopVideoCaptureWhenRecordingStarts:,assign,readwrite) bool _stopVideoCaptureWhenRecordingStarts;
@property(assign,readonly) bool _supportsPreviewingAfterCapture;
@property(assign,readonly) CAMBlurredSnapshotView * _suspensionSnapshotView;
@property(getter=_isSwipeToModeSwitchEnabled,setter=_setSwipeToModeSwitchEnabled:,assign,readwrite) bool _swipeToModeSwitchEnabled;
@property(assign,readonly) bool _switchingBetweenCameras;
@property(getter=_isTallScreenDevice,assign,readonly) bool _tallScreenDevice;
@property(assign,readonly) CAMBlurredSnapshotView * _targetDeviceSnapshotView;
@property(assign,readonly) double _timeIntervalOfTouchDown;
@property(assign,readonly) CAMTimerButton * _timerButton;
@property(assign,readonly) CAMTimerIndicatorView * _timerIndicator;
@property(assign,readonly) CAMTopBar * _topBar;
@property(assign,readonly) CAMTorchPatternController * _torchPatternController;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _unzoomedPreviewFrame;
@property(getter=_isViewingCameraRoll,setter=_setViewingCameraRoll:,assign,readwrite) bool _viewingCameraRoll;
@property(getter=_isWaitingForStillImageCaptureToComplete,setter=_setWaitingForStillImageCaptureToComplete:,assign,readwrite) bool _waitingForStillImageCaptureToComplete;
@property(assign,readonly) bool _wantsCaptureAnimations;
@property(assign,readonly) bool _wantsForcedPreviewAspectRatio;
@property(assign,readonly) bool _wantsFullScreenPreview;
@property(assign,readonly) bool _wantsOrientationAnimations;
@property(assign,readonly) bool _wantsPreviewSizeAdjustmentForBars;
@property(assign,readonly) bool _wantsSuspensionBlurs;
@property(assign,readonly) int _windowEdgeClip;
@property(assign,readonly) CAMZoomSlider * _zoomSlider;
@property(assign,readonly) bool allowsMultipleModes;
@property(assign,readwrite) long long cameraDevice;
@property(assign,readwrite) long long cameraMode;
@property(assign,readonly) bool controlsAreVisible;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readwrite) long long flashMode;
@property(getter=isGridVisible,assign,readwrite) bool gridVisible;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) bool isCameraReady;
@property(assign,readwrite) int lastSelectedHDRMode;
@property(assign,readwrite) long long lastSelectedPhotoFlashMode;
@property(assign,readonly) PLPreviewOverlayView * overlayView;
@property(assign,retain) CAMPhysicalCaptureRecognizer * physicalCaptureRecognizer;
@property(assign,readonly) UIView * previewContainerView;
@property(assign,readonly) CAMPreviewView * previewView;
@property(assign,readwrite) int previewViewAspectMode;
@property(assign,readwrite) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } previewViewTransform;
@property(assign,readwrite) int rotationStyle;
@property(assign,readwrite) long long selectedModeIndex;
@property(assign,readonly) CAMCameraSpec * spec;
@property(assign,readonly) Class superclass;
@property(assign,readwrite) long long timerDuration;
@property(assign,readwrite) bool userChangedHDRAfterFlash;
@property(getter=isUserInteractionLoggingEnabled,assign,readwrite) bool userInteractionLoggingEnabled;
@property(assign,readwrite) long long videoFlashMode;
