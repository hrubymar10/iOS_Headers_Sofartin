...
@property(getter=isHDRDetectionEnabled,assign,readwrite) bool HDRDetectionEnabled;
@property(getter=isHDRSuggested,assign,readonly) bool HDRSuggested;
@property(setter=_setAtomicEffectsAvailable:,assign,readwrite) bool _atomicEffectsAvailable;
@property(getter=_isAtomicModeChangeWaitingForConfigureSession,setter=_setAtomicModeChangeWaitingForConfigureSession:,assign,readwrite) bool _atomicModeChangeWaitingForConfigureSession;
@property(getter=_isAtomicModeChangeWaitingForPreviewStarted,setter=_setAtomicModeChangeWaitingForPreviewStarted:,assign,readwrite) bool _atomicModeChangeWaitingForPreviewStarted;
@property(assign,readonly) CAMAvalancheCaptureService * _avalancheCaptureService;
@property(assign,retain) NSObject<OS_dispatch_queue> * _captureIsolationQueue;
@property(getter=_isConfiguringCamera,setter=_setConfiguringCamera:,assign,readwrite) bool _configuringCamera;
@property(assign,readonly) NSMutableArray * _currentFaceMetadata;
@property(assign,readonly) CAMDebugCaptureService * _debugCaptureService;
@property(assign,readonly) NSMutableArray * _deferredVideoCaptureRequests;
@property(setter=_setDeviceLockCount:,assign,readwrite) long long _deviceLockCount;
@property(assign,retain) NSObject<OS_dispatch_queue> * _effectFilterIndexQueue;
@property(setter=_setEffectFilterIndices:,assign,retain) NSDictionary * _effectFilterIndices;
@property(assign,retain) NSObject<OS_dispatch_queue> * _effectRenderingQueue;
@property(setter=_setEffectsAvailable:,assign,readwrite) bool _effectsAvailable;
@property(assign,readonly) bool _ignoreSubjectAreaChanges;
@property(assign,readonly) double _ignoreSubjectAreaChangesUntilTime;
@property(assign,readonly) NSMutableArray * _inflightPanoramaCaptureRequests;
@property(assign,readonly) NSMutableArray * _inflightStillImageCaptureRequests;
@property(assign,readonly) NSMutableArray * _inflightVideoCaptureResponses;
@property(assign,readonly) bool _locationAcquiredForTimelapseCapture;
@property(assign,readonly) bool _lockExposureAfterExposeFinishes;
@property(assign,readonly) bool _lockFocusAfterFocusFinishes;
@property(setter=_setLockLensPositionCompletionBlock:,assign,copy) id _lockLensPositionCompletionBlock;
@property(setter=_setLockLensPositionTarget:,assign,readwrite) float _lockLensPositionTarget;
@property(getter=_isModeChangeWaitingForConfigureSession,setter=_setModeChangeWaitingForConfigureSession:,assign,readwrite) bool _modeChangeWaitingForConfigureSession;
@property(getter=_isModeChangeWaitingForPreviewStarted,setter=_setModeChangeWaitingForPreviewStarted:,assign,readwrite) bool _modeChangeWaitingForPreviewStarted;
@property(assign,readonly) bool _panoramaProcessorReadyForSampleBuffers;
@property(setter=_setPreviewLayerEnabledForRenderer:,assign,readwrite) bool _previewLayerEnabledForRenderer;
@property(getter=_isPreviewPaused,setter=_setPreviewPaused:,assign,readwrite) bool _previewPaused;
@property(assign,readonly) NSMutableArray * _processingPanoramaCaptureRequests;
@property(assign,readwrite) bool _rebuildingSession;
@property(assign,readonly) NSMutableDictionary * _servicesByType;
@property(getter=_isSessionReady,setter=_setSessionReady:,assign,readwrite) bool _sessionReady;
@property(setter=_setVideoDataOutputEnabledForRenderer:,assign,readwrite) bool _videoDataOutputEnabledForRenderer;
@property(assign,readonly) bool _wasStillImageStabilzationOnBeforeTimedCapture;
@property(assign,retain) CIFilter * activeFilter;
@property(assign,readonly) bool allowsAlternateSlomoFront;
@property(assign,readonly) bool allowsAlternateSlomoRear;
@property(assign,readwrite) long long cameraDevice;
@property(assign,readwrite) long long cameraMode;
@property(assign,readonly) long long cameraOrientation;
@property(assign,readwrite) bool canCapturePhotoFromVideoModeWhenNotRecording;
@property(assign,readwrite) int captureOrientation;
@property(getter=isCapturingTimelapse,assign,readwrite) bool capturingTimelapse;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } cleanAperture;
@property(assign,readwrite) bool convertSampleBufferToJPEG;
@property(assign,readwrite) AVCaptureDevice * currentDevice;
@property(assign,readwrite) AVCaptureDeviceInput * currentInput;
@property(assign,readwrite) AVCaptureOutput * currentOutput;
@property(assign,readonly) AVCaptureSession * currentSession;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool disableAllPreviewSuspensionDuringCapture;
@property(assign,retain) CAMEffectsRenderer * effectsRenderer;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } exposurePointOfInterest;
@property(assign,readwrite) float exposureTargetBias;
@property(assign,readonly) float exposureTargetBiasDefault;
@property(assign,readonly) float exposureTargetBiasMax;
@property(assign,readonly) float exposureTargetBiasMin;
@property(assign,readwrite) long long flashMode;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } focusPointOfInterest;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) AVCaptureStillImageOutput * imageOutput;
@property(assign,readwrite) bool isCameraApp;
@property(assign,readonly) bool isStillImageStabilizationActive;
@property(assign,readonly) float panoramaPreviewScale;
@property(assign,readonly) struct CGSize { double x1; double x2; } panoramaPreviewSize;
@property(assign,readwrite) bool performingAvalancheCapture;
@property(assign,copy) id postSessionSetupBlock;
@property(assign,readonly) AVCaptureVideoPreviewLayer * previewLayer;
@property(assign,readwrite) int previewOrientation;
@property(assign,readonly) CCCameraConnection * remoteShutterConnection;
@property(assign,readwrite) bool resetExposureWhenSubjectAreaChanged;
@property(assign,readwrite) bool resetFocusWhenSubjectAreaChanged;
@property(assign,readonly) Class superclass;
@property(assign,copy) NSArray * supportedCameraModes;
@property(assign,readonly) bool supportsHDR;
@property(assign,readonly) bool supportsHDRSuggestion;
@property(assign,readwrite) bool use60FPSVideo;
@property(assign,readwrite) bool useAlternateSlomoFront;
@property(assign,readwrite) bool useAlternateSlomoRear;
@property(assign,readwrite) bool userLockedExposure;
@property(assign,readwrite) bool userLockedFocus;
@property(assign,readwrite) double videoZoomFactor;
