...
@property(assign,readonly) PFVideoAdjustments * _adjustmentsToCommit;
@property(setter=_setAttemptFetchingVideoDerivative:,assign,readwrite) bool _attemptFetchingVideoDerivative;
@property(setter=_setCanAttemptFetchingVideoDerivative:,assign,readwrite) bool _canAttemptFetchingVideoDerivative;
@property(setter=_setDidEditSlalom:,assign,readwrite) bool _didEditSlalom;
@property(assign,readwrite) bool _didInsertMoviePlayerView;
@property(assign,readonly) bool _didSetPhotoData;
@property(assign,readonly) long long _expectedNotificationsCount;
@property(assign,readonly) bool _isFetchingVideo;
@property(setter=_setLocalVideoUnavailable:,assign,readwrite) bool _localVideoUnavailable;
@property(assign,readonly) bool _mediaIsPlayable;
@property(assign,retain) NSString * _pathForPrebakedLandscapeScrubberThumbnails;
@property(assign,retain) NSString * _pathForPrebakedPortraitScrubberThumbnails;
@property(assign,retain) NSString * _pathForVideoPreviewFile;
@property(assign,readonly) bool _slalomRegionEditorCreatedForScrubber;
@property(assign,readonly) PFVideoAVObjectBuilder * _videoAVObjectBuilder;
@property(assign,readwrite) bool allowSlalomEditor;
@property(assign,readwrite) bool canEdit;
@property(assign,readwrite) double currentTime;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <PLVideoViewDelegate> * delegate;
...
@property(assign,readwrite) PLPhotoTileViewController * imageTile;
@property(assign,readwrite) bool loadMediaImmediately;
@property(assign,retain) NSString * pathForVideoFile;
@property(assign,readonly) UIImage * posterFrameImage;
@property(assign,readonly) PLVideoPosterFrameView * posterFrameView;
@property(assign,readwrite) bool prepareMoviePlayerForScrubberAutomatically;
@property(assign,readonly) UIImageView * previewImageView;
@property(assign,readonly) UIView * scrubberBackgroundView;
@property(assign,readwrite) bool scrubberIsSubview;
@property(assign,readwrite) double scrubberWidth;
@property(assign,readwrite) bool shouldPlayVideoWhenViewAppears;
@property(assign,readwrite) bool showsPlayOverlay;
@property(assign,readwrite) bool showsScrubber;
@property(assign,readonly) double startTime;
@property(assign,readonly) Class superclass;
@property(assign,retain) PLProgressStack * trimProgressStack;
@property(assign,retain) PLManagedAsset * trimmedVideoClip;
@property(assign,readonly) PLManagedAsset * videoCameraImage;
@property(assign,readonly) NSString * videoPathAfterTrim;
