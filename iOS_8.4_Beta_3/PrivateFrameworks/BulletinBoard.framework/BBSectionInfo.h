...
@property(assign,readwrite) unsigned long long bulletinCount;
@property(assign,copy) NSArray * dataProviderIDs;
@property(assign,copy) NSString * displayName;
@property(assign,readwrite) bool displaysCriticalBulletins;
@property(assign,readwrite) bool enabled;
@property(assign,copy) NSString * factorySectionID;
@property(assign,readwrite) bool hideWeeApp;
@property(assign,copy) BBSectionIcon * icon;
@property(assign,copy) NSData * iconData;
@property(assign,readwrite) unsigned long long notificationCenterLimit;
@property(assign,readwrite) BBSectionInfo * parentSection;
@property(assign,copy) NSString * pathToWeeAppPluginBundle;
@property(assign,readwrite) unsigned long long pushSettings;
@property(assign,readwrite) long long sectionCategory;
...
@property(assign,copy) NSString * subsectionID;
@property(assign,readwrite) long long subsectionPriority;
@property(assign,copy) NSArray * subsections;
@property(assign,readwrite) bool suppressFromSettings;
@property(assign,readwrite) unsigned long long suppressedSettings;
