...
@property(assign,retain) NSDictionary * MMCSBackoffManagerParameters;
@property(setter=_setAssetInfoToReauthForDownload:,assign,retain) NSMutableArray * _assetInfoToReauthForDownload;
@property(setter=_setStopHandlerBlock:,assign,copy) id _stopHandlerBlock;
@property(assign,readwrite) MSAlbumSharingDaemon * daemon;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) id delegate;
@property(assign,retain) MSImageScalingSpecification * derivativeImageScalingSpecification;
@property(assign,retain) NSArray * derivativeSpecifications;
...
@property(assign,readwrite) int maxMetadataRetryCount;
@property(assign,retain) NSObject<OS_dispatch_queue> * memberQueue;
@property(assign,retain) NSDictionary * metadataBackoffManagerParameters;
@property(assign,retain) NSString * personID;
@property(assign,retain) MSASPhoneInvitations * phoneInvitations;
@property(assign,copy) id postCommandCompletionBlock;
@property(assign,retain) MSASProtocol * protocol;
@property(assign,retain) NSObject<OS_dispatch_queue> * serverSideConfigQueue;
@property(assign,retain) NSDictionary * serverSideConfiguration;
@property(assign,retain) NSString * serverSideConfigurationVersion;
@property(assign,readonly) Class superclass;
@property(assign,retain) MSImageScalingSpecification * thumbnailImageScalingSpecification;
