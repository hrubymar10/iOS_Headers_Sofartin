...
- (void)webBrowserView:(UIWebBrowserView *)arg1 willSubmitForm:(DOMElement *)arg2 toFrame:(WebFrame *)arg3 fromFrame:(WebFrame *)arg4 withValues:(NSDictionary *)arg5 submissionHandler:(id)arg6;
