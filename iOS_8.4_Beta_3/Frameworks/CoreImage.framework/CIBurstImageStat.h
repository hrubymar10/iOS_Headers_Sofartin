...
@property(assign,readwrite) int AEAverage;
@property(assign,readwrite) int AEDelta;
@property(assign,readwrite) bool AEStable;
@property(assign,readwrite) int AETarget;
@property(assign,readwrite) bool AFStable;
@property(assign,readwrite) float actionClusteringScore;
@property(assign,readwrite) float actionScore;
@property(assign,readwrite) float avgHorzDiffY;
@property(assign,readwrite) float blurExtent;
@property(assign,readwrite) bool doLimitedSharpnessAndBlur;
@property(assign,readwrite) bool emotionallyRejected;
@property(assign,readwrite) bool exclude;
@property(assign,readwrite) NSMutableArray * faceStatArray;
@property(assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } facesRoiRect;
@property(assign,readwrite) struct __IOSurface { }* fullsizeJpegData;
@property(assign,readwrite) int fullsizeJpegSize;
@property(assign,readwrite) bool hasRegistrationData;
@property(assign,readwrite) NSString * imageId;
@property(assign,readwrite) float imageScore;
@property(assign,readwrite) bool isGarbage;
@property(assign,readwrite) float maxSkewness;
@property(assign,readwrite) int numHWFaces;
@property(assign,readwrite) int orientation;
@property(assign,readwrite) float registrationErrorIntegral;
@property(assign,readwrite) float registrationErrorX;
@property(assign,readwrite) float registrationErrorY;
@property(assign,readwrite) float roiSize;
@property(assign,readwrite) int temporalOrder;
@property(assign,readwrite) double timeReceived;
@property(assign,readwrite) double timestamp;
@property(assign,readwrite) float tx;
@property(assign,readwrite) float ty;
