...
@property(assign,readwrite) bool actionViewControllerReadyForPresentation;
@property(assign,readwrite) bool actionViewControllerWantsDismissal;
@property(assign,retain) NSDictionary * adToLoad;
@property(assign,copy) NSString * advertisingSection;
@property(assign,copy) NSString * authenticationUserName;
@property(assign,readonly) ADAdSpaceConfiguration * configuration;
@property(assign,readonly) NSString * connectionAssertionIdentifier;
@property(assign,copy) NSSet * context;
@property(assign,retain) ADAdSpaceRemoteViewController * creativeViewController;
@property(assign,retain) ADAdImpressionPublicAttributes * currentAdImpressionPublicAttributes;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readonly) unsigned long long hash;
@property(assign,copy) NSString * identifier;
@property(assign,readwrite) double lastSlowCheck;
@property(assign,retain) _ADRemoteViewController * portraitOnlyViewController;
@property(assign,readonly) <ADAdRecipient> * recipient;
@property(assign,retain) _ADRemoteViewController * remoteViewController;
@property(assign,retain) _UIAsyncInvocation * remoteViewControllerRequestCancelationInvocation;
@property(assign,copy) NSURL * serverURL;
@property(assign,readonly) <ADSAdSpace_RPC><NSObject> * serviceAdSpace;
@property(assign,readwrite) bool serviceAdSpaceRequestInProgress;
@property(assign,readwrite) bool shouldPresentActionViewControllerWhenReady;
@property(assign,readonly) Class superclass;
@property(assign,readwrite) long long visibility;
@property(assign,readwrite) bool visibilityCheckScheduled;
