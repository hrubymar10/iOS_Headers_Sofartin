...
@property(assign,readonly) PUActivityViewController * _activityViewController;
@property(assign,readonly) PHCachingImageManager * _cachingImageManager;
@property(setter=_setEmbeddedActivityViewController:,assign,retain) PUActivityViewController * _embeddedActivityViewController;
@property(setter=_setLastKnownReferenceAsset:,assign,retain) PHAsset * _lastKnownReferenceAsset;
@property(setter=_setLastKnownReferenceIndexPath:,assign,retain) NSIndexPath * _lastKnownReferenceIndexPath;
...
@property(setter=_pptSetOnDidEndScrollingBlock:,assign,copy) id _pptOnDidEndScrollingBlock;
@property(setter=_setPreheatedAssets:,assign,retain) NSMutableSet * _preheatedAssets;
...
@property(setter=_setUnembeddedActivityViewController:,assign,retain) PUActivityViewController * _unembeddedActivityViewController;
@property(getter=_isViewInSyncWithModel,setter=_setViewInSyncWithModel:,assign,readwrite) bool _viewInSyncWithModel;
@property(assign,readonly) PHFetchResult * assetCollectionsFetchResult;
@property(assign,readonly) NSIndexPath * currentIndexPath;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <PUPhotosSharingViewControllerDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(setter=_setEmbeddedActivityView:,assign,retain) UIView * embeddedActivityView;
@property(assign,readonly) NSPredicate * filterPredicate;
@property(assign,readonly) unsigned long long hash;
@property(getter=isLockScreenCamera,assign,readwrite) bool lockScreenCamera;
@property(setter=_setMainCollectionView:,assign,retain) UICollectionView * mainCollectionView;
@property(setter=_setMainCollectionViewLayout:,assign,retain) PUPhotosSharingCollectionViewLayout * mainCollectionViewLayout;
@property(assign,readonly) PHFetchResult * photoCollectionsFetchResult;
...
@property(assign,retain) PUPhotosSharingViewControllerSpec * spec;
