...
@property(assign,readwrite) long long columnsPerRow;
@property(assign,readwrite) double cropAmount;
@property(assign,readwrite) long long cropType;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <PUSectionedGridLayoutDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool floatingSectionHeadersEnabled;
@property(assign,readwrite) double globalBottomPadding;
@property(assign,readwrite) double globalFooterHeight;
@property(assign,readonly) NSIndexPath * globalFooterIndexPath;
@property(assign,readonly) UICollectionViewLayoutAttributes * globalHeaderAttributes;
@property(assign,readwrite) double globalHeaderHeight;
@property(assign,readonly) NSIndexPath * globalHeaderIndexPath;
@property(assign,readwrite) double globalTopPadding;
@property(assign,readonly) unsigned long long hash;
@property(assign,copy) NSSet * hiddenItemIndexPaths;
...
@property(assign,readonly) long long itemsPerRow;
@property(assign,readonly) PULayoutSampledSectioning * layoutSectioning;
@property(assign,readonly) long long numberOfVisualSections;
@property(assign,copy) NSString * renderedStripsElementKind;
@property(assign,readwrite) double sectionBottomPadding;
@property(assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } sectionContentInset;
@property(assign,copy) NSString * sectionHeaderElementKind;
@property(assign,readwrite) double sectionHeaderHeight;
@property(assign,readwrite) double sectionTopPadding;
@property(assign,readonly) Class superclass;
@property(assign,readonly) struct CGSize { double x1; double x2; } transitionActualContentSize;
@property(assign,readonly) long long transitionAnchorColumnOffset;
@property(assign,readwrite) bool transitionAnchorShiftsColumns;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } transitionEffectiveContentOrigin;
@property(assign,readonly) struct CGPoint { double x1; double x2; } transitionEndContentOffset;
@property(assign,copy) NSIndexPath * transitionExplicitAnchorItemIndexPath;
@property(assign,copy) NSIndexPath * transitionFirstVisibleRowVisualPath;
@property(assign,readwrite) bool transitionIsAnimated;
@property(assign,readonly) bool transitionIsAppearing;
@property(assign,copy) NSIndexPath * transitionLastVisibleRowVisualPath;
@property(assign,readonly) UICollectionViewLayout * transitionLayout;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } transitionStartContentOffset;
@property(assign,readwrite) bool transitionZoomingOut;
@property(assign,readwrite) <PUCollectionViewLayoutTransitioningDelegate> * transitioningDelegate;
@property(assign,readwrite) bool usesRenderedStripTopExtendersForTransitions;
