...
@property(setter=_setAggregateSession:,assign,retain) PLPhotoEditAggregateSession * _aggregateSession;
@property(setter=_setBaseWorkCIImage:,assign,retain) CIImage * _baseWorkCIImage;
@property(setter=_setBaseWorkUIImage:,assign,retain) UIImage * _baseWorkUIImage;
@property(setter=_setCanAnimateNextAutoEnhance:,assign,readwrite) bool _canAnimateNextAutoEnhance;
@property(setter=_setCancelConfirmationAlert:,assign,readwrite) UIAlertController * _cancelConfirmationAlert;
@property(setter=_setCurrentResourceLoadRequest:,assign,retain) PUResourceDownloadRequest * _currentResourceLoadRequest;
@property(setter=_setLayoutReferenceSize:,assign,readwrite) struct CGSize { double x1; double x2; } _layoutReferenceSize;
@property(setter=_setMainRenderer:,assign,retain) PLPhotoEditRenderer * _mainRenderer;
@property(setter=_setNextRenderCompletionBlock:,assign,copy) id _nextRenderCompletionBlock;
@property(setter=_setOriginalWorkCIImage:,assign,retain) CIImage * _originalWorkCIImage;
@property(setter=_setOriginalWorkUIImage:,assign,retain) UIImage * _originalWorkUIImage;
@property(getter=_isPenultimateAvailable,setter=_setPenultimateAvailable:,assign,readwrite) bool _penultimateAvailable;
@property(setter=_setPhotoEditModel:,assign,retain) PLPhotoEditMutableModel * _photoEditModel;
@property(setter=_setPreviewRenderType:,assign,readwrite) long long _previewRenderType;
@property(setter=_setPreviewingOriginalRenderer:,assign,retain) PLPhotoEditRenderer * _previewingOriginalRenderer;
@property(setter=_setRedEyeController:,assign,retain) PURedeyeToolController * _redEyeController;
@property(setter=_setResourcesAvailability:,assign,readwrite) long long _resourcesAvailability;
@property(setter=_setRevertConfirmationAlert:,assign,readwrite) UIAlertController * _revertConfirmationAlert;
@property(getter=_isRevertingToOriginal,setter=_setRevertingToOriginal:,assign,readwrite) bool _revertingToOriginal;
@property(setter=_setShouldBePreviewingOriginal:,assign,readwrite) bool _shouldBePreviewingOriginal;
@property(setter=_setUneditedPhotoEditModel:,assign,copy) PLPhotoEditModel * _uneditedPhotoEditModel;
@property(setter=_setValuesCalculator:,assign,retain) PUPhotoEditValuesCalculator * _valuesCalculator;
@property(getter=_isWaitingForAssetChange,setter=_setWaitingForAssetChange:,assign,readwrite) bool _waitingForAssetChange;
@property(setter=_setWaitingForBaseImageRequest:,assign,readwrite) bool _waitingForBaseImageRequest;
@property(setter=_setWaitingForOriginalImageRequest:,assign,readwrite) bool _waitingForOriginalImageRequest;
@property(getter=_isWaitingForSaveCompletion,setter=_setWaitingForSaveCompletion:,assign,readwrite) bool _waitingForSaveCompletion;
@property(setter=_setWorkImageVersion:,assign,readwrite) long long _workImageVersion;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <PUPhotoEditViewControllerDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) long long layoutOrientation;
@property(assign,readonly) PHAsset * photo;
@property(assign,readonly) PUPhotoEditViewControllerSpec * photoEditSpec;
@property(assign,retain) UIImage * placeholderImage;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } previewViewFrame;
@property(getter=isPreviewViewHidden,assign,readwrite) bool previewViewHidden;
