...
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } photoFrame;
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } photoFrameForZoomTransition;
@property (nonatomic, readonly) UIImage *photoImage;
@property (nonatomic, readonly) UIImage *photoImageForZoomTransition;
@property (setter=ppt_setOnDidEndPagingBlock:, nonatomic, copy) id ppt_onDidEndPagingBlock;
