...
@property(setter=_setAboutToCreateAlbum:,assign,readwrite) bool _aboutToCreateAlbum;
...
@property(setter=_setCachedFeedViewController:,assign,retain) PUFeedViewController * _cachedFeedViewController;
@property(assign,readonly) PHCachingImageManager * _cachingImageManager;
@property(setter=_setCreateAlbumAlertAction:,assign,readwrite) UIAlertAction * _createAlbumAlertAction;
@property(setter=_setEmptyPlaceholderView:,assign,retain) _UIContentUnavailableView * _emptyPlaceholderView;
@property(assign,retain) PUCollageView * _feedCollageView;
@property(assign,retain) PUFeedRecentsManager * _feedRecentsManager;
@property(setter=_setIgnoredReorderNotificationCount:,assign,readwrite) long long _ignoredReorderNotificationCount;
@property(setter=_setKeyboardAware:,assign,readwrite) bool _isKeyboardAware;
@property(setter=_setJustCreatedCollectionAnimationCompletionHandler:,assign,copy) id _justCreatedCollectionAnimationCompletionHandler;
@property(setter=_setJustCreatedCollectionIdentifier:,assign,retain) NSString * _justCreatedCollectionIdentifier;
@property(setter=_setMainCollectionView:,assign,retain) PUCollectionView * _mainCollectionView;
@property(setter=_setMainCollectionViewLayout:,assign,retain) PUSectionedGridLayout * _mainCollectionViewLayout;
@property(setter=_setMainTableView:,assign,retain) UITableView * _mainTableView;
...
@property(setter=_setOnViewDidLayoutSubviewsBlock:,assign,copy) id _onViewDidLayoutSubviewsBlock;
@property(setter=_setPhotoPinchGestureRecognizer:,assign,retain) PUPhotoPinchGestureRecognizer * _photoPinchGestureRecognizer;
@property(setter=_setPreheatedCollections:,assign,retain) NSMutableSet * _preheatedCollections;
...
@property(assign,readonly) NSMutableDictionary * _subCollectionActiveCountFetchOperations;
...
@property(assign,readonly) long long albumsSection;
@property(assign,readonly) long long bottomPlaceholdersSection;
@property(assign,retain) PHCollectionList * collectionList;
@property(assign,retain) PHFetchResult * collectionsFetchResult;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool disallowsSearch;
@property(assign,retain) PHFetchResult * filteredFetchResult;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) bool isRootFolder;
@property(assign,readonly) bool isRootSharedAlbumList;
@property(assign,readwrite) bool progressViewVisible;
@property(assign,retain) PHCollection * pushedAlbum;
@property(assign,retain) UIViewController * pushedController;
@property(assign,retain) PHCollection * retitlingCollection;
@property(assign,retain) PUSessionInfo * sessionInfo;
@property(assign,readonly) PUAlbumListViewControllerSpec * spec;
@property(assign,readonly) Class superclass;
@property(assign,retain) PUPhotosGlobalFooterView * syncProgressView;
@property(assign,readonly) long long topPlaceholdersSection;
@property(getter=isViewInSyncWithModel,assign,readwrite) bool viewInSyncWithModel;
