...
@property(setter=_setFittingRegion:,assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _fittingRegion;
@property(setter=_setImageGeometry:,assign,retain) PLImageGeometry * _imageGeometry;
@property(setter=_setImageView:,assign,retain) UIImageView * _imageView;
@property(setter=_setPreferredZoomScale:,assign,readwrite) double _preferredZoomScale;
@property(getter=_isRotationSideways,assign,readonly) bool _rotationSideways;
@property(assign,readonly) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } _rotationTransform;
@property(setter=_setScrollView:,assign,retain) UIScrollView * _scrollView;
@property(setter=_setScrollViewReference:,assign,retain) UIView * _scrollViewReference;
@property(getter=_isScrollViewTracking,setter=_setScrollViewTracking:,assign,readwrite) bool _scrollViewTracking;
@property(getter=_isUpdatingForCrop,setter=_setUpdatingForCrop:,assign,readwrite) bool _updatingForCrop;
@property(getter=_isUpdatingForFit,setter=_setUpdatingForFit:,assign,readwrite) bool _updatingForFit;
@property(getter=_isUpdatingForStraighten,setter=_setUpdatingForStraighten:,assign,readwrite) bool _updatingForStraighten;
@property(assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } canvasFrame;
...
@property(assign,readwrite) <PUCropAndStraightenViewDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readonly) unsigned long long hash;
@property(assign,retain) UIImage * image;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } imageCropRect;
