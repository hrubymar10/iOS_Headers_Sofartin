...
@property(setter=_setCIImage:,assign,retain) CIImage * _CIImage;
@property(getter=_isActiveTool,setter=_setActiveTool:,assign,readwrite) bool _activeTool;
@property(setter=_setAnimationTargetsByKeyPath:,assign,retain) NSMutableDictionary * _animationTargetsByKeyPath;
@property(setter=_setAnimationsByKeyPath:,assign,retain) NSMutableDictionary * _animationsByKeyPath;
@property(setter=_setAspectAlertController:,assign,readwrite) UIAlertController * _aspectAlertController;
@property(setter=_setAspectButton:,assign,retain) UIButton * _aspectButton;
@property(setter=_setContentViewsHidden:,assign,readwrite) bool _contentViewsHidden;
@property(setter=_setContentViewsHiddenAnimationCount:,assign,readwrite) unsigned long long _contentViewsHiddenAnimationCount;
@property(setter=_setCropAspect:,assign,retain) PUCropAspect * _cropAspect;
@property(setter=_setCropCanvasView:,assign,retain) UIView * _cropCanvasView;
@property(setter=_setCropHandleViewsByHandle:,assign,retain) NSDictionary * _cropHandleViewsByHandle;
@property(setter=_setCropOverlayView:,assign,retain) PUCropOverlayView * _cropOverlayView;
@property(setter=_setCropToggleButton:,assign,retain) UIButton * _cropToggleButton;
@property(setter=_setCropToggleButtonTitle:,assign,copy) NSString * _cropToggleButtonTitle;
@property(setter=_setCropView:,assign,retain) PUCropAndStraightenView * _cropView;
@property(setter=_setCropViewFrameForLastModelLoad:,assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _cropViewFrameForLastModelLoad;
@property(setter=_setGeometry:,assign,retain) PLImageGeometry * _geometry;
@property(setter=_setHasAppliedCropSuggestion:,assign,readwrite) bool _hasAppliedCropSuggestion;
@property(setter=_setHasAutoAppliedCropSuggestion:,assign,readwrite) bool _hasAutoAppliedCropSuggestion;
@property(setter=_setHasRequestedCropSuggestion:,assign,readwrite) bool _hasRequestedCropSuggestion;
@property(setter=_setIgnoreTrackingUpdates:,assign,readwrite) bool _ignoreTrackingUpdates;
@property(setter=_setImage:,assign,retain) UIImage * _image;
@property(setter=_setInitialHandlePanCropRect:,assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _initialHandlePanCropRect;
@property(setter=_setInitialLocationsInHandlesByHandle:,assign,retain) NSMutableDictionary * _initialLocationsInHandlesByHandle;
@property(setter=_setLastKnownEditModel:,assign,retain) PLPhotoEditModel * _lastKnownEditModel;
@property(getter=_isModelChangeLocal,setter=_setModelChangeLocal:,assign,readwrite) bool _modelChangeLocal;
@property(setter=_setNeedsImageLoad:,assign,readwrite) bool _needsImageLoad;
@property(setter=_setNeedsModelLoad:,assign,readwrite) bool _needsModelLoad;
@property(setter=_setNormalizedImageRect:,assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _normalizedImageRect;
@property(setter=_setPreviewViewInsets:,assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } _previewViewInsets;
@property(setter=_setRenderer:,assign,retain) PLPhotoEditRenderer * _renderer;
@property(setter=_setRotateButton:,assign,retain) UIButton * _rotateButton;
@property(setter=_setRotateSnapshotView:,assign,retain) UIView * _rotateSnapshotView;
@property(setter=_setRotatingAnimationCount:,assign,readwrite) unsigned long long _rotatingAnimationCount;
@property(setter=_setSelectedCropHandleView:,assign,retain) PUCropHandleView * _selectedCropHandleView;
@property(setter=_setStraightenAngle:,assign,readwrite) double _straightenAngle;
@property(setter=_setSuggestedCrop:,assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _suggestedCrop;
@property(setter=_setSuggestedStraightenAngle:,assign,readwrite) double _suggestedStraightenAngle;
@property(setter=_setTiltControl:,assign,retain) PUTiltWheelControl * _tiltControl;
@property(setter=_setViewCropRect:,assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _viewCropRect;
@property(setter=_setWantsPreviewViewHidden:,assign,readwrite) bool _wantsPreviewViewHidden;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) PUCropToolControllerSpec * spec;
@property(assign,readonly) Class superclass;
@property(getter=_isTrackingTitlControl,setter=_setTrackingTiltControl:,assign,readwrite) bool trackingTiltControl;
