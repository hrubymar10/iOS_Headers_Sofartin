...
@property(assign,retain) MCNearbyServiceBrowser * browser;
@property(assign,retain) UIBarButtonItem * cancelButton;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) unsigned long long declinedPeersCount;
@property(assign,readwrite) <MCBrowserViewControllerDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,retain) UIBarButtonItem * doneButton;
@property(assign,retain) NSMutableArray * foundPeers;
@property(assign,retain) NSBundle * frameworkBundle;
@property(assign,readonly) unsigned long long hash;
@property(assign,retain) NSMutableArray * invitedPeersSection;
@property(assign,retain) NSMutableDictionary * invitedPeersState;
@property(assign,readwrite) unsigned long long maximumNumberOfPeers;
@property(assign,readonly) bool maximumNumberOfPeersReached;
@property(assign,readwrite) unsigned long long minimumNumberOfPeers;
@property(assign,readonly) bool minimumNumberOfPeersReached;
@property(assign,copy) MCPeerID * myPeerID;
@property(assign,retain) UINavigationBar * navigationBar;
@property(assign,retain) NSMutableArray * nearbyPeersSection;
