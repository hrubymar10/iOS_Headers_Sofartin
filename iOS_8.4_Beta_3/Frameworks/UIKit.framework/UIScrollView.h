...
@property(setter=_setAutomaticContentConstraints:,assign,copy) NSArray * _automaticContentConstraints;
@property(assign,retain) NSISVariable * _contentHeightVariable;
@property(assign,retain) NSISVariable * _contentWidthVariable;
@property(assign,readonly) _UIStaticScrollBar * _staticScrollBar;
@property(setter=_setUseContentDimensionVariablesForConstraintLowering:,assign,readwrite) bool _useContentDimensionVariablesForConstraintLowering;
@property(setter=_setWantsConstrainedContentSize:,assign,readwrite) bool _wantsConstrainedContentSize;
@property(getter=_adjustsTargetsOnContentOffsetChanges,setter=_setAdjustsTargetsOnContentOffsetChanges:,assign,readwrite) bool adjustsTargetsOnContentOffsetChanges;
@property(assign,readwrite) bool alwaysBounceHorizontal;
@property(assign,readwrite) bool alwaysBounceVertical;
@property(assign,readwrite) bool bounces;
@property(assign,readwrite) bool bouncesZoom;
@property(assign,readwrite) bool canCancelContentTouches;
...
@property(getter=isDecelerating,assign,readonly) bool decelerating;
@property(assign,readwrite) double decelerationRate;
@property(assign,readwrite) bool delaysContentTouches;
...
@property(getter=isDragging,assign,readonly) bool dragging;
@property(getter=_isFirstResponderKeyboardAvoidanceEnabled,setter=_setFirstResponderKeyboardAvoidanceEnabled:,assign,readwrite) bool firstResponderKeyboardAvoidanceEnabled;
@property(getter=_forwardsTouchesUpResponderChain,setter=_setForwardsTouchesUpResponderChain:,assign,readwrite) bool forwardsTouchesUpResponderChain;
@property(assign,readwrite) long long indicatorStyle;
@property(getter=_isAnimatingScroll,assign,readonly) bool isAnimatingScroll;
@property(getter=_isAnimatingZoom,assign,readonly) bool isAnimatingZoom;
@property(getter=_isHorizontalBouncing,assign,readonly) bool isHorizontalBouncing;
@property(getter=_isVerticalBouncing,assign,readonly) bool isVerticalBouncing;
@property(assign,readwrite) long long keyboardDismissMode;
@property(assign,readwrite) double maximumZoomScale;
@property(assign,readwrite) double minimumZoomScale;
@property(getter=isPagingEnabled,assign,readwrite) bool pagingEnabled;
...
@property(getter=isProgrammaticScrollEnabled,assign,readwrite) bool programmaticScrollEnabled;
...
@property(assign,retain) id scrollTestParameters;
@property(getter=_isScrollingToTop,assign,readonly) bool scrollingToTop;
@property(assign,readwrite) bool scrollsToTop;
...
@property(getter=_zoomAnchorPoint,setter=_setZoomAnchorPoint:,assign,readwrite) struct CGPoint { double x1; double x2; } zoomAnchorPoint;
@property(getter=isZoomBouncing,assign,readonly) bool zoomBouncing;
@property(assign,readwrite) double zoomScale;
@property(getter=isZooming,assign,readonly) bool zooming;
