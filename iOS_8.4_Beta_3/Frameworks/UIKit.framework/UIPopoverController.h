...
@property(assign,readwrite) <UIPopoverControllerDelegate> * delegate;
...
@property(assign,readwrite) struct CGSize { double x1; double x2; } popoverContentSize;
@property(assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } popoverLayoutMargins;
@property(getter=isPopoverVisible,assign,readonly) bool popoverVisible;
@property(assign,retain) _UIPopoverLayoutInfo * preferredLayoutInfo;
@property(getter=_presentationController,setter=_setPresentationController:,assign,retain) UIPopoverPresentationController * presentationController;
