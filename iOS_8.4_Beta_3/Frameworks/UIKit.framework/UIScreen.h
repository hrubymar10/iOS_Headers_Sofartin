...
@property (setter=_setInterfaceOrientation:, nonatomic) long long _interfaceOrientation;
@property (setter=_setLastNotifiedBacklightLevel:, nonatomic) long long _lastNotifiedBacklightLevel;
...
@property (getter=_unjailedReferenceBounds, nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _unjailedReferenceBounds;
...
@property (getter=_jailOffset, setter=_setJailOffset:, nonatomic) struct CGPoint { double x1; double x2; } jailOffset;
@property (getter=_jailOrientation, setter=_setJailOrientation:, nonatomic) long long jailOrientation;
@property (getter=_jailScale, setter=_setJailScale:, nonatomic) double jailScale;
@property (getter=_jailSize, setter=_setJailSize:, nonatomic) struct CGSize { double x1; double x2; } jailSize;
@property (getter=_jailTouchInsets, setter=_setJailTouchInsets:, nonatomic) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } jailTouchInsets;
