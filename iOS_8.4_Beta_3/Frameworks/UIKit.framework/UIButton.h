...
@property(setter=_setContentConstraints:,assign,copy) NSArray * _contentConstraints;
@property(assign,retain) UIColor * _currentImageColor;
@property(setter=_setExternalFlatEdge:,assign,readwrite) unsigned long long _externalFlatEdge;
@property(setter=_setInternalTitlePaddingInsets:,assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } _internalTitlePaddingInsets;
@property(assign,copy) NSString * ab_text;
@property(assign,copy) NSDictionary * ab_textAttributes;
@property(assign,readwrite) bool adjustsImageWhenDisabled;
...
@property(assign,retain) NSAttributedString * currentAttributedTitle;
@property(assign,retain) UIImage * currentBackgroundImage;
@property(assign,retain) UIImage * currentImage;
@property(assign,retain) NSString * currentTitle;
@property(assign,retain) UIColor * currentTitleColor;
@property(assign,retain) UIColor * currentTitleShadowColor;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } imageEdgeInsets;
@property(assign,retain) UIImageView * imageView;
@property(assign,readwrite) bool reversesTitleShadowWhenHighlighted;
@property(assign,readwrite) bool showsTouchWhenHighlighted;
@property(assign,readonly) Class superclass;
@property(assign,retain) UIColor * tintColor;
@property(assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } titleEdgeInsets;
