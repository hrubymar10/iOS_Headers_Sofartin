...
@property(getter=_viewController,setter=_setViewController:,assign,retain) UIViewController * _viewController;
@property(assign,retain) _UIModalItemBackgroundView * backgroundView;
@property(assign,copy) NSArray * buttonTitles;
@property(assign,readwrite) long long cancelButtonIndex;
@property(assign,retain) _UIModalItemContentView * contentView;
@property(assign,retain) UIViewController * contentViewController;
@property(assign,readwrite) struct CGSize { double x1; double x2; } contentViewControllerSize;
@property(assign,readwrite) long long defaultButtonIndex;
@property(assign,readwrite) <UIModalItemDelegate> * delegate;
@property(assign,readwrite) long long dismissAnimationType;
@property(assign,readwrite) long long dismissIndex;
@property(assign,readwrite) bool dontUpdateFrameForKBChanges;
@property(assign,readwrite) bool enableFirstOtherButton;
@property(assign,readwrite) bool forceVerticalLayout;
@property(assign,readwrite) bool isBeingDismissed;
@property(assign,readwrite) bool isHidden;
@property(assign,readonly) bool isPresented;
@property(assign,copy) NSString * loginPlaceholderString;
@property(assign,copy) NSString * loginString;
@property(assign,copy) NSString * message;
@property(assign,copy) NSAttributedString * messageAttributedString;
@property(assign,readwrite) long long messageMaxLineNumber;
@property(assign,readwrite) long long modalItemInputStyle;
@property(assign,readwrite) long long numberOfButtonsRows;
@property(assign,copy) NSString * passwordPlaceholderString;
@property(assign,copy) NSString * passwordString;
@property(assign,readwrite) long long presentAnimationType;
@property(assign,copy) NSString * subtitleString;
...
@property(assign,readwrite) UIView * targetView;
@property(assign,readwrite) bool textFieldsHidden;
@property(assign,copy) NSString * title;
@property(assign,copy) NSAttributedString * titleAttributedString;
@property(assign,readwrite) long long titleMaxLineNumber;
@property(assign,readwrite) long long type;
@property(assign,readwrite) bool useUndoStyle;
@property(assign,readwrite) bool useWifiPickerLayout;
