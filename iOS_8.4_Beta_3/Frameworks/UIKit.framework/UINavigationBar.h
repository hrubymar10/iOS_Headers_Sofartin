...
@property(setter=_setAnimationIds:,assign,retain) NSMutableArray * _animationIds;
@property(setter=_setBackIndicatorImage:,assign,retain) UIImage * _backIndicatorImage;
@property(setter=_setBackIndicatorLeftMargin:,assign,readwrite) double _backIndicatorLeftMargin;
@property(assign,retain) NSString * _backdropViewLayerGroupName;
@property(setter=_setBackdropViewLayerGroupName:,assign,retain) NSString * _backdropViewLayerGroupName;
@property(setter=_setBackgroundView:,assign,retain) UIView * _backgroundView;
@property(assign,readonly) long long _barTranslucence;
@property(getter=_isCondensed,setter=_setCondensed:,assign,readwrite) bool _condensed;
@property(assign,readonly) double _heightIncludingBackground;
@property(setter=_setNeedsUpdateBackIndicatorImage:,assign,readwrite) bool _needsUpdateBackIndicatorImage;
@property(setter=_setRequestedMaxBackButtonWidth:,assign,readwrite) double _requestedMaxBackButtonWidth;
@property(setter=_setRequestedMaxBackButtonWidth:,assign,readwrite) double _requestedMaxBackButtonWidth;
@property(setter=_setShadowAlpha:,assign,readwrite) double _shadowAlpha;
...
@property(assign,retain) UINavigationItem * backItem;
...
@property(assign,readwrite) <UINavigationBarDelegate> * delegate;
...
@property(assign,copy) NSDictionary * titleTextAttributes;
@property(assign,retain) UINavigationItem * topItem;
