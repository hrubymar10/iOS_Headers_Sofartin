...
@property(assign,readwrite) long long accessoryType;
...
@property(assign,retain) UILabel * detailTextLabel;
@property(getter=isEditing,assign,readwrite) bool editing;
@property(assign,readwrite) long long editingAccessoryType;
@property(assign,retain) UIView * editingAccessoryView;
@property(assign,readonly) long long editingStyle;
@property(assign,readonly) unsigned long long hash;
@property(getter=isHighlighted,assign,readwrite) bool highlighted;
@property(assign,retain) UIImageView * imageView;
@property(assign,readwrite) long long indentationLevel;
@property(assign,readwrite) double indentationWidth;
@property(assign,retain) UIView * multipleSelectionBackgroundView;
...
@property(assign,readwrite) bool shouldIndentWhileEditing;
@property(assign,readonly) bool showingDeleteConfirmation;
@property(assign,readwrite) bool showsReorderControl;
