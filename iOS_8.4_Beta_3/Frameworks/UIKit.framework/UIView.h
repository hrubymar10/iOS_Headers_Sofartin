...
@property(setter=_setAccessoryViewFrame:,assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _accessoryViewFrame;
@property(getter=_ancestorDefinesTintAdjustmentMode,setter=_setAncestorDefinesTintAdjustmentMode:,assign,readwrite) bool _ancestorDefinesTintAdjustmentMode;
@property(getter=_ancestorDefinesTintColor,setter=_setAncestorDefinesTintColor:,assign,readwrite) bool _ancestorDefinesTintColor;
@property(assign,readonly) UIView * _backdropMaskViewForColorTint;
@property(assign,readonly) UIView * _backdropMaskViewForFilters;
@property(assign,readonly) UIView * _backdropMaskViewForGrayscaleTint;
@property(assign,readonly) NSArray * _backdropMaskViews;
@property(assign,retain) NSISVariable * _boundsHeightVariable;
@property(assign,retain) NSISVariable * _boundsWidthVariable;
@property(assign,retain) NSArray * _constraintsExceptingSubviewAutoresizingConstraints;
@property(assign,readwrite) unsigned long long _countOfMotionEffectsInSubtree;
@property(setter=_setInferredLayoutMargins:,assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } _inferredLayoutMargins;
@property(assign,readonly) UIKBRenderConfig * _inheritedRenderConfig;
@property(setter=_setInteractionTintColor:,assign,retain) UIColor * _interactionTintColor;
@property(setter=_setInternalConstraints:,assign,retain) NSMutableArray * _internalConstraints;
@property(setter=_setLayoutDebuggingIdentifier:,assign,copy) NSString * _layoutDebuggingIdentifier;
@property(setter=_setLayoutEngine:,assign,retain) NSISEngine * _layoutEngine;
@property(assign,readonly) bool _lightStyleRenderConfig;
@property(assign,retain) MKMapView * _mapKit_mapView;
@property(assign,retain) CALayer * _mapkit_currentLayer;
@property(assign,readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _mapkit_doubleFrame;
@property(setter=_setMaskView:,assign,retain) UIView * _maskView;
@property(setter=_setMayRemainFocused:,assign,readwrite) bool _mayRemainFocused;
@property(assign,retain) NSISVariable * _minXVariable;
@property(assign,retain) NSISVariable * _minYVariable;
@property(getter=_presentationControllerToNotifyOnLayoutSubviews,setter=_setPresentationControllerToNotifyOnLayoutSubviews:,assign,retain) UIPresentationController * _presentationControllerToNotifyOnLayoutSubviews;
@property(setter=_setRawLayoutMargins:,assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } _rawLayoutMargins;
@property(setter=_setShouldArchiveUIAppearanceTags:,assign,readwrite) bool _shouldArchiveUIAppearanceTags;
@property(getter=_userInterfaceIdiom,setter=_setUserInterfaceIdiom:,assign,readwrite) long long _userInterfaceIdiom;
@property(assign,readonly) bool _wantsGeometryChangeNotification;
@property(assign,readwrite) int action;
@property(assign,readonly) MPArtworkCatalog * artworkCatalog;
@property(getter=_backgroundColorSystemColorName,setter=_setBackgroundColorSystemColorName:,assign,retain) NSString * backgroundColorSystemColorName;
...
@property(assign,readonly) CALayer * currentLayer;
@property(getter=_currentScreenScale,assign,readonly) double currentScreenScale;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) bool deliversTouchesForGesturesToSuperview;
@property(assign,copy) NSString * description;
@property(assign,copy) NSString * description;
@property(assign,copy) NSString * description;
@property(assign,copy) NSString * description;
@property(assign,copy) NSString * description;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } focusDirection;
@property(getter=isFocused,assign,readonly) bool focused;
@property(assign,readonly) UIView * focusedView;
@property(assign,readwrite) bool gesturesEnabled;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) unsigned long long hash;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) struct CGPoint { double x1; double x2; } integralCenter;
@property(assign,retain) UIColor * interactionTintColor;
@property(assign,retain) CALayer * layer;
@property(getter=_maskView,setter=_setMaskView:,assign,retain) UIView * maskView;
@property(getter=_monitorsSubtree,setter=_setMonitorsSubtree:,assign,readwrite) bool monitorsSubtree;
@property(assign,readonly) <UIFocusContainer> * preferredFocusedItem;
@property(setter=rc_setAutoUpdatingTextStyle:,assign,readwrite) NSString * rc_autoUpdatingTextStyle;
@property(setter=rc_setCharge:,assign,readwrite) float rc_charge;
@property(assign,readwrite) bool skipsSubviewEnumeration;
...
@property(getter=_isUnsatisfiableConstraintsLoggingSuspended,setter=_setUnsatisfiableConstraintsLoggingSuspended:,assign,readwrite) bool unsatisfiableConstraintsLoggingSuspended;
@property(getter=_isUnsatisfiableConstraintsLoggingSuspended,setter=_setUnsatisfiableConstraintsLoggingSuspended:,assign,readwrite) bool unsatisfiableConstraintsLoggingSuspended;
@property(getter=isUserInteractionEnabled,assign,readwrite) bool userInteractionEnabled;
@property(getter=_viewDelegate,setter=_setViewDelegate:,assign,readwrite) UIViewController * viewDelegate;
@property(assign,readwrite) bool viewTraversalMark;
