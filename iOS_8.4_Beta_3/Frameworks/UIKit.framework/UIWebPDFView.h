...
@property(assign,readonly) struct CGPDFDocument { }* cgPDFDocument;
...
@property(assign,readonly) NSData * documentData;
@property(assign,retain) NSString * documentPassword;
@property(assign,readonly) double documentScale;
@property(assign,readwrite) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } documentTransform;
...
@property(assign,readwrite) long long ignoreContentOffsetChanges;
@property(assign,readwrite) double initialZoomScale;
@property(assign,retain) NSArray * pageMinYs;
@property(assign,retain) NSArray * pageRects;
@property(assign,readwrite) NSObject<UIWebPDFViewDelegate> * pdfDelegate;
@property(assign,readwrite) WebPDFViewPlaceholder * pdfPlaceHolderView;
@property(assign,readwrite) bool readyForSnapshot;
