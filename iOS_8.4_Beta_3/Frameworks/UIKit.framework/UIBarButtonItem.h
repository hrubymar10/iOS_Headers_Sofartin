...
@property(setter=_setFlexible:,assign,readwrite) bool _flexible;
@property(setter=_setHidden:,assign,readwrite) bool _hidden;
@property(setter=_setImageHasEffects:,assign,readwrite) bool _imageHasEffects;
@property(setter=_setItemVariation:,assign,retain) UIBarButtonItem * _itemVariation;
@property(setter=_setItemVariation:,assign,retain) UIBarButtonItem * _itemVariation;
@property(setter=_setMaximumWidth:,assign,readwrite) double _maximumWidth;
@property(setter=_setMinimumWidth:,assign,readwrite) double _minimumWidth;
@property(assign,readonly) bool _needsViewUpdateForLetterpressImage;
@property(assign,readonly) bool _needsViewUpdateForLetterpressImage;
@property(setter=_setOwningNavigationItem:,assign,readwrite) UINavigationItem * _owningNavigationItem;
@property(setter=_setPossibleItemVariations:,assign,copy) NSSet * _possibleItemVariations;
@property(setter=_setPossibleItemVariations:,assign,copy) NSSet * _possibleItemVariations;
@property(setter=_setShowsBackButtonIndicator:,assign,readwrite) bool _showsBackButtonIndicator;
@property(setter=_setStylesForSizingTitles:,assign,copy) NSDictionary * _stylesForSizingTitles;
@property(assign,readonly) UIToolbarButton * _toolbarButton;
@property(setter=_setToolbarCharge:,assign,readwrite) double _toolbarCharge;
@property(assign,readonly) bool _viewWantsLetterpressImage;
@property(assign,readwrite) SEL action;
@property(assign,retain) UIView * customView;
@property(getter=isEnabled,assign,readwrite) bool enabled;
@property(assign,readonly) bool isSystemItem;
@property(assign,readonly) bool isSystemItem;
@property(getter=_miniImage,setter=_setMiniImage:,assign,retain) UIImage * miniImage;
@property(getter=_miniImageInsets,setter=_setMiniImageInsets:,assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } miniImageInsets;
@property(getter=_possibleSystemItems,setter=_setPossibleSystemItems:,assign,copy) NSSet * possibleSystemItems;
@property(getter=_possibleSystemItems,setter=_setPossibleSystemItems:,assign,copy) NSSet * possibleSystemItems;
@property(assign,copy) NSSet * possibleTitles;
@property(assign,readwrite) bool selected;
@property(assign,readwrite) bool selected;
@property(assign,readwrite) long long style;
@property(assign,readonly) long long systemItem;
@property(assign,readonly) long long systemItem;
