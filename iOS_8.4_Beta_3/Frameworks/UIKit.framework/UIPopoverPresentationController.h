...
@property(getter=_centersPopoverIfSourceViewNotSet,setter=_setCentersPopoverIfSourceViewNotSet:,assign,readwrite) bool _centersPopoverIfSourceViewNotSet;
@property(setter=_setDimmingViewTopEdgeInset:,assign,readwrite) double _dimmingViewTopEdgeInset;
@property(setter=_setIgnoresKeyboardNotifications:,assign,readwrite) bool _ignoresKeyboardNotifications;
@property(getter=_shouldHideArrow,setter=_setShouldHideArrow:,assign,readwrite) bool _shouldHideArrow;
@property(assign,readwrite) bool allowResizePastTargetRect;
@property(assign,readonly) unsigned long long arrowDirection;
@property(assign,copy) UIColor * backgroundColor;
@property(assign,retain) UIBarButtonItem * barButtonItem;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <UIPopoverPresentationControllerDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,retain) UIDimmingView * dimmingView;
@property(assign,readwrite) bool dismissesOnRotation;
...
@property(assign,readwrite) unsigned long long popoverArrowDirection;
@property(assign,retain) Class popoverBackgroundViewClass;
@property(assign,readwrite) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } popoverLayoutMargins;
@property(assign,retain) _UIPopoverLayoutInfo * preferredLayoutInfo;
@property(getter=_presentationEdge,setter=_setPresentationEdge:,assign,readwrite) unsigned long long presentationEdge;
@property(getter=_presentingView,setter=_setPresentingView:,assign,readwrite) UIView * presentingView;
@property(getter=_retainsSelfWhilePresented,setter=_setRetainsSelfWhilePresented:,assign,readwrite) bool retainsSelfWhilePresented;
@property(assign,readwrite) bool showsOrientationMarker;
@property(assign,readwrite) bool showsPresentationArea;
@property(assign,readwrite) bool showsTargetRect;
@property(assign,readwrite) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } sourceRect;
@property(assign,retain) UIView * sourceView;
