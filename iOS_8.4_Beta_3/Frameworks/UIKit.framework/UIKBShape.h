...
@property(assign,retain) UIKBGeometry * geometry;
@property(assign,retain) UIKBShape * originalShape;
...
@property(assign,readwrite) bool scaled;
@property(assign,readonly) unsigned long long uid;
