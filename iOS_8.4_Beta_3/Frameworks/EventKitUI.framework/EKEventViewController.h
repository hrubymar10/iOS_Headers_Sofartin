...
@property(getter=isICSPreview,assign,readwrite) bool ICSPreview;
@property(assign,retain) EKEventEditViewController * activeEventEditor;
@property(assign,readwrite) bool allowsCalendarPreview;
@property(assign,readwrite) bool allowsEditing;
@property(assign,readwrite) bool allowsInviteResponses;
@property(assign,readwrite) bool allowsSubitems;
@property(assign,readwrite) bool alwaysShowsCalendarPreview;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) <EKEventViewDelegate> * delegate;
@property(assign,copy) NSString * description;
@property(assign,readwrite) int editorHideTransition;
@property(assign,readwrite) int editorShowTransition;
@property(assign,retain) EKEvent * event;
@property(assign,readwrite) UIViewController * eventDetailContainer;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) bool hideNavigationBar;
@property(assign,readwrite) double leftInset;
@property(assign,readwrite) bool minimalMode;
@property(assign,readwrite) double rightInset;
@property(assign,readwrite) int scrollToSection;
@property(assign,readwrite) bool showsAddToCalendar;
@property(assign,readwrite) bool showsDelegateMessage;
@property(assign,readwrite) bool showsDelegatorMessage;
@property(assign,readwrite) bool showsDoneButton;
@property(assign,readwrite) bool showsOutOfDateMessage;
