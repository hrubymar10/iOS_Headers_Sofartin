...
@property(assign,copy) NSString * addressForMissingIdentity;
@property(assign,retain) MFModernComposeRecipientAtom * atomPresentingCard;
@property(assign,retain) <NSCoding> * autosaveIdentifier;
@property(assign,readonly) NSDate * autosavedDate;
@property(assign,retain) NSDictionary * certificatesByRecipient;
@property(assign,copy) NSString * debugDescription;
@property(assign,readwrite) id delegate;
@property(assign,readonly) MFOutgoingMessageDelivery * delivery;
@property(assign,copy) NSString * description;
@property(assign,retain) NSDictionary * errorsByRecipient;
@property(assign,readonly) unsigned long long hash;
@property(assign,readwrite) bool isModal;
@property(assign,readonly) MFMailboxUid * lastDraftMailboxUid;
@property(assign,readonly) NSString * lastDraftMessageID;
@property(assign,copy) NSString * originatingBundleID;
@property(assign,retain) ABPeoplePickerNavigationController * peoplePicker;
@property(assign,retain) ABPersonViewController * personViewController;
@property(assign,retain) UIAlertController * popoverAlert;
@property(assign,retain) MFComposeRecipient * recipientPresentingCard;
@property(assign,retain) id remoteViewControllerProxy;
@property(assign,readwrite) int sourceAccountManagement;
@property(assign,readonly) Class superclass;
@property(assign,retain) ABUnknownPersonViewController * unknownPersonViewController;
@property(getter=isVerticallyCompact,assign,readonly) bool verticallyCompact;
