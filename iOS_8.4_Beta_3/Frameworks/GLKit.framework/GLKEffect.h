...
@property(assign,readwrite) int aColorLoc;
@property(assign,readwrite) union _GLKVector4 { struct { float x_1_1_1; float x_1_1_2; float x_1_1_3; float x_1_1_4; } x1; struct { float x_2_1_1; float x_2_1_2; float x_2_1_3; float x_2_1_4; } x2; struct { float x_3_1_1; float x_3_1_2; float x_3_1_3; float x_3_1_4; } x3; float x4[4]; } baseLightingColor;
@property(assign,readwrite) int baseLightingColorLoc;
@property(assign,readwrite) unsigned char colorMaterialEnabled;
@property(assign,readwrite) unsigned long long dirtyUniforms;
@property(assign,readwrite) id* effectShaderArray;
@property(assign,readwrite) struct GLKBigInt_s { unsigned long long x1; unsigned long long x2; }* fshMask;
@property(assign,readwrite) unsigned int fshName;
@property(assign,readonly) GLKShaderBlockNode * fshRootNode;
@property(assign,readwrite) char ** fshStrings;
@property(assign,copy) NSString * label;
@property(assign,readwrite) union _GLKVector4 { struct { float x_1_1_1; float x_1_1_2; float x_1_1_3; float x_1_1_4; } x1; struct { float x_2_1_1; float x_2_1_2; float x_2_1_3; float x_2_1_4; } x2; struct { float x_3_1_1; float x_3_1_2; float x_3_1_3; float x_3_1_4; } x3; float x4[4]; } lightModelAmbientColor;
@property(assign,readwrite) int lightModelAmbientColorLoc;
@property(assign,readwrite) unsigned char lightModelTwoSided;
@property(assign,retain) NSMutableArray * lightProperties;
@property(assign,readwrite) unsigned char masksInitialized;
@property(assign,readonly) float* materialAmbientColor;
@property(assign,readonly) float* materialDiffuseColor;
@property(assign,readwrite) unsigned int numFshStrings;
@property(assign,readwrite) unsigned int numLights;
@property(assign,readwrite) unsigned int numTextures;
@property(assign,readwrite) unsigned int numVshStrings;
@property(assign,readwrite) unsigned char perPixelLightingEnabled;
@property(assign,readwrite) unsigned char perVertexLightingEnabled;
@property(assign,readwrite) struct GLKBigInt_s { unsigned long long x1; unsigned long long x2; } prevFshMask;
@property(assign,readwrite) struct GLKBigInt_s { unsigned long long x1; unsigned long long x2; } prevVshMask;
@property(assign,readonly) NSMutableDictionary * programHash;
@property(assign,readwrite) unsigned int programName;
@property(assign,retain) NSMutableArray * properties;
@property(assign,copy) NSArray * textureOrder;
@property(assign,readwrite) bool textureOrderStale;
@property(assign,readwrite) unsigned char texturingEnabled;
@property(assign,readwrite) struct GLKBigInt_s { unsigned long long x1; unsigned long long x2; }* vshMask;
@property(assign,readwrite) unsigned int vshName;
@property(assign,readonly) GLKShaderBlockNode * vshRootNode;
@property(assign,readwrite) char ** vshStrings;
