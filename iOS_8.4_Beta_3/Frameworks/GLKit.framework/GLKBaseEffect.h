...
@property(assign,readwrite) union _GLKVector4 { struct { float x_1_1_1; float x_1_1_2; float x_1_1_3; float x_1_1_4; } x1; struct { float x_2_1_1; float x_2_1_2; float x_2_1_3; float x_2_1_4; } x2; struct { float x_3_1_1; float x_3_1_2; float x_3_1_3; float x_3_1_4; } x3; float x4[4]; } constantColor;
@property(assign,readonly) GLKEffectPropertyConstantColor * constantColorProp;
@property(assign,readwrite) GLKEffect * effect;
@property(assign,readwrite) unsigned char effectStale;
@property(assign,readonly) GLKEffectPropertyFog * fog;
@property(assign,copy) NSString * label;
@property(assign,readonly) GLKEffectPropertyLight * light0;
@property(assign,readonly) GLKEffectPropertyLight * light1;
@property(assign,readonly) GLKEffectPropertyLight * light2;
...
@property(assign,readonly) GLKEffectPropertyMaterial * material;
@property(assign,readwrite) unsigned int programName;
@property(assign,readonly) NSMutableArray * propertyArray;
@property(assign,readwrite) unsigned char propertyArrayStale;
@property(assign,readonly) GLKEffectPropertyTexture * texture2d0;
@property(assign,readonly) GLKEffectPropertyTexture * texture2d1;
@property(assign,copy) NSArray * textureOrder;
@property(assign,readonly) GLKEffectPropertyTransform * transform;
@property(assign,readwrite) unsigned char useConstantColor;
