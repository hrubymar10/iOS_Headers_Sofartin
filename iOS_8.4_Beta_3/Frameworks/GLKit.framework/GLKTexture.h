...
@property(assign,readwrite) unsigned int GLTextureName;
@property(assign,readwrite) unsigned int bindTarget;
@property(assign,readwrite) unsigned int bitsPerPixel;
@property(assign,readwrite) int dataCategory;
@property(assign,readwrite) unsigned int format;
@property(assign,readwrite) bool hasAlpha;
@property(assign,readonly) bool hasPremultipliedAlpha;
...
@property(assign,readwrite) unsigned int internalFormat;
@property(assign,readwrite) bool isCubeMap;
@property(assign,readwrite) bool isMipmapped;
@property(assign,readwrite) bool isPowerOfTwo;
@property(assign,readwrite) bool isVerticalFlipped;
@property(assign,copy) NSString * label;
@property(assign,readwrite) int loadMode;
@property(assign,readwrite) unsigned int nComponents;
@property(assign,readwrite) unsigned int nPrimarySurfaces;
@property(assign,readwrite) unsigned int nSurfaces;
@property(assign,readwrite) unsigned int numMipMapLevels;
@property(assign,readwrite) unsigned int orientation;
@property(assign,readwrite) bool reOrient;
@property(assign,readwrite) unsigned int rowBytes;
@property(assign,readwrite) int texelFormat;
