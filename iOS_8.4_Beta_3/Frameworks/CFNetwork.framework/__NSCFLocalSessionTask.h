...
@property(assign,retain) NSURLSessionConfiguration * _configuration;
@property(assign,copy) id async_initialization;
@property(assign,retain) __NSCFURLSessionConnection * cfConn;
@property(assign,readwrite) struct HTTPConnectionCacheKey { int (**x1)(); struct __CFAllocator {} *x2; int x3; unsigned long long x4; struct __CFString {} *x5; int x6; int x7; struct __CFDictionary {} *x8; unsigned long long x9; struct __CFDictionary {} *x10; struct NetworkProxy {} *x11; struct __CFString {} *x12; int x13; int x14; }* connKey;
@property(assign,copy) id dataTaskCompletion;
@property(assign,readwrite) NSObject<OS_dispatch_data> * dataTaskData;
@property(assign,copy) NSString * debugDescription;
@property(assign,copy) NSString * description;
@property(assign,readwrite) bool didIssueDidFinish;
@property(assign,retain) NSString * duetAccountedBundleID;
@property(assign,readwrite) bool duetAccountingIsDiscretionary;
@property(assign,readonly) unsigned long long hash;
@property(assign,retain) __NSURLSessionLocal * localSession;
@property(assign,readwrite) NSObject<OS_dispatch_data> * pendingResponseBytes;
@property(assign,readwrite) bool pendingResponseDisposition;
@property(assign,readwrite) bool pendingResponseDisposition_didFinish;
@property(assign,readwrite) NSObject<OS_dispatch_source> * resourceTimeout;
@property(assign,readonly) Class superclass;
@property(assign,readwrite) unsigned long long suspendCount;
@property(assign,retain) NSData * uploadData;
@property(assign,retain) NSInputStream * uploadDataStream;
@property(assign,retain) NSURL * uploadFile;
