...
@property(assign,readwrite) double bandwidthMax;
@property(assign,readwrite) double bandwidthMean;
@property(assign,readwrite) double bandwidthStdDev;
@property(assign,readwrite) unsigned int duration;
@property(assign,readwrite) unsigned int fastFowards;
@property(assign,readwrite) bool hasBandwidthMax;
@property(assign,readwrite) bool hasBandwidthMean;
@property(assign,readwrite) bool hasBandwidthStdDev;
@property(assign,readwrite) bool hasDuration;
@property(assign,readwrite) bool hasFastFowards;
@property(assign,readwrite) bool hasLocalFairPlayCount;
@property(assign,readwrite) bool hasLocalNonFairPlayCount;
@property(assign,readwrite) bool hasPauses;
@property(assign,readwrite) bool hasReadyToPlayMs;
@property(assign,readwrite) bool hasReason;
@property(assign,readwrite) bool hasRemoteFairPlayCount;
@property(assign,readwrite) bool hasRemoteNonFairPlayCount;
@property(assign,readwrite) bool hasRewinds;
@property(assign,readonly) bool hasSessionUUID;
@property(assign,readwrite) bool hasStallCount;
@property(assign,readwrite) bool hasTimestamp;
@property(assign,readwrite) unsigned int localFairPlayCount;
@property(assign,readwrite) unsigned int localNonFairPlayCount;
@property(assign,readwrite) unsigned int pauses;
@property(assign,readwrite) unsigned int readyToPlayMs;
@property(assign,readwrite) int reason;
@property(assign,readwrite) unsigned int remoteFairPlayCount;
@property(assign,readwrite) unsigned int remoteNonFairPlayCount;
@property(assign,readwrite) unsigned int rewinds;
@property(assign,retain) NSString * sessionUUID;
@property(assign,readwrite) unsigned int stallCount;
