...
@property(assign,readwrite) unsigned int clientAnnounceMs;
...
@property(assign,readwrite) unsigned int clientSetupAudioMs;
@property(assign,readwrite) unsigned int clientSetupScreenMs;
@property(assign,retain) NSString * clientVersion;
@property(assign,readwrite) bool hasAudioCompressionType;
@property(assign,readwrite) bool hasClientAnnounceMs;
...
@property(assign,readwrite) bool hasClientSetupAudioMs;
@property(assign,readwrite) bool hasClientSetupScreenMs;
@property(assign,readonly) bool hasClientVersion;
@property(assign,readwrite) bool hasLatencyMs;
@property(assign,readwrite) bool hasServerRecordMs;
...
@property(assign,readwrite) unsigned int latencyMs;
@property(assign,readwrite) unsigned int serverRecordMs;
