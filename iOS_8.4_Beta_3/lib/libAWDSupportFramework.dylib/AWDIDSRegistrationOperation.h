...
@property(assign,readwrite) bool hasHeartbeatDelay;
@property(assign,readwrite) bool hasHeartbeatRegister;
...
@property(assign,readwrite) unsigned int heartbeatDelay;
@property(assign,readwrite) unsigned int heartbeatRegister;
