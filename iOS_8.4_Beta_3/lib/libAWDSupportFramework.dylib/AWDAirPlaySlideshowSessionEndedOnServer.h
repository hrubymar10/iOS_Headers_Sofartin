...
@property(assign,readwrite) bool hasSkipAheads;
@property(assign,readwrite) bool hasSkipBacks;
...
@property(assign,readwrite) unsigned int skipAheads;
@property(assign,readwrite) unsigned int skipBacks;
